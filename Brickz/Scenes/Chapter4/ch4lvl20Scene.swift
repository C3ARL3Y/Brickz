...
class ch4lvl20Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl21Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl21Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick5.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y)
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height * 2))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick19.texture = SKTexture(imageNamed: "brick3Texture9")
        brick19.size = steelBrickSize
        ...
        brick20.texture = SKTexture(imageNamed: "brick3Texture9")
        brick20.size = steelBrickSize
        ...
        brick21.texture = SKTexture(imageNamed: "brick3Texture9")
        brick21.size = steelBrickSize
        ...
        obstacle3.position = CGPoint(x: 0 + (obstacle3.size.width * 0.6), y: brick8.position.y - (brick8.size.height))
        ...
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle1.size.width * 0.6), y: brick15.position.y - (brick15.size.height))
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl20Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl21Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick19" {
            ...
            if brickLives[18] == 9 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[18] == 8 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[18] == 7 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[18] == 6 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[18] == 5 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[18] == 4 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[18] == 3 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[18] == 2 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick20" {
            ...
            if brickLives[19] == 9 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[19] == 8 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[19] == 7 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[19] == 6 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[19] == 5 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[19] == 4 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[19] == 3 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[19] == 2 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick21" {
            ...
            if brickLives[20] == 9 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[20] == 8 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[20] == 7 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[20] == 6 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[20] == 5 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[20] == 4 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[20] == 3 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[20] == 2 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if brickCount == 0 {
            print("ch4lvl20 completed")
            gameOver = true
            
            if ch4lvl21Unlocked == false {
                continueString = "ch4lvl21"
                UserDefaults.standard.set("ch4lvl21", forKey: "continueString")
            }
            ch4lvl21Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl21Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl21Unlocked == false {
                continueString = "ch4lvl21"
                UserDefaults.standard.set("ch3lvl21", forKey: "continueString")
            }
            ch4lvl21Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl21Unlocked")
            UserDefaults.standard.synchronize()

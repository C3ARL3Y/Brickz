...
class ch4lvl3Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 + (cementBrickSize.width * 1.5), y: self.frame.height / 1.6 - (cementBrickSize.height * 1.5))
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: self.frame.width / 2 + (cementBrickSize.width * 1.5), y: self.frame.height / 1.6 + (cementBrickSize.height * 1.5))
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: self.frame.width / 2 - (cementBrickSize.width * 1.5), y: self.frame.height / 1.6 + (cementBrickSize.height * 1.5))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: self.frame.width / 2 - (cementBrickSize.width * 1.5), y: self.frame.height / 1.6 - (cementBrickSize.height * 1.5))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        obstacle1.size = CGSize(width: self.frame.height / 40, height: brick1.size.height * 2.6)
        obstacle1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.6)
        ...
        obstacle1.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        obstacle1.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        obstacle2.size = CGSize(width: brick1.size.width * 2.6, height: self.frame.height / 40)
        obstacle2.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.6)
        ...
        obstacle2.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        obstacle2.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: brick2.position.y + (brick2.size.height * 1.1))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick1.position.y - (brick1.size.height * 1.1))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl3 completed")
            gameOver = true
            
            if ch4lvl4Unlocked == false {
                continueString = "ch4lvl4"
                UserDefaults.standard.set("ch4lvl4", forKey: "continueString")
            }
            ch4lvl4Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl4Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl4Unlocked == false {
                continueString = "ch4lvl4"
                UserDefaults.standard.set("ch3lvl4", forKey: "continueString")
            }
            ch4lvl4Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl4Unlocked")
            UserDefaults.standard.synchronize()

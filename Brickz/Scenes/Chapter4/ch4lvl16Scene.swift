...
class ch4lvl16Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl17Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl17Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick3.position = CGPoint(x: brick1.position.x + (brick1.size.width * 2), y: brick1.position.y + (brick1.size.height))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y - (brick1.size.height))
        ...
        brick11.position = CGPoint(x: brick1.position.x - (brick11.size.width * 2), y: brick1.position.y - (brick1.size.height))
        ...
        brick15.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y - (brick1.size.height * 2))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick7.position.y + (brick7.size.height / 2))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick17.position.y - (brick17.size.height / 2))
        ...
        obstacleLeft.position = CGPoint(x: brick11.position.x - (brick11.size.width * 1.5), y: bottomSensor.position.y + (obstacleLeft.size.height * 0.6))
        ...
        obstacleRight.position = CGPoint(x: brick3.position.x + (brick3.size.width * 1.5), y: topSensor.position.y - (obstacleRight.size.height * 0.6))
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl16Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl16 completed")
            gameOver = true
            
            if ch4lvl17Unlocked == false {
                continueString = "ch4lvl17"
                UserDefaults.standard.set("ch4lvl17", forKey: "continueString")
            }
            ch4lvl17Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl17Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl17Unlocked == false {
                continueString = "ch4lvl17"
                UserDefaults.standard.set("ch3lvl17", forKey: "continueString")
            }
            ch4lvl17Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl17Unlocked")
            UserDefaults.standard.synchronize()

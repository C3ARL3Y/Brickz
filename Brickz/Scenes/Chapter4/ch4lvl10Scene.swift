...
class ch4lvl10Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brick1.size.width), y: self.frame.height / 1.3)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: self.frame.width / 2 + (brick2.size.width), y: self.frame.height / 1.3)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y - (brick1.size.height))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick7.position.x + (brick7.size.width * 2), y: brick7.position.y)
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick11.position = CGPoint(x: brick10.position.x + (brick10.size.width * 2), y: brick10.position.y)
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick11.position.y - (brick11.size.height / 2))
        ...
        moveObstacleUp = SKAction.moveTo(y: topSensor.position.y, duration: 2.2)
        moveObstacleDown = SKAction.moveTo(y: bottomSensor.position.y, duration: 2.2)
        ...
        obstacleLeft.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2), y: topSensor.position.y - (obstacleLeft.size.height * 0.6))
        ...
        obstacleRight.position = CGPoint(x: brick2.position.x + (brick2.size.width * 2), y: bottomSensor.position.y + (obstacleRight.size.height * 0.6))
        ...
        obstacleTop.position = CGPoint(x: self.frame.width - (obstacleTop.size.width * 0.6), y: topSensor.position.y + (obstacleTop.size.height * 0.6))
        ...
        obstacleBottom.position = CGPoint(x: 0 + (obstacleBottom.size.width * 0.6), y: bottomSensor.position.y - (obstacleBottom.size.height * 0.6))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl10 completed")
            gameOver = true
            
            if ch4lvl11Unlocked == false {
                continueString = "ch4lvl11"
                UserDefaults.standard.set("ch4lvl11", forKey: "continueString")
            }
            ch4lvl11Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl11Unlocked")
            UserDefaults.standard.synchronize()

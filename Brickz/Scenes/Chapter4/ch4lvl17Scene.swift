...
class ch4lvl17Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl18Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl18Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.width * 0.6), y: self.frame.height / 1.3)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick1.physicsBody?.restitution = 1
        brick1.physicsBody?.linearDamping = 0
        brick1.physicsBody?.angularDamping = 0
        ...
        brick2.physicsBody?.angularDamping = 0
        ...
        brick3.physicsBody?.angularDamping = 0
        
        brick4.texture = SKTexture(imageNamed: "brick3Texture9")
        brick4.size = steelBrickSize
        brick4.position = CGPoint(x: self.frame.width - (brick4.size.width * 0.6), y: brick1.position.y)
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick4.physicsBody?.restitution = 1
        brick4.physicsBody?.linearDamping = 0
        brick4.physicsBody?.angularDamping = 0
        ...
        brick5.physicsBody?.restitution = 1
        brick5.physicsBody?.linearDamping = 0
        brick5.physicsBody?.angularDamping = 0
        
        brick6.texture = SKTexture(imageNamed: "brick3Texture9")
        brick6.size = steelBrickSize
        brick6.position = CGPoint(x: brick5.position.x - (brick5.size.width), y: brick5.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick6.physicsBody?.friction = 0
        brick6.physicsBody?.restitution = 1
        brick6.physicsBody?.linearDamping = 0
        brick6.physicsBody?.angularDamping = 0
        ...
        brick7.physicsBody?.friction = 0
        brick7.physicsBody?.restitution = 1
        brick7.physicsBody?.linearDamping = 0
        brick7.physicsBody?.angularDamping = 0
        
        brick8.texture = SKTexture(imageNamed: "brick3Texture9")
        brick8.size = steelBrickSize
        brick8.position = CGPoint(x: brick2.position.x, y: brick7.position.y)
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick8.physicsBody?.friction = 0
        brick8.physicsBody?.restitution = 1
        brick8.physicsBody?.linearDamping = 0
        brick8.physicsBody?.angularDamping = 0
        
        brick9.texture = SKTexture(imageNamed: "brick3Texture9")
        brick9.size = steelBrickSize
        brick9.position = CGPoint(x: brick3.position.x, y: brick8.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick9.physicsBody?.friction = 0
        brick9.physicsBody?.restitution = 1
        brick9.physicsBody?.linearDamping = 0
        brick9.physicsBody?.angularDamping = 0
        
        brick10.texture = SKTexture(imageNamed: "brick3Texture9")
        brick10.size = steelBrickSize
        brick10.position = CGPoint(x: brick4.position.x, y: brick9.position.y)
        ...
        brick10.physicsBody?.friction = 0
        brick10.physicsBody?.restitution = 1
        brick10.physicsBody?.linearDamping = 0
        brick10.physicsBody?.angularDamping = 0
        
        brick11.texture = SKTexture(imageNamed: "brick3Texture9")
        brick11.size = steelBrickSize
        brick11.position = CGPoint(x: brick5.position.x, y: brick10.position.y)
        ...
        brick11.physicsBody?.friction = 0
        brick11.physicsBody?.restitution = 1
        brick11.physicsBody?.linearDamping = 0
        brick11.physicsBody?.angularDamping = 0
        
        brick12.texture = SKTexture(imageNamed: "brick3Texture9")
        brick12.size = steelBrickSize
        brick12.position = CGPoint(x: brick6.position.x, y: brick11.position.y)
        ...
        brick12.physicsBody?.friction = 0
        brick12.physicsBody?.restitution = 1
        brick12.physicsBody?.linearDamping = 0
        brick12.physicsBody?.angularDamping = 0
        
        brick13.texture = SKTexture(imageNamed: "brick3Texture9")
        brick13.size = steelBrickSize
        brick13.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height * 2))
        ...
        brick13.physicsBody?.friction = 0
        brick13.physicsBody?.restitution = 1
        brick13.physicsBody?.linearDamping = 0
        brick13.physicsBody?.angularDamping = 0
        
        brick14.texture = SKTexture(imageNamed: "brick3Texture9")
        brick14.size = steelBrickSize
        brick14.position = CGPoint(x: brick8.position.x, y: brick13.position.y)
        ...
        brick14.physicsBody?.friction = 0
        brick14.physicsBody?.restitution = 1
        brick14.physicsBody?.linearDamping = 0
        brick14.physicsBody?.angularDamping = 0
        
        brick15.texture = SKTexture(imageNamed: "brick3Texture9")
        brick15.size = steelBrickSize
        brick15.position = CGPoint(x: brick9.position.x, y: brick14.position.y)
        ...
        brick15.physicsBody?.friction = 0
        brick15.physicsBody?.restitution = 1
        brick15.physicsBody?.linearDamping = 0
        brick15.physicsBody?.angularDamping = 0
        
        brick16.texture = SKTexture(imageNamed: "brick3Texture9")
        brick16.size = steelBrickSize
        brick16.position = CGPoint(x: brick10.position.x, y: brick15.position.y)
        ...
        brick16.physicsBody?.friction = 0
        brick16.physicsBody?.restitution = 1
        brick16.physicsBody?.linearDamping = 0
        brick16.physicsBody?.angularDamping = 0
        
        brick17.texture = SKTexture(imageNamed: "brick3Texture9")
        brick17.size = steelBrickSize
        brick17.position = CGPoint(x: brick11.position.x, y: brick16.position.y)
        ...
        brick17.physicsBody?.friction = 0
        brick17.physicsBody?.restitution = 1
        brick17.physicsBody?.linearDamping = 0
        brick17.physicsBody?.angularDamping = 0
        
        brick18.texture = SKTexture(imageNamed: "brick3Texture9")
        brick18.size = steelBrickSize
        brick18.position = CGPoint(x: brick12.position.x, y: brick17.position.y)
        ...
        brick18.physicsBody?.friction = 0
        brick18.physicsBody?.restitution = 1
        brick18.physicsBody?.linearDamping = 0
        brick18.physicsBody?.angularDamping = 0
       
        moveObstacleLeft = SKAction.moveTo(x: 0, duration: 2)
        moveObstacleRight = SKAction.moveTo(x: self.frame.width, duration: 2)
        
        obstacle1.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle1.position = CGPoint(x: 0 + (obstacle1.size.width * 0.6), y: brick1.position.y + (brick1.size.height))
        obstacle1.zPosition = 1
        obstacle1.color = SKColor.darkGray
        obstacle1.name = "obstacle1"
        self.addChild(obstacle1)
        obstacle1.run(moveObstacleRight)
        ...
        obstacle1.physicsBody?.friction = 0
        obstacle1.physicsBody?.restitution = 1
        obstacle1.physicsBody?.linearDamping = 0
        obstacle1.physicsBody?.angularDamping = 0
        
        obstacle2.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle2.position = CGPoint(x: self.frame.width - (obstacle2.size.width * 0.6), y: brick1.position.y - (brick1.size.height))
        obstacle2.zPosition = 1
        obstacle2.color = SKColor.darkGray
        obstacle2.name = "obstacle2"
        self.addChild(obstacle2)
        obstacle2.run(moveObstacleLeft)
        ...
        obstacle2.physicsBody?.friction = 0
        obstacle2.physicsBody?.restitution = 1
        obstacle2.physicsBody?.linearDamping = 0
        obstacle2.physicsBody?.angularDamping = 0
        
        obstacle3.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle3.position = CGPoint(x: 0 + (obstacle1.size.width * 0.6), y: brick7.position.y - (brick7.size.height))
        obstacle3.zPosition = 1
        obstacle3.color = SKColor.darkGray
        obstacle3.name = "obstacle3"
        self.addChild(obstacle3)
        obstacle3.run(moveObstacleRight)
        ...
        obstacle3.physicsBody?.friction = 0
        obstacle3.physicsBody?.restitution = 1
        obstacle3.physicsBody?.linearDamping = 0
        obstacle3.physicsBody?.angularDamping = 0
        
        obstacle4.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle1.size.width * 0.6), y: brick13.position.y - (brick13.size.height))
        obstacle4.zPosition = 1
        obstacle4.color = SKColor.darkGray
        obstacle4.name = "obstacle4"
        self.addChild(obstacle4)
        obstacle4.run(moveObstacleLeft)
        ...
        obstacle4.physicsBody?.friction = 0
        obstacle4.physicsBody?.restitution = 1
        obstacle4.physicsBody?.linearDamping = 0
        obstacle4.physicsBody?.angularDamping = 0
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "obstacle1") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacle1") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle1") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacle1") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle2") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacle2") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle2") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacle2") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle3") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacle3") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle3") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacle3") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle4") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacle4") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle4") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacle4") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        if Obstacle.name == "obstacle1" && Sensor.name == "leftBarrier" {
            obstacle1.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle1" && Sensor.name == "rightBarrier" {
            obstacle1.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacle2" && Sensor.name == "leftBarrier" {
            obstacle2.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle2" && Sensor.name == "rightBarrier" {
            obstacle2.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacle3" && Sensor.name == "leftBarrier" {
            obstacle3.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle3" && Sensor.name == "rightBarrier" {
            obstacle3.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacle4" && Sensor.name == "leftBarrier" {
            obstacle4.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle4" && Sensor.name == "rightBarrier" {
            obstacle4.run(moveObstacleLeft)
        }
    }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl17Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl18Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick8" {
            ...
            if brickLives[7] == 9 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[7] == 8 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[7] == 7 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[7] == 6 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[7] == 5 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[7] == 4 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[7] == 3 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[7] == 2 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick9" {
            ...
            if brickLives[8] == 9 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[8] == 8 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[8] == 7 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[8] == 6 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[8] == 5 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[8] == 4 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[8] == 3 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[8] == 2 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick10" {
            ...
            if brickLives[9] == 9 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[9] == 8 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[9] == 7 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[9] == 6 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[9] == 5 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[9] == 4 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[9] == 3 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[9] == 2 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick11" {
            ...
            if brickLives[10] == 9 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[10] == 8 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[10] == 7 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[10] == 6 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[10] == 5 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[10] == 4 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[10] == 3 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[10] == 2 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick12" {
            ...
            if brickLives[11] == 9 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[11] == 8 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[11] == 7 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[11] == 6 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[11] == 5 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[11] == 4 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[11] == 3 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[11] == 2 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick13" {
            ...
            if brickLives[12] == 9 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[12] == 8 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[12] == 7 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[12] == 6 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[12] == 5 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[12] == 4 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[12] == 3 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[12] == 2 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick14" {
            ...
            if brickLives[13] == 9 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[13] == 8 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[13] == 7 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[13] == 6 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[13] == 5 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[13] == 4 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[13] == 3 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[13] == 2 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick15" {
            ...
            if brickLives[14] == 9 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[14] == 8 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[14] == 7 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[14] == 6 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[14] == 5 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[14] == 4 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[14] == 3 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[14] == 2 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick16" {
            ...
            if brickLives[15] == 9 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[15] == 8 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[15] == 7 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[15] == 6 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[15] == 5 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[15] == 4 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[15] == 3 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[15] == 2 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick17" {
            ...
            if brickLives[16] == 9 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[16] == 8 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[16] == 7 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[16] == 6 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[16] == 5 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[16] == 4 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[16] == 3 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[16] == 2 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick18" {
            ...
            if brickLives[17] == 9 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[17] == 8 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[17] == 7 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[17] == 6 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[17] == 5 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[17] == 4 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[17] == 3 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[17] == 2 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if brickCount == 0 {
            print("ch4lvl17 completed")
            gameOver = true
            
            if ch4lvl18Unlocked == false {
                continueString = "ch4lvl18"
                UserDefaults.standard.set("ch4lvl18", forKey: "continueString")
            }
            ch4lvl18Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl18Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl18Unlocked == false {
                continueString = "ch4lvl18"
                UserDefaults.standard.set("ch3lvl18", forKey: "continueString")
            }
            ch4lvl18Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl18Unlocked")
            UserDefaults.standard.synchronize()

...
class ch4lvl4Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9]
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl4 completed")
            gameOver = true
            
            if ch4lvl5Unlocked == false {
                continueString = "ch4lvl5"
                UserDefaults.standard.set("ch4lvl5", forKey: "continueString")
            }
            ch4lvl5Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl5Unlocked")
            UserDefaults.standard.synchronize()

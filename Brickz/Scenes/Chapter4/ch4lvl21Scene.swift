...
class ch4lvl21Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl22Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl22Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick4.position = CGPoint(x: brick2.position.x + (brick2.size.width), y: brick2.position.y + (brick2.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick2.position.x - (brick2.size.width), y: brick2.position.y + (brick2.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick2.position.x - (brick2.size.width), y: brick2.position.y - (brick2.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2), y: brick1.position.y)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick7.position.x + (brick7.size.width), y: brick7.position.y + (brick7.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y + (brick7.size.height))
        ...
        brick11.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y - (brick7.size.height))
        ...
        brick12.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 4))
        ...
        brick13.position = CGPoint(x: brick12.position.x + (brick12.size.width * 2), y: brick12.position.y)
        ...
        brick15.position = CGPoint(x: brick13.position.x + (brick13.size.width), y: brick13.position.y + (brick13.size.height))
        ...
        brick16.position = CGPoint(x: brick13.position.x - (brick13.size.width), y: brick13.position.y + (brick13.size.height))
        ...
        brick17.position = CGPoint(x: brick13.position.x - (brick13.size.width), y: brick13.position.y - (brick13.size.height))
        ...
        brick18.position = CGPoint(x: brick12.position.x - (brick12.size.width * 2), y: brick12.position.y)
        ...
        brick20.position = CGPoint(x: brick18.position.x + (brick18.size.width), y: brick18.position.y + (brick18.size.height))
        ...
        brick21.position = CGPoint(x: brick18.position.x - (brick18.size.width), y: brick18.position.y + (brick18.size.height))
        ...
        brick22.position = CGPoint(x: brick18.position.x - (brick18.size.width), y: brick18.position.y - (brick18.size.height))
        ...
        obstacle.position = CGPoint(x: 0 + (obstacle.size.width * 0.6), y: brick1.position.y - (brick1.size.height * 2))
        obstacle.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle.zPosition = 1
        obstacle.color = SKColor.darkGray
        obstacle.name = "obstacle"
        self.addChild(obstacle)
        obstacle.run(moveObstacleRight)
        obstacle.physicsBody = SKPhysicsBody(rectangleOf: obstacle.size)
        obstacle.physicsBody?.affectedByGravity = false
        obstacle.physicsBody?.isDynamic = true
        obstacle.physicsBody?.allowsRotation = false
        obstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "obstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacle") && (secondBody.name == "ball") {
            ...
            if (firstBody.name == "obstacle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacle") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacle") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "obstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        if Obstacle.name == "obstacle" && Sensor.name == "leftBarrier" {
            obstacle.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle" && Sensor.name == "rightBarrier" {
            obstacle.run(moveObstacleLeft)
        }
    }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl22Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl21 completed")
            gameOver = true
            
            if ch4lvl22Unlocked == false {
                continueString = "ch4lvl22"
                UserDefaults.standard.set("ch4lvl22", forKey: "continueString")
            }
            ch4lvl22Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl22Unlocked")
            UserDefaults.standard.synchronize()

...
class Chapter4lvlSelectScene: SKScene, SKPhysicsContactDelegate {
    
    var ch4lvl2Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl2Unlocked")
    var ch4lvl3Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl3Unlocked")
    var ch4lvl4Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl4Unlocked")
    var ch4lvl5Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl5Unlocked")
    var ch4lvl6Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl6Unlocked")
    var ch4lvl7Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl7Unlocked")
    var ch4lvl8Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl8Unlocked")
    var ch4lvl9Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl9Unlocked")
    var ch4lvl10Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl10Unlocked")
    var ch4lvl11Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl11Unlocked")
    ...
    var ch4lvl14Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl14Unlocked")
    var ch4lvl15Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl15Unlocked")
    ...
    let bg = SKSpriteNode(imageNamed: "ch4Background")
    
    let chapter4Title = SKSpriteNode(imageNamed: "ch4Title")
    
    let backBtn = SKSpriteNode(imageNamed: "backBtn")
    
    let lvl1Btn = SKSpriteNode(imageNamed: "ch4lvl1BtnImg"), lvl2Btn = SKSpriteNode(imageNamed: "ch4lvl2BtnImg"), lvl3Btn = SKSpriteNode(imageNamed: "ch4lvl3BtnImg"), lvl4Btn = SKSpriteNode(imageNamed: "ch4lvl4BtnImg"), lvl5Btn = SKSpriteNode(imageNamed: "ch4lvl5BtnImg"), lvl6Btn = SKSpriteNode(imageNamed: "ch4lvl6BtnImg"), lvl7Btn = SKSpriteNode(imageNamed: "ch4lvl7BtnImg"), lvl8Btn = SKSpriteNode(imageNamed: "ch4lvl8BtnImg"), lvl9Btn = SKSpriteNode(imageNamed: "ch4lvl9BtnImg"), lvl10Btn = SKSpriteNode(imageNamed: "ch4lvl10BtnImg"), lvl11Btn = SKSpriteNode(imageNamed: "ch4lvl11BtnImg"), lvl12Btn = SKSpriteNode(imageNamed: "ch4lvl12BtnImg"), lvl13Btn = SKSpriteNode(imageNamed: "ch4lvl13BtnImg"), lvl14Btn = SKSpriteNode(imageNamed: "ch4lvl14BtnImg"), lvl15Btn = SKSpriteNode(imageNamed: "ch4lvl15BtnImg"), lvl16Btn = SKSpriteNode(imageNamed: "ch4lvl16BtnImg"), lvl17Btn = SKSpriteNode(imageNamed: "ch4lvl17BtnImg"), lvl18Btn = SKSpriteNode(imageNamed: "ch4lvl18BtnImg"), lvl19Btn = SKSpriteNode(imageNamed: "ch4lvl19BtnImg"), lvl20Btn = SKSpriteNode(imageNamed: "ch4lvl20BtnImg"), lvl21Btn = SKSpriteNode(imageNamed: "ch4lvl21BtnImg"), lvl22Btn = SKSpriteNode(imageNamed: "ch4lvl22BtnImg"), lvl23Btn = SKSpriteNode(imageNamed: "ch4lvl23BtnImg"), lvl24Btn = SKSpriteNode(imageNamed: "ch4lvl24BtnImg"), lvl25Btn = SKSpriteNode(imageNamed: "ch4lvl25BtnImg")
    ...
    override func didMove(to view: SKView) {
        ...
        chapter4Title.size = CGSize(width: self.frame.width / 2, height: self.frame.height / 8)
        chapter4Title.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.15)
        chapter4Title.zPosition = 1
        self.addChild(chapter4Title)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touchedNode.name == "lvl3Btn" {
            if ch4lvl3Unlocked == true {
                scrollView?.removeFromSuperview()
                let scene = ch4lvl3Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            } else {
        ...
        if touchedNode.name == "lvl4Btn" {
            if ch4lvl4Unlocked == true {
                scrollView?.removeFromSuperview()
                let scene = ch4lvl4Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            } else {
        ...
        if touchedNode.name == "lvl5Btn" {
            if ch4lvl5Unlocked == true {
                scrollView?.removeFromSuperview()
                let scene = ch4lvl5Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            } else {
        ...
        if touchedNode.name == "lvl10Btn" {
            if ch4lvl10Unlocked == true {
                scrollView?.removeFromSuperview()
                let scene = ch4lvl10Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            } else {
        ...
        if touchedNode.name == "lvl13Btn" {
            if ch4lvl13Unlocked == true {
                scrollView?.removeFromSuperview()
                let scene = ch4lvl13Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            } else {
        ...
        if touchedNode.name == "lvl14Btn" {
            if ch4lvl14Unlocked == true {
                scrollView?.removeFromSuperview()
                let scene = ch4lvl14Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            } else {

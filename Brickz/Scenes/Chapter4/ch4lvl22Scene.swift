...
class ch4lvl22Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl23Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl23Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.width * 0.6), y: self.frame.height / 1.2)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: brick1.position.x + (brick2.size.width), y: brick1.position.y - (brick1.size.height))
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brick3.size.height * 2))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.height * 2))
        ...
        brick13.position = CGPoint(x: brick3.position.x - (brick3.size.width), y: brick3.position.y - (brick3.size.height))
        ...
        brick16.position = CGPoint(x: brick6.position.x + (brick6.size.width), y: brick6.position.y - (brick6.size.height))
        ...
        brick19.position = CGPoint(x: self.frame.width / 2, y: brick3.position.y - (brick3.size.height))
        ...
        brick20.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (brick3.size.height * 2))
        ...
        brick21.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height * 2))
        ...
        brick22.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (brick6.size.height * 2))
        ...
        brick23.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick1.size.height * 2))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: brick1.position.y + (brick1.size.height))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick12.position.y - (brick12.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl22 completed")
            gameOver = true
            
            if ch4lvl23Unlocked == false {
                continueString = "ch4lvl23"
                UserDefaults.standard.set("ch4lvl23", forKey: "continueString")
            }
            ch4lvl23Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl23Unlocked")
            UserDefaults.standard.synchronize()

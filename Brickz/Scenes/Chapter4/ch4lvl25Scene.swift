...
class ch4lvl25Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch5lvl1Unlocked = UserDefaults.standard.bool(forKey: "ch5lvl1Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.7)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick3.position.x + (brick3.size.width / 2), y: brick3.position.y - (brick3.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick16.position = CGPoint(x: brick3.position.x + (brick3.size.width / 2), y: brick3.position.y + (brick3.size.height))
        ...
        brick20.position = CGPoint(x: brick19.position.x - (brick19.size.width / 2), y: brick19.position.y + (brick19.size.height))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick25.position.y + (brick25.size.height / 2))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick15.position.y - (brick15.size.height / 2))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl25 completed")
            gameOver = true
            
            if ch5lvl1Unlocked == false {
                continueString = "ch5lvl1"
                UserDefaults.standard.set("ch5lvl1", forKey: "continueString")
            }
            ch5lvl1Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch5lvl1Unlocked")
            UserDefaults.standard.synchronize()
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        obstacleTop.position.y = (topSensor.position.y + (obstacleTop.size.height * 0.6))

...
class ch4lvl23Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch4lvl24Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl24Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brick1.size.width), y: self.frame.height / 1.6)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick3.position.x + (brick3.size.width / 2), y: brick3.position.y - (brick3.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick10.position = CGPoint(x: self.frame.width / 2 + (brick10.size.width), y: brick1.position.y)
        ...
        brick16.position = CGPoint(x: brick12.position.x - (brick12.size.width / 2), y: brick12.position.y - (brick12.size.height))
        ...
        brick19.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (brick6.size.height * 2))
        ...
        brick20.position = CGPoint(x: self.frame.width / 2, y: brick19.position.y)
        ...
        brick21.position = CGPoint(x: brick15.position.x, y: brick20.position.y)
        ...
        brick22.position = CGPoint(x: brick9.position.x, y: brick9.position.y - (brick9.size.height * 2))
        ...
        brick23.position = CGPoint(x: self.frame.width / 2, y: brick22.position.y)
        ...
        brick24.position = CGPoint(x: brick18.position.x, y: brick23.position.y)
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick6.position.y + (brick6.size.height / 2))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick9.position.y - (brick9.size.height / 2))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: topSensor.position.y + (obstacleTop.size.height * 0.6))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: bottomSensor.position.y - (obstacleBottom.size.height * 0.6))
        ...
        obstacleMiddle.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 8)
        obstacleMiddle.position = CGPoint(x: self.frame.width / 2, y: topSensor.position.y - (obstacleMiddle.size.height * 0.6))
        obstacleMiddle.zPosition = 1
        obstacleMiddle.color = SKColor.darkGray
        obstacleMiddle.name = "obstacleMiddle"
        self.addChild(obstacleMiddle)
        obstacleMiddle.run(moveObstacleDown)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "obstacleMiddle") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacleMiddle") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacleMiddle") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacleMiddle") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        ...
        if Obstacle.name == "obstacleMiddle" && Sensor.name == "topSensor" {
            obstacleMiddle.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacleMiddle" && Sensor.name == "bottomSensor" {
            obstacleMiddle.run(moveObstacleUp)
        }
    }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl23Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl23 completed")
            gameOver = true
            
            if ch4lvl24Unlocked == false {
                continueString = "ch4lvl24"
                UserDefaults.standard.set("ch4lvl24", forKey: "continueString")
            }
            ch4lvl24Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl24Unlocked")
            UserDefaults.standard.synchronize()

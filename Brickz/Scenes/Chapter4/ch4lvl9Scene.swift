...
class ch4lvl9Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brick1.size.width * 2), y: self.frame.height / 1.55)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick6.position = CGPoint(x: self.frame.width / 2 + (brick6.size.width * 2), y: brick1.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        obstacleMiddle.size = CGSize(width: self.frame.height / 40, height: brick1.size.height * 3)
        obstacleMiddle.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y)
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick2.position.y - (brick2.size.height * 1.1))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl9 completed")
            gameOver = true
            
            if ch4lvl10Unlocked == false {
                continueString = "ch4lvl10"
                UserDefaults.standard.set("ch4lvl10", forKey: "continueString")
            }
            ch4lvl10Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl10Unlocked")
            UserDefaults.standard.synchronize()

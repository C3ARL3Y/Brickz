...
class ch4lvl18Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,]
    ...
    var ch4lvl19Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl19Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick7.position = CGPoint(x: brick3.position.x - (brick3.size.width), y: brick3.position.y + (brick3.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick2.position.x - (brick2.size.width), y: brick2.position.y - (brick2.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick13.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y + (brick7.size.height))
        ...
        brick16.position = CGPoint(x: brick15.position.x, y: brick15.position.y + (brick15.size.height * 2))
        ...
        brick18.position = CGPoint(x: brick12.position.x, y: brick12.position.y - (brick12.size.height * 2))
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl19Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl18 completed")
            gameOver = true
            
            if ch4lvl19Unlocked == false {
                continueString = "ch4lvl19"
                UserDefaults.standard.set("ch4lvl19", forKey: "continueString")
            }
            ch4lvl19Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl19Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl19Unlocked == false {
                continueString = "ch4lvl19"
                UserDefaults.standard.set("ch3lvl19", forKey: "continueString")
            }
            ch4lvl19Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl19Unlocked")
            UserDefaults.standard.synchronize()

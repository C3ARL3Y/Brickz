...
class ch4lvl19Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl20Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl20Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: self.frame.width / 2 + (brick2.size.width / 2), y: self.frame.height / 1.7)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick4.position.x - (brick4.size.width / 2), y: brick4.position.y - (brick4.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick11.position = CGPoint(x: brick3.position.x + (brick3.size.width / 2), y: brick3.position.y + (brick3.size.height))
        ...
        brick18.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick10.size.height))
        ...
        brick19.position = CGPoint(x: brick3.position.x - (brick3.size.width), y: brick3.position.y)
        ...
        brick20.position = CGPoint(x: brick4.position.x + (brick4.size.width), y: brick4.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl19 completed")
            gameOver = true
            
            if ch4lvl20Unlocked == false {
                continueString = "ch4lvl20"
                UserDefaults.standard.set("ch4lvl20", forKey: "continueString")
            }
            ch4lvl20Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl20Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl20Unlocked == false {
                continueString = "ch4lvl20"
                UserDefaults.standard.set("ch3lvl20", forKey: "continueString")
            }
            ch4lvl20Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl20Unlocked")
            UserDefaults.standard.synchronize()

...
class ch4lvl2Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: self.frame.width / 2 + (brick2.size.width), y: self.frame.height / 1.6)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        obstacleMiddle.size = CGSize(width: self.frame.height / 40, height: steelBrickSize.height)
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick1.position.y - (brick1.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl2 completed")
            gameOver = true
            
            if ch4lvl3Unlocked == false {
                continueString = "ch4lvl3"
                UserDefaults.standard.set("ch4lvl3", forKey: "continueString")
            }
            ch4lvl3Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl3Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl3Unlocked == false {
                continueString = "ch4lvl3"
                UserDefaults.standard.set("ch3lvl3", forKey: "continueString")
            }
            ch4lvl3Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl3Unlocked")
            UserDefaults.standard.synchronize()

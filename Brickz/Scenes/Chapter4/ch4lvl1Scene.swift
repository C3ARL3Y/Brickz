...
class ch4lvl1Scene: SKScene, SKPhysicsContactDelegate {
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl1 completed")
            gameOver = true
            
            if ch4lvl2Unlocked == false {
                continueString = "ch4lvl2"
                UserDefaults.standard.set("ch4lvl2", forKey: "continueString")
            }
            ch4lvl2Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl2Unlocked")
            UserDefaults.standard.synchronize()

...
class ch4lvl15Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl16Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl16Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        if view.frame.width == 375 && view.frame.height == 812 {
            ...
            iPhoneXLeftBarrier.physicsBody?.collisionBitMask = PhysicsCategory.Ball
            iPhoneXLeftBarrier.physicsBody?.contactTestBitMask = PhysicsCategory.Ball
            ...
            iPhoneXBottomBarrier.physicsBody?.collisionBitMask = PhysicsCategory.Ball
            iPhoneXBottomBarrier.physicsBody?.contactTestBitMask = PhysicsCategory.Ball
            ...
            iPhoneXRightBarrier.physicsBody?.collisionBitMask = PhysicsCategory.Ball
            iPhoneXRightBarrier.physicsBody?.contactTestBitMask = PhysicsCategory.Ball
        ...
        brick7.position = CGPoint(x: brick5.position.x, y: brick5.position.y - (brick5.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick11.position = CGPoint(x: brick9.position.x - (brick9.size.width), y: brick9.position.y)
        ...
        brick15.position = CGPoint(x: brick13.position.x, y: brick13.position.y + (brick13.size.height))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick2.position.y + (brick2.size.height / 2))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick8.position.y - (brick8.size.height / 2))
        ...
        obstacleLeft.position = CGPoint(x: brick15.position.x - (brick15.size.width), y: bottomSensor.position.y + (obstacleLeft.size.height * 0.6))
        ...
        obstacleRight.position = CGPoint(x: brick4.position.x + (brick4.size.width), y: topSensor.position.y - (obstacleRight.size.height * 0.6))
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl15Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl15 completed")
            gameOver = true
            
            if ch4lvl16Unlocked == false {
                continueString = "ch4lvl16"
                UserDefaults.standard.set("ch4lvl16", forKey: "continueString")
            }
            ch4lvl16Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl16Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl16Unlocked == false {
                continueString = "ch4lvl16"
                UserDefaults.standard.set("ch3lvl16", forKey: "continueString")
            }
            ch4lvl16Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl16Unlocked")
            UserDefaults.standard.synchronize()

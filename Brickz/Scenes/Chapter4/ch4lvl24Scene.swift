...
class ch4lvl24Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl25Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl25Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick3.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2), y: brick1.position.y)
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick4.position.x + (brick4.size.width * 2), y: brick4.position.y)
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x + (brick5.size.width * 2), y: brick5.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x + (brick6.size.width * 2), y: brick6.position.y)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y - (brick7.size.height))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x - (brick9.size.width * 2), y: brick9.position.y)
        ...
        brick12.position = CGPoint(x: brick11.position.x + (brick11.size.width * 2), y: brick11.position.y)
        ...
        brick14.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y + (brick1.size.height))
        ...
        brick15.position = CGPoint(x: brick14.position.x + (brick14.size.width * 2), y: brick14.position.y)
        ...
        brick17.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height))
        ...
        brick18.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height))
        ...
        brick19.position = CGPoint(x: brick18.position.x + (brick18.size.width), y: brick18.position.y - (brick18.size.height))
        ...
        brick22.texture = SKTexture(imageNamed: "brick3Texture9")
        brick22.size = steelBrickSize
        ...
        brick23.texture = SKTexture(imageNamed: "brick3Texture9")
        brick23.size = steelBrickSize
        ...
        brick24.texture = SKTexture(imageNamed: "brick3Texture9")
        brick24.size = steelBrickSize
        ...
        brick25.texture = SKTexture(imageNamed: "brick3Texture9")
        brick25.size = steelBrickSize
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl24Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl25Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick22" {
            ...
            if brickLives[21] == 9 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[21] == 8 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[21] == 7 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[21] == 6 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[21] == 5 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[21] == 4 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[21] == 3 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[21] == 2 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick23" {
            ...
            if brickLives[22] == 9 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[22] == 8 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[22] == 7 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[22] == 6 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[22] == 5 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[22] == 4 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[22] == 3 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[22] == 2 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick24" {
            ...
            if brickLives[23] == 9 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[23] == 8 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[23] == 7 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[23] == 6 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[23] == 5 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[23] == 4 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[23] == 3 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[23] == 2 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if Brick.name == "brick25" {
            ...
            if brickLives[24] == 9 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture8")
            } else if brickLives[24] == 8 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture7")
            } else if brickLives[24] == 7 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture6")
            } else if brickLives[24] == 6 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture5")
            } else if brickLives[24] == 5 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture4")
            } else if brickLives[24] == 4 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture3")
            } else if brickLives[24] == 3 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture2")
            } else if brickLives[24] == 2 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick3Texture1")
        ...
        if brickCount == 0 {
            print("ch4lvl24 completed")
            gameOver = true
            
            if ch4lvl25Unlocked == false {
                continueString = "ch4lvl25"
                UserDefaults.standard.set("ch4lvl25", forKey: "continueString")
            }
            ch4lvl25Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl25Unlocked")
            UserDefaults.standard.synchronize()

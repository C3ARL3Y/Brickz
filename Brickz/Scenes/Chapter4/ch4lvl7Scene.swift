...
class ch4lvl7Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brick1.size.width), y: self.frame.height / 1.5)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: self.frame.width / 2 + (brick1.size.width), y: self.frame.height / 1.5)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        obstacle1.size = CGSize(width: self.frame.height / 40, height: brick1.size.height * 4)
        obstacle1.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y - (brick1.size.height / 2))
        ...
        obstacle2.size = CGSize(width: self.frame.height / 40, height: brick1.size.height * 4)
        obstacle2.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y - (brick1.size.height / 2))
        ...
        obstacle3.size = CGSize(width: self.frame.height / 40, height: brick1.size.height * 4)
        obstacle3.position = CGPoint(x: brick2.position.x + (brick2.size.width), y: brick1.position.y - (brick1.size.height / 2))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: brick3.position.y + (brick3.size.height * 1.1))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick5.position.y - (brick5.size.height * 1.1))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl7 completed")
            gameOver = true
            
            if ch4lvl8Unlocked == false {
                continueString = "ch4lvl8"
                UserDefaults.standard.set("ch4lvl8", forKey: "continueString")
            }
            ch4lvl8Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl8Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl8Unlocked == false {
                continueString = "ch4lvl8"
                UserDefaults.standard.set("ch3lvl8", forKey: "continueString")
            }
            ch4lvl8Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl8Unlocked")
            UserDefaults.standard.synchronize()

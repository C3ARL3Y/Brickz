...
class ch4lvl5Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.width), y: self.frame.height / 1.4)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick4.position = CGPoint(x: self.frame.width - (brick4.size.width * 0.7), y: self.frame.height / 2)
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        moveObstacleMiddle = SKAction.moveTo(x: self.frame.width, duration: 1.05)
        
        obstacleTop.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.5), y: brick3.position.y + (brick3.size.height * 1.1))
        ...
        obstacleMiddle.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y - (brick1.size.height / 0.9))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.5), y: brick4.position.y - (brick4.size.height * 1.1))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl5 completed")
            gameOver = true
            
            if ch4lvl6Unlocked == false {
                continueString = "ch4lvl6"
                UserDefaults.standard.set("ch4lvl6", forKey: "continueString")
            }
            ch4lvl6Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl6Unlocked")
            UserDefaults.standard.synchronize()

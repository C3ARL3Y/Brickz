...
class ch4lvl14Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    override func didMove(to view: SKView) {
        ...
        brick3.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick7.position = CGPoint(x: self.frame.width - (brick7.size.width * 0.6), y: brick1.position.y)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: self.frame.width - (brick10.size.width * 0.6), y: brick5.position.y)
        ...
        brick13.position = CGPoint(x: self.frame.width / 2, y: brick3.position.y)
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + (brick1.size.height / 2))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick5.position.y - (brick5.size.height / 2))
        ...
        obstacleLeft.position = CGPoint(x: brick13.position.x - (brick13.size.width * 1.5), y: topSensor.position.y - (obstacleLeft.size.height * 0.6))
        ...
        obstacleRight.position = CGPoint(x: brick13.position.x + (brick13.size.width * 1.5), y: bottomSensor.position.y + (obstacleRight.size.height * 0.6))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl14 completed")
            gameOver = true
            
            if ch4lvl15Unlocked == false {
                continueString = "ch4lvl15"
                UserDefaults.standard.set("ch4lvl15", forKey: "continueString")
            }
            ch4lvl15Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl15Unlocked")
            UserDefaults.standard.synchronize()

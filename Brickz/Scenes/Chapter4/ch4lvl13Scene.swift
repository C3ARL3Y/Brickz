...
class ch4lvl13Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.width * 0.6), y: self.frame.height / 1.4)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x + (brick5.size.width), y: brick5.position.y - (brick5.size.height / 2))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x - (brick9.size.width), y: brick9.position.y + (brick9.size.height / 2))
        ...
        brick13.position = CGPoint(x: self.frame.width / 2, y: brick12.position.y + (brick12.size.height / 2))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick3.position.y - (brick3.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl13 completed")
            gameOver = true
            
            if ch4lvl14Unlocked == false {
                continueString = "ch4lvl14"
                UserDefaults.standard.set("ch4lvl14", forKey: "continueString")
            }
            ch4lvl14Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl14Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl14Unlocked == false {
                continueString = "ch4lvl14"
                UserDefaults.standard.set("ch3lvl14", forKey: "continueString")
            }
            ch4lvl14Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl14Unlocked")
            UserDefaults.standard.synchronize()

...
class ch4lvl11Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [9,9,9,9,9,9,9,9,9,9,9,9]
    ...
    var ch4lvl12Unlocked = UserDefaults.standard.bool(forKey: "ch4lvl12Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: self.frame.width - (brick3.size.width * 0.6), y: brick1.position.y)
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 2))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick2.position.x, y: brick2.position.y - (brick2.size.height * 2))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brick3.size.height * 2))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick4.position.x, y: brick4.position.y - (brick4.size.height * 2))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick5.position.x, y: brick5.position.y - (brick5.size.height * 2))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.height * 2))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height * 2))
        ...
        brick11.position = CGPoint(x: brick8.position.x, y: brick8.position.y - (brick8.size.height * 2))
        ...
        brick12.position = CGPoint(x: brick9.position.x, y: brick9.position.y - (brick9.size.height * 2))
        ...
        moveObstacleLeft = SKAction.moveTo(x: 0, duration: 2.2)
        moveObstacleRight = SKAction.moveTo(x: self.frame.width, duration: 2.2)
        ...
        obstacle3.position = CGPoint(x: 0 + (obstacle3.size.width * 0.6), y: brick4.position.y - (brick4.size.height))
        ...
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle4.size.width * 0.6), y: brick7.position.y - (brick7.size.height))
        ...
        obstacle5.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle5.position = CGPoint(x: 0 + (obstacle5.size.width * 0.6), y: brick10.position.y - (brick10.size.height))
        obstacle5.zPosition = 1
        obstacle5.color = SKColor.darkGray
        obstacle5.name = "obstacle5"
        self.addChild(obstacle5)
        obstacle5.run(moveObstacleRight)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "obstacle5") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacle5") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle5") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacle5") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        ...
        if Obstacle.name == "obstacle5" && Sensor.name == "leftBarrier" {
            obstacle5.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle5" && Sensor.name == "rightBarrier" {
            obstacle5.run(moveObstacleLeft)
        }
    }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name ==  "retryBtn" {
                let scene = ch4lvl11Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl12Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch4lvl11 completed")
            gameOver = true
            
            if ch4lvl12Unlocked == false {
                continueString = "ch4lvl12"
                UserDefaults.standard.set("ch4lvl12", forKey: "continueString")
            }
            ch4lvl12Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl12Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func explosionRadiusHitBrick(Radius: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch4lvl12Unlocked == false {
                continueString = "ch4lvl12"
                UserDefaults.standard.set("ch3lvl12", forKey: "continueString")
            }
            ch4lvl12Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl12Unlocked")
            UserDefaults.standard.synchronize()

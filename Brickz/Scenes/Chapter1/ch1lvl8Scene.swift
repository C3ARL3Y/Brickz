...
class ch1lvl8Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.15)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick11.position = CGPoint(x: self.frame.width / 2, y: brick10.position.y - (brick10.size.height))
        ...
        brick12.position = CGPoint(x: self.frame.width / 2, y: brick11.position.y - (brick11.size.height))
        ...
        brick13.position = CGPoint(x: self.frame.width / 2, y: brick12.position.y - (brick12.size.height))
        ...
        brick14.position = CGPoint(x: self.frame.width / 2, y: brick13.position.y - (brick13.size.height))
        ...
        brick15.position = CGPoint(x: self.frame.width / 2, y: brick14.position.y - (brick14.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            continueString = "ch1lvl9"
            UserDefaults.standard.set("ch1lvl9", forKey: "continueString")
            }
            ch1lvl9Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch1lvl9Unlocked")
            UserDefaults.standard.synchronize()

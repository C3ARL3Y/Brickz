...
class ch1lvl3Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [1,1,1,1,1,1,1]
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            continueString = "ch1lvl4"
            UserDefaults.standard.set("ch1lvl4", forKey: "continueString")
            }
            ch1lvl4Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch1lvl4Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if view?.frame.width == 768 && view?.frame.height == 1024 {
            if dxSpeed1 <= 20.0 && dxSpeed1 >= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: 9.5, dy: 0.0))
            } else if dxSpeed1 >= -20 && dxSpeed1 <= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: -(9.5), dy: 0.0))
            }
            if dySpeed1 <= 20.0 && dySpeed1 >= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: 9.5))
            } else if dySpeed1 >= -20 && dySpeed1 <= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: -(9.5)))
            }
            
            if dxSpeed2 <= 20.0 && dxSpeed2 >= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: 9.5, dy: 0.0))
            } else if dxSpeed2 >= -20 && dxSpeed2 <= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: -(9.5), dy: 0.0))
            }
            if dySpeed2 <= 20.0 && dySpeed2 >= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: 9.5))
            } else if dySpeed2 >= -20 && dySpeed2 <= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: -(9.5)))
            }
            
            if dxSpeed3 <= 20.0 && dxSpeed3 >= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: 9.5, dy: 0.0))
            } else if dxSpeed3 >= -20 && dxSpeed3 <= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: -(9.5), dy: 0.0))
            }
            if dySpeed3 <= 20.0 && dySpeed3 >= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: 9.5))
            ...
            if dxSpeed1 <= 20.0 && dxSpeed1 >= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: 21, dy: 0.0))
            } else if dxSpeed1 >= -20 && dxSpeed1 <= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: -(21), dy: 0.0))
            }
            if dySpeed1 <= 20.0 && dySpeed1 >= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: 21))
            } else if dySpeed1 >= -20 && dySpeed1 <= 0 {
                ball1.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: -(21)))
            }
            
            if dxSpeed2 <= 20.0 && dxSpeed2 >= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: 21, dy: 0.0))
            } else if dxSpeed2 >= -20 && dxSpeed2 <= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: -(21), dy: 0.0))
            }
            if dySpeed2 <= 20.0 && dySpeed2 >= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: 21))
            } else if dySpeed2 >= -20 && dySpeed2 <= 0 {
                ball2.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: -(21)))
            }
            
            if dxSpeed3 <= 20.0 && dxSpeed3 >= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: 21, dy: 0.0))
            } else if dxSpeed3 >= -20 && dxSpeed3 <= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: -(21), dy: 0.0))
            }
            if dySpeed3 <= 20.0 && dySpeed3 >= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: 21))
            } else if dySpeed3 >= -20 && dySpeed3 <= 0 {
                ball3.physicsBody?.applyImpulse(CGVector(dx: 0.0, dy: -(21)))
            }
            // Optional((1.39736270904541, 671.98193359375))

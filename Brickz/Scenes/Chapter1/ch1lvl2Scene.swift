...
class ch1lvl2Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [1,1,1,1,1]
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            continueString = "ch1lvl3"
            UserDefaults.standard.set("ch1lvl3", forKey: "continueString")
            }
            ch1lvl3Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch1lvl3Unlocked")
            UserDefaults.standard.synchronize()

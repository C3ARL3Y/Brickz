...
class ch3lvl6Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: (self.frame.width / 2) - (woodBrickSize.width * 2), y: self.frame.height / 1.6)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick1.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick1.position.y + (brick1.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x, y: brick1.position.y - (brick1.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick1.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick1.position.y + (brick1.size.height))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick1.position.x - (woodBrickSize.width / 2 + cementBrickSize.width / 2), y: brick1.position.y - (brick1.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: (self.frame.width / 2) + (woodBrickSize.width * 2), y: brick1.position.y)
        ...
        brick15.position = CGPoint(x: brick10.position.x + (woodBrickSize.width / 2 + cementBrickSize.width / 2), y: brick10.position.y + (brick10.size.height))
        ...
        brick16.position = CGPoint(x: brick10.position.x + (woodBrickSize.width / 2 + cementBrickSize.width / 2), y: brick10.position.y - (brick10.size.height))
        ...
        brick17.position = CGPoint(x: brick10.position.x - (woodBrickSize.width / 2 + cementBrickSize.width / 2), y: brick10.position.y + (brick10.size.height))
        ...
        brick18.position = CGPoint(x: brick10.position.x - (woodBrickSize.width / 2 + cementBrickSize.width / 2), y: brick10.position.y - (brick10.size.height))
        ...
        obstacleMiddle.size = CGSize(width: self.frame.height / 40, height: woodBrickSize.height * 3)
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: brick3.position.y + (brick3.size.height))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick14.position.y - (brick14.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl6 completed")
            gameOver = true
            
            if ch3lvl7Unlocked == false {
                continueString = "ch3lvl7"
                UserDefaults.standard.set("ch3lvl7", forKey: "continueString")
            }
            ch3lvl7Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl7Unlocked")
            UserDefaults.standard.synchronize()

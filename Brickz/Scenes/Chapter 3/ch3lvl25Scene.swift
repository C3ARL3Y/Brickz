...
class ch3lvl25Scene: SKScene, SKPhysicsContactDelegate {
    ...
    let brick67 = SKSpriteNode()
    let brick68 = SKSpriteNode()
    let brick69 = SKSpriteNode()
    let brick70 = SKSpriteNode()
    let brick71 = SKSpriteNode()
    let brick72 = SKSpriteNode()
    
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    var moveObstacleMiddle = SKAction()
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brick1.size.width / 2), y: self.frame.height / 1.8 + (cementBrickSize.height))
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick8.position.x - (brick8.size.width / 2), y: brick8.position.y + (brick8.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick16.position = CGPoint(x: brick15.position.x + (brick15.size.width / 2), y: brick15.position.y + (brick15.size.height))
        ...
        brick19.position = CGPoint(x: brick18.position.x + (brick18.size.width), y: brick18.position.y)
        ...
        brick22.position = CGPoint(x: brick21.position.x - (brick21.size.width / 2), y: brick21.position.y + (brick21.size.height))
        ...
        brick23.position = CGPoint(x: brick22.position.x - (brick22.size.width), y: brick22.position.y)
        ...
        brick26.position = CGPoint(x: brick25.position.x - (brick25.size.width), y: brick25.position.y)
        ...
        brick27.position = CGPoint(x: brick26.position.x + (brick26.size.width / 2), y: brick26.position.y + (brick26.size.height))
        ...
        brick28.position = CGPoint(x: brick27.position.x + (brick27.size.width), y: brick27.position.y)
        ...
        brick29.position = CGPoint(x: brick28.position.x + (brick28.size.width), y: brick28.position.y)
        ...
        brick31.position = CGPoint(x: brick30.position.x - (brick30.size.width / 2), y: brick30.position.y + (brick30.size.height))
        ...
        brick34.position = CGPoint(x: brick33.position.x + (brick33.size.width / 2), y: brick33.position.y + (brick33.size.height))
        ...
        brick37.position = CGPoint(x: self.frame.width / 2 - (brick37.size.width / 2), y: self.frame.height / 1.8 - (cementBrickSize.height))
        ...
        brick41.position = CGPoint(x: brick37.position.x + (brick37.size.width), y: brick37.position.y)
        ...
        brick42.position = CGPoint(x: brick41.position.x + (brick41.size.width), y: brick41.position.y)
        ...
        brick45.position = CGPoint(x: brick44.position.x - (brick44.size.width / 2), y: brick44.position.y - (brick44.size.height))
        ...
        brick47.position = CGPoint(x: brick46.position.x - (brick46.size.width), y: brick46.position.y)
        ...
        brick51.position = CGPoint(x: brick50.position.x - (brick50.size.width), y: brick50.position.y)
        ...
        brick52.position = CGPoint(x: brick51.position.x + (brick51.size.width / 2), y: brick51.position.y - (brick51.size.height))
        ...
        brick54.position = CGPoint(x: brick53.position.x + (brick53.size.width), y: brick53.position.y)
        ...
        brick56.position = CGPoint(x: brick55.position.x + (brick55.size.width), y: brick55.position.y)
        ...
        brick58.position = CGPoint(x: brick57.position.x - (brick57.size.width / 2), y: brick57.position.y - (brick57.size.height))
        ...
        brick59.position = CGPoint(x: brick58.position.x - (brick58.size.width), y: brick58.position.y)
        ...
        brick60.position = CGPoint(x: brick59.position.x - (brick59.size.height), y: brick59.position.y)
        ...
        brick61.position = CGPoint(x: brick60.position.x - (brick60.size.width), y: brick60.position.y)
        ...
        brick63.position = CGPoint(x: brick62.position.x + (brick62.size.width / 2), y: brick62.position.y - (brick62.size.height))
        ...
        brick64.position = CGPoint(x: brick63.position.x + (brick63.size.width), y: brick63.position.y)
        ...
        brick65.position = CGPoint(x: brick64.position.x + (brick64.size.width), y: brick64.position.y)
        ...
        brick66.texture = SKTexture(imageNamed: "brick2Texture6")
        brick66.size = cementBrickSize
        brick66.position = CGPoint(x: brick65.position.x + (brick65.size.width), y: brick65.position.y)
        brick66.name = "brick66"
        brick66.zPosition = 1
        self.addChild(brick66)
        brick66.physicsBody = SKPhysicsBody(rectangleOf: brick66.size)
        ...
        brick66.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick66.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick67.texture = SKTexture(imageNamed: "brick2Texture6")
        brick67.size = cementBrickSize
        brick67.position = CGPoint(x: brick66.position.x - (brick66.size.width / 2), y: brick66.position.y - (brick66.size.height))
        brick67.name = "brick67"
        brick67.zPosition = 1
        self.addChild(brick67)
        brick67.physicsBody = SKPhysicsBody(rectangleOf: brick67.size)
        brick67.physicsBody?.isDynamic = false
        brick67.physicsBody?.affectedByGravity = false
        brick67.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick67.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick67.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick68.texture = SKTexture(imageNamed: "brick2Texture6")
        brick68.size = cementBrickSize
        brick68.position = CGPoint(x: brick67.position.x - (brick67.size.width), y: brick67.position.y)
        brick68.name = "brick68"
        brick68.zPosition = 1
        self.addChild(brick68)
        brick68.physicsBody = SKPhysicsBody(rectangleOf: brick68.size)
        brick68.physicsBody?.isDynamic = false
        brick68.physicsBody?.affectedByGravity = false
        brick68.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick68.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick68.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick69.texture = SKTexture(imageNamed: "brick2Texture6")
        brick69.size = cementBrickSize
        brick69.position = CGPoint(x: brick68.position.x - (brick68.size.width), y: brick68.position.y)
        brick69.name = "brick69"
        brick69.zPosition = 1
        self.addChild(brick69)
        brick69.physicsBody = SKPhysicsBody(rectangleOf: brick69.size)
        brick69.physicsBody?.isDynamic = false
        brick69.physicsBody?.affectedByGravity = false
        brick69.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick69.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick69.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick70.texture = SKTexture(imageNamed: "brick2Texture6")
        brick70.size = cementBrickSize
        brick70.position = CGPoint(x: brick69.position.x + (brick69.size.width / 2), y: brick69.position.y - (brick69.size.height))
        brick70.name = "brick70"
        brick70.zPosition = 1
        self.addChild(brick70)
        brick70.physicsBody = SKPhysicsBody(rectangleOf: brick70.size)
        brick70.physicsBody?.isDynamic = false
        brick70.physicsBody?.affectedByGravity = false
        brick70.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick70.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick70.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick71.texture = SKTexture(imageNamed: "brick2Texture6")
        brick71.size = cementBrickSize
        brick71.position = CGPoint(x: brick70.position.x + (brick70.size.width), y: brick70.position.y)
        brick71.name = "brick71"
        brick71.zPosition = 1
        self.addChild(brick71)
        brick71.physicsBody = SKPhysicsBody(rectangleOf: brick71.size)
        brick71.physicsBody?.isDynamic = false
        brick71.physicsBody?.affectedByGravity = false
        brick71.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick71.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick71.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick72.texture = SKTexture(imageNamed: "brick2Texture6")
        brick72.size = cementBrickSize
        brick72.position = CGPoint(x: brick71.position.x - (brick71.size.width / 2), y: brick71.position.y - (brick71.size.height))
        brick72.name = "brick72"
        brick72.zPosition = 1
        self.addChild(brick72)
        brick72.physicsBody = SKPhysicsBody(rectangleOf: brick72.size)
        brick72.physicsBody?.isDynamic = false
        brick72.physicsBody?.affectedByGravity = false
        brick72.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick72.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick72.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        moveObstacleLeft = SKAction.moveTo(x: 0, duration: 2.5)
        moveObstacleRight = SKAction.moveTo(x: self.frame.width, duration: 2.5)
        moveObstacleMiddle = SKAction.moveTo(x: self.frame.width, duration: 1.25)
        
        obstacleTop.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.5), y: brick36.position.y + (brick36.size.height))
        ...
        obstacleMiddle.run(moveObstacleMiddle)
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.5), y: brick72.position.y - (brick72.size.height))
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "brick67") {
                ballHitBrick(Ball: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick67") && (secondBody.name == "ball") {
                ballHitBrick(Ball: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "brick68") {
                ballHitBrick(Ball: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick68") && (secondBody.name == "ball") {
                ballHitBrick(Ball: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "brick69") {
                ballHitBrick(Ball: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick69") && (secondBody.name == "ball") {
                ballHitBrick(Ball: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "brick70") {
                ballHitBrick(Ball: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick70") && (secondBody.name == "ball") {
                ballHitBrick(Ball: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "brick71") {
                ballHitBrick(Ball: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick71") && (secondBody.name == "ball") {
                ballHitBrick(Ball: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "brick72") {
                ballHitBrick(Ball: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick72") && (secondBody.name == "ball") {
                ballHitBrick(Ball: secondBody, Brick: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "brick66") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick66") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick67") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick67") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick68") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick68") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick69") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick69") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick70") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick70") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick71") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick71") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick72") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick72") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            ...
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick66") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick66") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick67") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick67") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick68") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick68") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick69") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick69") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick70") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick70") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick71") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick71") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick72") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick72") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if touchedNode.name == "nextBtn" {
                let scene = ch4lvl1Scene(size: CGSize(width: (view?.frame.width)!, height: (view?.frame.height)!))
                let transition = SKTransition.fade(withDuration: 0.5)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick66" {
            if brickCount > 1 {
                powerUp.position = brick66.position
            ...
            if brickLives[65] == 6 {
                brickLives[65] -= 1
                brick66.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[65] == 5 {
                brickLives[65] -= 1
                brick66.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[65] == 4 {
                brickLives[65] -= 1
                brick66.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[65] == 3 {
                brickLives[65] -= 1
                brick66.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[65] == 2 {
                brickLives[65] -= 1
                brick66.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[65] == 1 {
                brickLives[65] -= 1
                brickCount -= 1
                brick66.removeFromParent()
                brickExplosion.position = brick66.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick67" {
            if brickCount > 1 {
                powerUp.position = brick67.position
            ...
            if brickLives[66] == 6 {
                brickLives[66] -= 1
                brick67.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[66] == 5 {
                brickLives[66] -= 1
                brick67.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[66] == 4 {
                brickLives[66] -= 1
                brick67.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[66] == 3 {
                brickLives[66] -= 1
                brick67.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[66] == 2 {
                brickLives[66] -= 1
                brick67.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[66] == 1 {
                brickLives[66] -= 1
                brickCount -= 1
                brick67.removeFromParent()
                brickExplosion.position = brick67.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick68" {
            if brickCount > 1 {
                powerUp.position = brick68.position
            ...
            if brickLives[67] == 6 {
                brickLives[67] -= 1
                brick68.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[67] == 5 {
                brickLives[67] -= 1
                brick68.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[67] == 4 {
                brickLives[67] -= 1
                brick68.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[67] == 3 {
                brickLives[67] -= 1
                brick68.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[67] == 2 {
                brickLives[67] -= 1
                brick68.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[67] == 1 {
                brickLives[67] -= 1
                brickCount -= 1
                brick68.removeFromParent()
                brickExplosion.position = brick68.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick69" {
            if brickCount > 1 {
                powerUp.position = brick69.position
            ...
            if brickLives[68] == 6 {
                brickLives[68] -= 1
                brick69.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[68] == 5 {
                brickLives[68] -= 1
                brick69.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[68] == 4 {
                brickLives[68] -= 1
                brick69.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[68] == 3 {
                brickLives[68] -= 1
                brick69.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[68] == 2 {
                brickLives[68] -= 1
                brick69.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[68] == 1 {
                brickLives[68] -= 1
                brickCount -= 1
                brick69.removeFromParent()
                brickExplosion.position = brick69.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick70" {
            if brickCount > 1 {
                powerUp.position = brick70.position
            ...
            if brickLives[69] == 6 {
                brickLives[69] -= 1
                brick70.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[69] == 5 {
                brickLives[69] -= 1
                brick70.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[69] == 4 {
                brickLives[69] -= 1
                brick70.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[69] == 3 {
                brickLives[69] -= 1
                brick70.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[69] == 2 {
                brickLives[69] -= 1
                brick70.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[69] == 1 {
                brickLives[69] -= 1
                brickCount -= 1
                brick70.removeFromParent()
                brickExplosion.position = brick70.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick71" {
            if brickCount > 1 {
                powerUp.position = brick71.position
            ...
            if brickLives[70] == 6 {
                brickLives[70] -= 1
                brick71.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[70] == 5 {
                brickLives[70] -= 1
                brick71.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[70] == 4 {
                brickLives[70] -= 1
                brick71.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[70] == 3 {
                brickLives[70] -= 1
                brick71.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[70] == 2 {
                brickLives[70] -= 1
                brick71.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[70] == 1 {
                brickLives[70] -= 1
                brickCount -= 1
                brick71.removeFromParent()
                brickExplosion.position = brick71.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick72" {
            if brickCount > 1 {
                powerUp.position = brick72.position
            ...
            if brickLives[71] == 6 {
                brickLives[71] -= 1
                brick72.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[71] == 5 {
                brickLives[71] -= 1
                brick72.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[71] == 4 {
                brickLives[71] -= 1
                brick72.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[71] == 3 {
                brickLives[71] -= 1
                brick72.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[71] == 2 {
                brickLives[71] -= 1
                brick72.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[71] == 1 {
                brickLives[71] -= 1
                brickCount -= 1
                brick72.removeFromParent()
                brickExplosion.position = brick72.position
                self.addChild(brickExplosion)
                self.run(explosionWait, completion: {
                    brickExplosion.removeFromParent()
                })
        ...
        if brickCount == 0 {
            print("ch3lvl25 completed")
            gameOver = true
            
            if ch4lvl1Unlocked == false {
                continueString = "ch4lvl1"
                UserDefaults.standard.set("ch4lvl1", forKey: "continueString")
            }
            ch4lvl1Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch4lvl1Unlocked")
            UserDefaults.standard.synchronize()

...
class ch3lvl13Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height * 2))
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick2.position.x, y: brick2.position.y + (brick2.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick2.position.x - (brick2.size.width), y: brick2.position.y)
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y)
        ...
        brick11.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height))
        ...
        brick12.position = CGPoint(x: brick1.position.x - (brick1.size.width * 4), y: self.frame.height / 1.5)
        ...
        brick13.position = CGPoint(x: brick12.position.x, y: brick12.position.y + (brick12.size.height * 2))
        ...
        brick16.position = CGPoint(x: brick13.position.x - (brick13.size.width), y: brick13.position.y)
        ...
        brick17.position = CGPoint(x: brick13.position.x, y: brick13.position.y - (brick13.size.height))
        ...
        brick20.position = CGPoint(x: brick18.position.x, y: brick18.position.y + (brick18.size.height))
        ...
        brick21.position = CGPoint(x: brick18.position.x - (brick18.size.width), y: brick18.position.y)
        ...
        brick22.position = CGPoint(x: brick18.position.x, y: brick18.position.y - (brick18.size.height))
        ...
        brick23.position = CGPoint(x: brick1.position.x + (brick1.size.width * 4), y: brick1.position.y)
        ...
        brick24.position = CGPoint(x: brick23.position.x, y: brick23.position.y + (brick23.size.height * 2))
        ...
        brick26.position = CGPoint(x: brick24.position.x, y: brick24.position.y + (brick24.size.height))
        ...
        brick27.position = CGPoint(x: brick24.position.x - (brick24.size.width), y: brick24.position.y)
        ...
        brick28.position = CGPoint(x: brick24.position.x, y: brick24.position.y - (brick24.size.height))
        ...
        brick29.position = CGPoint(x: brick23.position.x, y: brick23.position.y - (brick23.size.height * 2))
        ...
        brick31.position = CGPoint(x: brick29.position.x, y: brick29.position.y + (brick29.size.height))
        ...
        brick32.position = CGPoint(x: brick29.position.x - (brick29.size.width), y: brick29.position.y)
        ...
        brick33.position = CGPoint(x: brick29.position.x, y: brick29.position.y - (brick29.size.height))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick4.position.y + (brick4.size.height * 0.7))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick11.position.y - (brick11.size.height * 0.7))
        ...
        moveObstacleUp = SKAction.moveTo(y: topSensor.position.y, duration: 1.2)
        moveObstacleDown = SKAction.moveTo(y: bottomSensor.position.y, duration: 1.2)
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: topSensor.position.y + (obstacleTop.size.height * 0.7))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: bottomSensor.position.y - (obstacleBottom.size.height * 0.7))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch3lvl14Unlocked == false {
                continueString = "ch3lvl14"
                UserDefaults.standard.set("ch3lvl14", forKey: "continueString")
            }
            ch3lvl14Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl14Unlocked")
            UserDefaults.standard.synchronize()

...
class ch3lvl10Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 + (cementBrickSize.width / 2), y: self.frame.height / 1.5)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick1.physicsBody?.linearDamping = 1
        
        brick2.texture = SKTexture(imageNamed: "brick2Texture6")
        brick2.size = cementBrickSize
        brick2.position = CGPoint(x: self.frame.width / 2 - (cementBrickSize.width / 2), y: brick1.position.y)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick2.physicsBody?.linearDamping = 1
        ...
        brick3.physicsBody?.linearDamping = 1
        ...
        brick4.physicsBody?.linearDamping = 1
        ...
        brick5.physicsBody?.linearDamping = 1
        ...
        brick6.physicsBody?.linearDamping = 1
        ...
        brick7.physicsBody?.linearDamping = 1
        ...
        brick8.physicsBody?.linearDamping = 1
        ...
        brick9.physicsBody?.linearDamping = 1
        ...
        brick10.physicsBody?.linearDamping = 1
        
        brick11.texture = SKTexture(imageNamed: "brick2Texture6")
        brick11.size = cementBrickSize
        brick11.position = CGPoint(x: brick4.position.x - (brick4.size.width / 2), y: brick4.position.y + (brick4.size.height))
        ...
        brick11.physicsBody?.linearDamping = 1
        ...
        brick12.physicsBody?.linearDamping = 1
        ...
        brick13.physicsBody?.linearDamping = 1
        ...
        brick14.physicsBody?.linearDamping = 1
        ...
        brick15.physicsBody?.linearDamping = 1
        ...
        brick16.physicsBody?.linearDamping = 1
        ...
        brick17.physicsBody?.linearDamping = 1
        ...
        brick18.physicsBody?.linearDamping = 1
        ...
        brick19.physicsBody?.linearDamping = 1
        ...
        brick20.physicsBody?.linearDamping = 1
        ...
        brick21.physicsBody?.linearDamping = 1
        ...
        brick22.physicsBody?.linearDamping = 1
        ...
        brick23.physicsBody?.linearDamping = 1
        ...
        brick24.physicsBody?.linearDamping = 1
        ...
        brick25.physicsBody?.linearDamping = 1
        ...
        brick26.physicsBody?.linearDamping = 1
        ...
        brick27.physicsBody?.linearDamping = 1
        ...
        brick28.physicsBody?.linearDamping = 1
        
        obstacle1.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle1.position = CGPoint(x: 0 + (obstacle1.size.width * 0.6), y: self.frame.height / 2)
        ...
        obstacle1.physicsBody?.linearDamping = 1
        
        obstacle2.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle2.position = CGPoint(x: self.frame.width - (obstacle1.size.width * 0.6), y: obstacle1.position.y - (woodBrickSize.height * 3))
        ...
        obstacle2.physicsBody?.linearDamping = 1
        
        obstacle3.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacle3.position = CGPoint(x: 0 + (obstacle1.size.width * 0.6), y: obstacle2.position.y - (woodBrickSize.height * 3))
        ...
        obstacle3.physicsBody?.linearDamping = 1
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl1 completed")
            gameOver = true
            
            if ch3lvl11Unlocked == false {
                continueString = "ch3lvl11"
                UserDefaults.standard.set("ch3lvl11", forKey: "continueString")
            }
            ch3lvl11Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl11Unlocked")
            UserDefaults.standard.synchronize()
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        //print("\(Int((brick1.physicsBody?.velocity.dx)!) + Int((ball1.physicsBody?.velocity.dy)!))")

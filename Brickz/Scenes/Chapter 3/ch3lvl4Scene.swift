...
class ch3lvl4Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (cementBrickSize.width * 0.6), y: self.frame.height / 1.35)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick2.position.x, y: brick2.position.y - (brick2.size.height * 2))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x + (brick4.size.width), y: brick4.position.y - (brick4.size.width / 2))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y - (brick7.size.width / 2))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick8.position.x, y: brick8.position.y - (brick8.size.height * 2))
        ...
        brick12.position = CGPoint(x: brick10.position.x - (brick10.size.width), y: brick10.position.y - (brick10.size.height / 2))
        ...
        obstacleMiddle.size = CGSize(width: self.frame.width / 4, height: self.frame.height / 40)
        obstacleMiddle.position = CGPoint(x: self.frame.width / 2, y: brick2.position.y - (brick2.size.height))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick11.position.y - (brick11.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl4 completed")
            gameOver = true
            
            if ch3lvl5Unlocked == false {
                continueString = "ch3lvl5"
                UserDefaults.standard.set("ch3lvl5", forKey: "continueString")
            }
            ch3lvl5Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl5Unlocked")
            UserDefaults.standard.synchronize()

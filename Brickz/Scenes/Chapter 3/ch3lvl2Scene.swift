...
class ch3lvl2Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6]
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl2 completed")
            gameOver = true
            
            if ch3lvl3Unlocked == false {
                continueString = "ch3lvl3"
                UserDefaults.standard.set("ch3lvl3", forKey: "continueString")
            }
            ch3lvl3Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl3Unlocked")
            UserDefaults.standard.synchronize()

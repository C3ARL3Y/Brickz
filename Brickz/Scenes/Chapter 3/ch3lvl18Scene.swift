...
class ch3lvl18Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick5.position = CGPoint(x: brick3.position.x + (brick3.size.width), y: brick3.position.y - (brick3.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick6.position.x - (brick6.size.width), y: brick6.position.y - (brick6.size.width))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick5.position.x - (brick5.size.width), y: brick5.position.y - (brick5.size.width))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick4.position.x - (brick4.size.width), y: brick4.position.y - (brick4.size.height))
        ...
        brick14.position = CGPoint(x: brick13.position.x + (brick13.size.width * 2), y: brick13.position.y)
        ...
        brick17.position = CGPoint(x: brick16.position.x - (brick16.size.width * 2), y: brick16.position.y)
        ...
        brick18.position = CGPoint(x: brick17.position.x - (brick17.size.width * 2), y: brick17.position.y)
        ...
        brick19.position = CGPoint(x: brick18.position.x - (brick18.size.width * 2), y: brick18.position.y)
        ...
        brick20.position = CGPoint(x: brick19.position.x - (brick19.size.width * 2), y: brick19.position.y)
        ...
        brick21.position = CGPoint(x: brick20.position.x - (brick20.size.width * 2), y: brick20.position.y)
        ...
        brick22.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brick21.size.height) * 2)
        ...
        brick24.position = CGPoint(x: brick23.position.x + (brick23.size.width * 2), y: brick23.position.y)
        ...
        brick26.position = CGPoint(x: brick25.position.x + (brick25.size.width * 2), y: brick25.position.y)
        ...
        brick27.position = CGPoint(x: brick26.position.x + (brick26.size.width * 2), y: brick26.position.y)
        ...
        brick29.position = CGPoint(x: brick28.position.x - (brick28.size.width * 2), y: brick28.position.y)
        ...
        brick30.position = CGPoint(x: brick29.position.x - (brick29.size.width * 2), y: brick29.position.y)
        ...
        brick31.position = CGPoint(x: brick30.position.x - (brick30.size.width * 2), y: brick30.position.y)
        ...
        brick33.position = CGPoint(x: brick32.position.x + (brick32.size.width), y: brick32.position.y - (brick32.size.height))
        ...
        brick34.position = CGPoint(x: brick33.position.x + (brick33.size.width * 2), y: brick33.position.y)
        ...
        brick35.position = CGPoint(x: brick34.position.x + (brick34.size.width * 2 ), y: brick34.position.y)
        ...
        brick36.position = CGPoint(x: brick35.position.x + (brick35.size.width * 2), y: brick35.position.y)
        ...
        brick37.position = CGPoint(x: brick36.position.x - (brick36.size.width * 2), y: brick36.position.y)
        ...
        brick38.position = CGPoint(x: brick37.position.x + (brick37.size.width), y: brick37.position.y - (brick37.size.height))
        ...
        brick40.position = CGPoint(x: brick39.position.x - (brick39.size.width * 2), y: brick39.position.y)
        ...
        brick41.position = CGPoint(x: brick40.position.x + (brick40.size.width), y: brick40.position.y - (brick40.size.height))
        ...
        brick42.position = CGPoint(x: brick41.position.x + (brick41.size.width * 2), y: brick41.position.y)
        ...
        brick43.position = CGPoint(x: brick42.position.x - (brick42.size.width), y: brick42.position.y - (brick42.size.height))
        ...
        leftSensor.position = CGPoint(x: brick21.position.x - (brick21.size.width / 2), y: brick21.position.y - (brick21.size.height))
        ...
        rightSensor.position = CGPoint(x: brick16.position.x + (brick16.size.width / 2), y: brick16.position.y - (brick16.size.height))
        ...
        obstacleTop.size = CGSize(width: self.frame.width / 7, height: self.frame.height / 40)
        obstacleTop.position = CGPoint(x: leftSensor.position.x + (obstacleTop.size.width * 0.7), y: brick1.position.y + (brick1.size.height))
        ...
        obstacleMiddle.size = CGSize(width: self.frame.width / 7, height: self.frame.height / 40)
        obstacleMiddle.position = CGPoint(x: rightSensor.position.x - (obstacleMiddle.size.width * 0.7), y: brick21.position.y - (brick21.size.height))
        ...
        obstacleBottom.position = CGPoint(x: leftSensor.position.x + (obstacleBottom.size.width * 0.7), y: brick43.position.y - (brick43.size.height))
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "obstacleMiddle") && (secondBody.name == "leftSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftSensor") && (secondBody.name == "obstacleMiddle") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacleMiddle") && (secondBody.name == "rightSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightSensor") && (secondBody.name == "obstacleMiddle") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        ...
        if Obstacle.name == "obstacleMiddle" && Sensor.name == "leftSensor" {
            obstacleMiddle.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacleMiddle" && Sensor.name == "rightSensor" {
            obstacleMiddle.run(moveObstacleLeft)
        }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl18 completed")
            gameOver = true
            
            if ch3lvl19Unlocked == false {
                continueString = "ch3lvl19"
                UserDefaults.standard.set("ch3lvl19", forKey: "continueString")
            }
            ch3lvl19Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl19Unlocked")
            UserDefaults.standard.synchronize()

...
class ch3lvl16Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick8.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y)
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick15.position = CGPoint(x: brick12.position.x, y: brick12.position.y - (brick12.size.height * 2))
        ...
        brick28.position = CGPoint(x: brick25.position.x, y: brick25.position.y - (brick25.size.height * 2))
        ...
        brick39.position = CGPoint(x: self.frame.width / 2, y: brick38.position.y - (brick38.size.height * 2))
        ...
        brick7.position = CGPoint(x: brick39.position.x + (brick39.size.width), y: brick39.position.y - (brick39.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick13.position = CGPoint(x: brick39.position.x - (brick39.size.width), y: brick39.position.y - (brick39.size.height))
        ...
        brick14.position = CGPoint(x: brick39.position.x, y: brick39.position.y - (brick39.size.height * 4))
        ...
        brick26.position = CGPoint(x: brick14.position.x + (brick14.size.width), y: brick14.position.y + (brick14.size.height))
        ...
        brick27.position = CGPoint(x: brick14.position.x - (brick14.size.width), y: brick14.position.y + (brick14.size.width))
        ...
        obstacle1.position = CGPoint(x: 0 + (obstacle1.size.width * 0.7), y: brick1.position.y + (brick1.size.height))
        ...
        obstacle2.position = CGPoint(x: self.frame.width - (obstacle2.size.width * 0.7), y: brick1.position.y - (brick1.size.height))
        ...
        obstacle3.position = CGPoint(x: 0 + (obstacle3.size.width * 0.7), y: brick15.position.y - (brick15.size.height))
        ...
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle4.size.width * 0.7), y: brick28.position.y - (brick28.size.height))
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "brick36") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "ball36") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl16 completed")
            gameOver = true
            
            if ch3lvl17Unlocked == false {
                continueString = "ch3lvl17"
                UserDefaults.standard.set("ch3lvl17", forKey: "continueString")
            }
            ch3lvl17Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl17Unlocked")
            UserDefaults.standard.synchronize()

...
class ch3lvl3Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 + (brick1.size.width / 2), y: self.frame.height / 1.6)
        brick1.name = "brick1"
        brick1.zPosition = 1
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl3 completed")
            gameOver = true
            
            if ch3lvl4Unlocked == false {
                continueString = "ch3lvl4"
                UserDefaults.standard.set("ch3lvl4", forKey: "continueString")
            }
            ch3lvl4Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl4Unlocked")
            UserDefaults.standard.synchronize()

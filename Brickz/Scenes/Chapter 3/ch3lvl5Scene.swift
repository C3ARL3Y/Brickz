...
class ch3lvl5Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick1.position.y)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: brick1.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick1.position.y)
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick2.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)) ,y: brick2.position.y)
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick3.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick3.position.y)
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick6.position.y)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick7.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick7.position.y)
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick8.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick8.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x + (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick9.position.y)
        ...
        brick12.position = CGPoint(x: brick11.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick11.position.y)
        ...
        brick13.position = CGPoint(x: brick12.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick12.position.y)
        ...
        brick14.position = CGPoint(x: brick13.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick13.position.y)
        ...
        brick15.position = CGPoint(x: brick14.position.x - (woodBrickSize.width / 2 + (cementBrickSize.width / 2)), y: brick14.position.y)
        ...
        obstacle2.position = CGPoint(x: self.frame.width / 2, y: brick6.position.y + (brick6.size.height))
        ...
        obstacle3.position = CGPoint(x: self.frame.width / 2, y: brick11.position.y + (brick11.size.height))
        ...
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle4.size.width * 0.6), y: brick11.position.y - (brick11.size.height))
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "obstacle1" && Barrier.name == "leftBarrier" {
            obstacle1.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle1" && Barrier.name == "rightBarrier" {
            obstacle1.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacle2" && Barrier.name == "leftBarrier" {
            obstacle2.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle2" && Barrier.name == "rightBarrier" {
            obstacle2.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacle3" && Barrier.name == "leftBarrier" {
            obstacle3.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle3" && Barrier.name == "rightBarrier" {
            obstacle3.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacle4" && Barrier.name == "leftBarrier" {
            obstacle4.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacle4" && Barrier.name == "rightBarrier" {
            obstacle4.run(moveObstacleLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl5 completed")
            gameOver = true
            
            if ch3lvl6Unlocked == false {
                continueString = "ch3lvl6"
                UserDefaults.standard.set("ch3lvl6", forKey: "continueString")
            }
            ch3lvl6Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl6Unlocked")
            UserDefaults.standard.synchronize()

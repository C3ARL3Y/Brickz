...
class ch3lvl11Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick11.position = CGPoint(x: brick5.position.x - (brick5.size.width * 3), y: brick5.position.y)
        ...
        brick16.position = CGPoint(x: brick9.position.x - (brick9.size.width * 3), y: brick9.position.y)
        ...
        brick21.position = CGPoint(x: brick5.position.x + (brick5.size.width * 3), y: brick5.position.y)
        ...
        brick26.position = CGPoint(x: brick9.position.x + (brick9.size.width * 3), y: brick9.position.y)
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick13.position.y + (brick13.size.height * 0.7))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: brick13.position.y + (brick13.size.height))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick10.position.y - (brick10.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl11 completed")
            gameOver = true
            
            if ch3lvl12Unlocked == false {
                continueString = "ch3lvl12"
                UserDefaults.standard.set("ch3lvl12", forKey: "continueString")
            }
            ch3lvl12Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl12Unlocked")
            UserDefaults.standard.synchronize()

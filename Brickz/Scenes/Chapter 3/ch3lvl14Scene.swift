...
class ch3lvl14Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick3.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y + (brick1.size.width))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x - (brick5.size.width * 2), y: brick1.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (brick6.size.height))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick6.position.x - (brick6.size.width), y: brick6.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.height))
        ...
        brick11.position = CGPoint(x: brick2.position.x + (brick2.size.width * 2), y: brick1.position.y)
        ...
        brick13.position = CGPoint(x: brick11.position.x, y: brick11.position.y + (brick11.size.height))
        ...
        brick14.position = CGPoint(x: brick11.position.x - (brick11.size.width), y: brick11.position.y)
        ...
        brick15.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.height))
        ...
        brick16.position = CGPoint(x: brick1.position.x + (brick1.size.width * 3), y: brick15.position.y - (brick15.size.height * 3))
        ...
        brick19.position = CGPoint(x: brick16.position.x - (brick16.size.width), y: brick16.position.y + (brick16.size.height))
        ...
        brick21.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 4))
        ...
        brick23.position = CGPoint(x: brick21.position.x, y: brick21.position.y + (brick21.size.height))
        ...
        brick24.position = CGPoint(x: brick21.position.x - (brick21.size.width), y: brick21.position.y)
        ...
        brick25.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brick21.size.height))
        ...
        brick26.position = CGPoint(x: brick21.position.x - (brick17.size.width * 3), y: brick21.position.y)
        ...
        brick29.position = CGPoint(x: brick26.position.x - (brick26.size.width), y: brick26.position.y + (brick26.size.height))
        ...
        brick31.position = CGPoint(x: self.frame.width / 2, y: brick30.position.y - (brick30.size.height * 3))
        ...
        brick32.position = CGPoint(x: brick31.position.x + (brick31.size.width), y: brick31.position.y - (brick31.size.width))
        ...
        brick33.position = CGPoint(x: brick31.position.x + (brick31.size.width), y: brick31.position.y + (brick31.size.height))
        ...
        brick34.position = CGPoint(x: brick31.position.x - (brick31.size.width), y: brick31.position.y + (brick31.size.height))
        ...
        brick35.position = CGPoint(x: brick31.position.x - (brick31.size.width), y: brick31.position.y - (brick31.size.height))
        ...
        obstacle1.position = CGPoint(x: 0 + (obstacle1.size.width * 0.6), y: brick4.position.y + (brick5.size.height))
        ...
        obstacle2.position = CGPoint(x: self.frame.width - (obstacle2.size.width * 0.6), y: brick15.position.y - (brick15.size.height))
        ...
        obstacle3.position = CGPoint(x: 0 + (obstacle3.size.width * 0.6), y: brick20.position.y - (brick20.size.height))
        ...
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle4.size.width * 0.6), y: brick35.position.y - (brick30.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl14 completed")
            gameOver = true
            
            if ch3lvl15Unlocked == false {
                continueString = "ch3lvl15"
                UserDefaults.standard.set("ch3lvl15", forKey: "continueString")
            }
            ch3lvl15Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl15Unlocked")
            UserDefaults.standard.synchronize()

...
class ch3lvl20Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.45)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y - (brick1.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick11.position = CGPoint(x: brick3.position.x + (brick3.size.width), y: brick3.position.y - (brick3.size.height))
        ...
        brick13.position = CGPoint(x: brick12.position.x, y: brick1.position.y)
        ...
        brick21.position = CGPoint(x: brick20.position.x, y: brick20.position.y + (brick20.size.height))
        ...
        brick22.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height))
        ...
        brick26.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y)
        ...
        brick30.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height))
        ...
        brick31.position = CGPoint(x: brick30.position.x - (brick30.size.width), y: brick30.position.y - (brick30.size.height))
        ...
        brick34.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y)
        ...
        brick35.position = CGPoint(x: brick34.position.x - (brick34.size.width), y: brick34.position.y + (brick34.size.height))
        ...
        brick38.position = CGPoint(x: self.frame.width / 2, y: brick33.position.y - (brick33.size.height * 3))
        ...
        brick39.position = CGPoint(x: brick38.position.x + (brick38.size.width), y: brick38.position.y - (brick38.size.height))
        ...
        brick48.position = CGPoint(x: self.frame.width / 2, y: brick47.position.y - (brick47.size.height))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.7), y: brick4.position.y + (brick4.size.height))
        ...
        obstacleMiddle.position = CGPoint(x: self.frame.width - (obstacleMiddle.size.width * 0.7), y: brick38.position.y + (brick38.size.height))
        ...
        obstacleBottom.position = CGPoint(x: 0 + (obstacleBottom.size.width * 0.7), y: brick48.position.y - (brick48.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl20 completed")
            gameOver = true
            
            if ch3lvl21Unlocked == false {
                continueString = "ch3lvl21"
                UserDefaults.standard.set("ch3lvl21", forKey: "continueString")
            }
            ch3lvl21Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl21Unlocked")
            UserDefaults.standard.synchronize()

...
class ch3lvl9Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.1 - (brick1.size.height * 4))
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick1.position.x + (brick1.size.width * 4), y: brick1.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick6.position.x - (brick6.size.width), y: brick6.position.y + (brick6.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick11.position = CGPoint(x: brick1.position.x - (brick1.size.width * 4), y: brick1.position.y)
        ...
        brick15.position = CGPoint(x: brick11.position.x - (brick11.size.width), y: brick11.position.y - (brick11.size.height))
        ...
        brick16.position = CGPoint(x: brick1.position.x, y: brick11.position.y - (brick11.size.height * 4))
        ...
        obstacle1.position = CGPoint(x: 0 + (obstacle1.size.width * 0.6), y: brick5.position.y + (brick5.size.height * 3))
        ...
        obstacle2.position = CGPoint(x: self.frame.width - (obstacle2.size.width * 0.6), y: brick10.position.y - (brick10.size.height))
        ...
        obstacle3.position = CGPoint(x: 0 + (obstacle3.size.width * 0.6), y: brick16.position.y - (brick16.size.height * 2))
        ...
        obstacle4.position = CGPoint(x: self.frame.width - (obstacle4.size.width * 0.6), y: brick21.position.y - (brick20.size.height * 2))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl9 completed")
            gameOver = true
            
            if ch3lvl10Unlocked == false {
                continueString = "ch3lvl10"
                UserDefaults.standard.set("ch3lvl10", forKey: "continueString")
            }
            ch3lvl10Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl10Unlocked")
            UserDefaults.standard.synchronize()

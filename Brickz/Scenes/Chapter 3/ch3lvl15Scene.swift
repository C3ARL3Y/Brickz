...
class ch3lvl15Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (cementBrickSize.width / 2), y: self.frame.height / 1.3)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + brick1.size.height)
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick36.position.y - brick36.size.height)
        ...
        obstacleLeft.position = CGPoint(x: 0 + (obstacleLeft.size.width), y: topSensor.position.y - (obstacleLeft.size.height * 0.7))
        ...
        obstacleRight.position = CGPoint(x: self.frame.width - (obstacleRight.size.width), y: bottomSensor.position.y + (obstacleRight.size.height * 0.7))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl15 completed")
            gameOver = true
            
            if ch3lvl16Unlocked == false {
                continueString = "ch3lvl16"
                UserDefaults.standard.set("ch3lvl16", forKey: "continueString")
            }
            ch3lvl16Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl16Unlocked")
            UserDefaults.standard.synchronize()

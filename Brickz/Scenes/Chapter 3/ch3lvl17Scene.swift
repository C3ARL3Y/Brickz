...
class ch3lvl17Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (cementBrickSize.width * 0.7), y: self.frame.height / 1.28)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick8.position.x, y: brick8.position.y - (brick8.size.height))
        ...
        brick11.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height * 2))
        ...
        brick18.position = CGPoint(x: brick14.position.x + (brick14.size.width), y: brick14.position.y + (brick14.size.height))
        ...
        brick20.position = CGPoint(x: brick18.position.x + (brick18.size.width), y: brick18.position.y)
        ...
        brick21.position = CGPoint(x: self.frame.width - (brick21.size.width * 0.7), y: brick1.position.y)
        ...
        brick28.position = CGPoint(x: brick21.position.x - (brick21.size.width), y: brick21.position.y - (brick21.size.height))
        ...
        brick30.position = CGPoint(x: brick28.position.x, y: brick28.position.y - (brick28.size.height))
        ...
        brick31.position = CGPoint(x: brick27.position.x, y: brick27.position.y - (brick27.size.height * 2))
        ...
        brick38.position = CGPoint(x: brick34.position.x - (brick34.size.width), y: brick34.position.y +  (brick34.size.height))
        ...
        brick40.position = CGPoint(x: brick38.position.x, y: brick38.position.y + (brick38.size.height))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.7), y: brick1.position.y + (brick1.size.height))
        ...
        obstacleMiddle.position = CGPoint(x: self.frame.width - (obstacleMiddle.size.width * 0.7), y: brick27.position.y - (brick27.size.height))
        ...
        obstacleBottom.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.7), y: brick17.position.y - (brick17.size.height))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl17 completed")
            gameOver = true
            
            if ch3lvl18Unlocked == false {
                continueString = "ch3lvl18"
                UserDefaults.standard.set("ch3lvl18", forKey: "continueString")
            }
            ch3lvl18Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl18Unlocked")
            UserDefaults.standard.synchronize()

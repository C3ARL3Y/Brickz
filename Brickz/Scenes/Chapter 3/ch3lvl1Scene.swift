...
class ch3lvl1Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6]
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            if ch3lvl2Unlocked == false {
                continueString = "ch3lvl2"
                UserDefaults.standard.set("ch3lvl2", forKey: "continueString")
            }
            ch3lvl2Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl2Unlocked")
            UserDefaults.standard.synchronize()

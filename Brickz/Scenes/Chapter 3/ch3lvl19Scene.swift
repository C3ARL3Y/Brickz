...
class ch3lvl19Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick16.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.height * 4))
        ...
        brick21.position = CGPoint(x: brick16.position.x + (brick16.size.width * 4), y: brick16.position.y)
        ...
        brick26.position = CGPoint(x: brick21.position.x + (brick21.size.width * 4), y: brick21.position.y)
        ...
        brick31.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brick26.size.height * 4))
        ...
        brick32.position = CGPoint(x: brick31.position.x + (brick31.size.width), y: brick31.position.y - (brick31.size.height))
        ...
        brick36.position = CGPoint(x: brick31.position.x - (brick1.size.width * 4), y: brick31.position.y)
        ...
        brick37.position = CGPoint(x: brick36.position.x + (brick36.size.width), y: brick36.position.y - (brick36.size.height))
        ...
        brick38.position = CGPoint(x: brick36.position.x + (brick36.size.width), y: brick36.position.y + (brick36.size.height))
        ...
        brick39.position = CGPoint(x: brick36.position.x - (brick36.size.width), y: brick36.position.y + (brick36.size.height))
        ...
        brick40.position = CGPoint(x: brick36.position.x - (brick36.size.width), y: brick36.position.y - (brick36.size.height))
        ...
        brick41.position = CGPoint(x: brick36.position.x - (brick1.size.width * 4), y: brick36.position.y)
        ...
        brick42.position = CGPoint(x: brick41.position.x + (brick41.size.width), y: brick41.position.y - (brick41.size.height))
        ...
        brick43.position = CGPoint(x: brick41.position.x + (brick41.size.width), y: brick41.position.y + (brick41.size.height))
        ...
        brick44.position = CGPoint(x: brick41.position.x - (brick41.size.width), y: brick41.position.y + (brick41.size.height))
        ...
        brick45.position = CGPoint(x: brick41.position.x - (brick41.size.width), y: brick41.position.y - (brick41.size.height))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + (brick1.size.height * 1.5))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick41.position.y - (brick41.size.height * 1.5))
        ...
        obstacleLeft.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2), y: topSensor.position.y - (obstacleLeft.size.height * 0.7))
        ...
        obstacleRight.position = CGPoint(x: brick1.position.x + (brick1.size.width * 2), y: bottomSensor.position.y + (obstacleRight.size.height * 0.7))
        ...
        obstacleTop.position = CGPoint(x: self.frame.width - (obstacleTop.size.width * 0.7), y: brick1.position.y - (brick1.size.height * 2))
        ...
        obstacleBottom.position = CGPoint(x: 0 + (obstacleBottom.size.width * 0.7), y: brick16.position.y - (brick16.size.height * 2))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl19 completed")
            gameOver = true
            
            if ch3lvl20Unlocked == false {
                continueString = "ch3lvl20"
                UserDefaults.standard.set("ch3lvl20", forKey: "continueString")
            }
            ch3lvl20Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl20Unlocked")
            UserDefaults.standard.synchronize()

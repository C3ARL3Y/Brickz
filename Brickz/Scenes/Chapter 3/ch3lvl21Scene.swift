...
class ch3lvl21Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.25)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick11.position = CGPoint(x: brick1.position.x + (brick1.size.width * 2), y: brick1.position.y)
        ...
        brick12.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.height))
        ...
        brick16.position = CGPoint(x: brick15.position.x, y: brick15.position.y - (brick15.size.height))
        ...
        brick19.position = CGPoint(x: brick18.position.x, y: brick18.position.y - (brick18.size.height))
        ...
        brick21.position = CGPoint(x: brick11.position.x + (brick11.size.width * 2), y: brick11.position.y)
        ...
        brick22.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brick21.size.height))
        ...
        brick27.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brick26.size.height))
        ...
        brick31.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2) , y: brick1.position.y)
        ...
        brick34.position = CGPoint(x: brick33.position.x , y: brick33.position.y - (brick33.size.height))
        ...
        brick36.position = CGPoint(x: brick35.position.x , y: brick35.position.y - (brick35.size.height))
        ...
        brick37.position = CGPoint(x: brick36.position.x, y: brick36.position.y - (brick36.size.height))
        ...
        brick38.position = CGPoint(x: brick37.position.x , y: brick37.position.y - (brick37.size.height))
        ...
        brick39.position = CGPoint(x: brick38.position.x , y: brick38.position.y - (brick38.size.height))
        ...
        brick40.position = CGPoint(x: brick39.position.x, y: brick39.position.y - (brick39.size.height))
        ...
        brick41.position = CGPoint(x: brick31.position.x - (brick31.size.width * 2), y: brick31.position.y)
        ...
        brick42.position = CGPoint(x: brick41.position.x, y: brick41.position.y - (brick41.size.height))
        ...
        brick43.position = CGPoint(x: brick42.position.x, y: brick42.position.y - (brick42.size.height))
        ...
        brick44.position = CGPoint(x: brick43.position.x, y: brick43.position.y - (brick43.size.height))
        ...
        brick45.position = CGPoint(x: brick44.position.x, y: brick44.position.y - (brick44.size.height))
        ...
        brick46.position = CGPoint(x: brick45.position.x, y: brick45.position.y - (brick45.size.height))
        ...
        brick47.position = CGPoint(x: brick46.position.x, y: brick46.position.y - (brick46.size.height))
        ...
        brick48.position = CGPoint(x: brick47.position.x, y: brick47.position.y - (brick47.size.height))
        ...
        brick49.position = CGPoint(x: brick48.position.x, y: brick48.position.y - (brick48.size.height))
        ...
        brick50.position = CGPoint(x: brick49.position.x, y: brick49.position.y - (brick49.size.height))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + (brick1.size.height * 0.5))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick10.position.y - (brick10.size.height * 0.5))
        ...
        obstacle1.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7.5)
        obstacle1.position = CGPoint(x: brick41.position.x - (brick41.size.width), y: topSensor.position.y - (obstacle1.size.height * 0.7))
        obstacle1.zPosition = 1
        obstacle1.color = SKColor.brown
        obstacle1.name = "obstacle1"
        self.addChild(obstacle1)
        obstacle1.run(moveObstacleDown)
        ...
        obstacle2.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7.5)
        obstacle2.position = CGPoint(x: brick31.position.x - (brick31.size.width), y: bottomSensor.position.y + (obstacle2.size.height * 0.7))
        obstacle2.zPosition = 1
        obstacle2.color = SKColor.brown
        obstacle2.name = "obstacle2"
        self.addChild(obstacle2)
        obstacle2.run(moveObstacleUp)
        ...
        obstacle3.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7.5)
        obstacle3.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: topSensor.position.y - (obstacle3.size.height * 0.7))
        obstacle3.zPosition = 1
        obstacle3.color = SKColor.brown
        obstacle3.name = "obstacle3"
        self.addChild(obstacle3)
        obstacle3.run(moveObstacleDown)
        ...
        obstacle4.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7.5)
        obstacle4.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: bottomSensor.position.y + (obstacle4.size.height * 0.7))
        obstacle4.zPosition = 1
        obstacle4.color = SKColor.brown
        obstacle4.name = "obstacle4"
        self.addChild(obstacle4)
        obstacle4.run(moveObstacleUp)
        ...
        obstacle5.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7.5)
        obstacle5.position = CGPoint(x: brick11.position.x + (brick11.size.width), y: topSensor.position.y - (obstacle5.size.height * 0.7))
        obstacle5.zPosition = 1
        obstacle5.color = SKColor.brown
        obstacle5.name = "obstacle5"
        self.addChild(obstacle5)
        obstacle5.run(moveObstacleDown)
        ...
        obstacle6.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7.5)
        obstacle6.position = CGPoint(x: brick21.position.x + (brick21.size.width), y: bottomSensor.position.y + (obstacle6.size.height * 0.7))
        obstacle6.zPosition = 1
        obstacle6.color = SKColor.brown
        obstacle6.name = "obstacle6"
        self.addChild(obstacle6)
        obstacle6.run(moveObstacleUp)
        obstacle6.physicsBody = SKPhysicsBody(rectangleOf: obstacle6.size)
        obstacle6.physicsBody?.affectedByGravity = false
        obstacle6.physicsBody?.isDynamic = true
        obstacle6.physicsBody?.allowsRotation = false
        obstacle6.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacle6.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacle6.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "obstacle6") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacle6") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "obstacle1") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacle1") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle1") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacle1") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle2") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacle2") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle2") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacle2") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle3") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacle3") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle3") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacle3") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle4") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacle4") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle4") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacle4") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle5") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacle5") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle5") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacle5") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle6") && (secondBody.name == "topSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "obstacle6") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "obstacle6") && (secondBody.name == "bottomSensor") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "obstacle6") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "obstacle6") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacle6") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        if Obstacle.name == "obstacle1" && Sensor.name == "topSensor" {
            obstacle1.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacle1" && Sensor.name == "bottomSensor" {
            obstacle1.run(moveObstacleUp)
        }
        if Obstacle.name == "obstacle2" && Sensor.name == "topSensor" {
            obstacle2.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacle2" && Sensor.name == "bottomSensor" {
            obstacle2.run(moveObstacleUp)
        }
        if Obstacle.name == "obstacle3" && Sensor.name == "topSensor" {
            obstacle3.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacle3" && Sensor.name == "bottomSensor" {
            obstacle3.run(moveObstacleUp)
        }
        if Obstacle.name == "obstacle4" && Sensor.name == "topSensor" {
            obstacle4.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacle4" && Sensor.name == "bottomSensor" {
            obstacle4.run(moveObstacleUp)
        }
        if Obstacle.name == "obstacle5" && Sensor.name == "topSensor" {
            obstacle5.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacle5" && Sensor.name == "bottomSensor" {
            obstacle5.run(moveObstacleUp)
        }
        if Obstacle.name == "obstacle6" && Sensor.name == "topSensor" {
            obstacle6.run(moveObstacleDown)
        }
        if Obstacle.name == "obstacle6" && Sensor.name == "bottomSensor" {
            obstacle6.run(moveObstacleUp)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl21 completed")
            gameOver = true
            
            if ch3lvl22Unlocked == false {
                continueString = "ch3lvl22"
                UserDefaults.standard.set("ch3lvl22", forKey: "continueString")
            }
            ch3lvl22Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl22Unlocked")
            UserDefaults.standard.synchronize()

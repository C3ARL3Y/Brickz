...
class ch3lvl24Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    let movingObstacle1 = SKSpriteNode()
    let movingObstacle2 = SKSpriteNode()
    let movingObstacle3 = SKSpriteNode()
    let movingObstacle4 = SKSpriteNode()
    let movingObstacle5 = SKSpriteNode()
    let movingObstacle6 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.width * 1.5), y: self.frame.height / 1.1)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: brick1.position.x + (brick1.size.width * 2), y: brick1.position.y)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y - (brick1.size.height * 3))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (brick3.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick3.position.x - (brick3.size.width), y: brick3.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brick3.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick3.position.x - (brick3.size.width), y: brick3.position.y - (brick3.size.height * 3))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick8.position.x + (brick8.size.width * 2), y: brick8.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x - (brick9.size.width), y: brick9.position.y - (brick9.size.height * 3))
        ...
        brick12.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (brick10.size.height))
        ...
        brick13.position = CGPoint(x: brick10.position.x - (brick10.size.width), y: brick10.position.y)
        ...
        brick14.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick10.size.height))
        ...
        brick15.position = CGPoint(x: brick14.position.x - (brick14.size.width), y: brick14.position.y - (brick14.size.height * 2))
        ...
        brick16.position = CGPoint(x: brick15.position.x + (brick15.size.width * 2), y: brick15.position.y)
        ...
        brick17.position = CGPoint(x: brick16.position.x - (brick16.size.width), y: brick16.position.y - (brick16.size.height * 3))
        ...
        brick19.position = CGPoint(x: brick17.position.x, y: brick17.position.y + (brick17.size.height))
        ...
        brick20.position = CGPoint(x: brick17.position.x - (brick17.size.width), y: brick17.position.y)
        ...
        brick21.position = CGPoint(x: brick17.position.x, y: brick17.position.y - (brick17.size.height))
        ...
        brick22.position = CGPoint(x: brick21.position.x - (brick21.size.width), y: brick21.position.y - (brick21.size.height * 2))
        ...
        brick23.position = CGPoint(x: brick22.position.x + (brick22.size.width * 2), y: brick22.position.y)
        ...
        brick24.position = CGPoint(x: self.frame.width - (brick1.size.width * 1.5), y: brick1.position.y)
        ...
        brick25.position = CGPoint(x: brick24.position.x - (brick24.size.width * 2), y: brick24.position.y)
        ...
        brick26.position = CGPoint(x: brick25.position.x + (brick25.size.width), y: brick25.position.y - (brick25.size.height * 3))
        ...
        brick28.position = CGPoint(x: brick26.position.x, y: brick26.position.y + (brick26.size.height))
        ...
        brick29.position = CGPoint(x: brick26.position.x - (brick26.size.width), y: brick26.position.y)
        ...
        brick30.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brick26.size.height))
        ...
        brick31.position = CGPoint(x: brick30.position.x + (brick30.size.width), y: brick30.position.y - (brick30.size.height * 2))
        ...
        brick32.position = CGPoint(x: brick31.position.x - (brick31.size.width * 2), y: brick31.position.y)
        ...
        brick33.position = CGPoint(x: brick32.position.x + (brick32.size.width), y: brick32.position.y - (brick32.size.height * 3))
        ...
        brick35.position = CGPoint(x: brick33.position.x, y: brick33.position.y + (brick33.size.height))
        ...
        brick36.position = CGPoint(x: brick33.position.x - (brick33.size.width), y: brick33.position.y)
        ...
        brick37.position = CGPoint(x: brick33.position.x, y: brick33.position.y - (brick33.size.height))
        ...
        brick38.position = CGPoint(x: brick37.position.x + (brick37.size.width), y: brick37.position.y - (brick37.size.height * 2))
        ...
        brick39.position = CGPoint(x: brick38.position.x - (brick38.size.width * 2), y: brick38.position.y)
        ...
        brick40.position = CGPoint(x: brick39.position.x + (brick39.size.width), y: brick39.position.y - (brick39.size.height * 3))
        ...
        brick42.position = CGPoint(x: brick40.position.x, y: brick40.position.y + (brick40.size.height))
        ...
        brick43.position = CGPoint(x: brick40.position.x - (brick40.size.width), y: brick40.position.y)
        ...
        brick44.position = CGPoint(x: brick40.position.x, y: brick40.position.y - (brick40.size.height))
        ...
        brick45.position = CGPoint(x: brick44.position.x - (brick44.size.width), y: brick44.position.y - (brick44.size.height * 2))
        ...
        brick46.position = CGPoint(x: brick45.position.x + (brick45.size.width * 2), y: brick45.position.y)
        ...
        brick47.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y)
        ...
        brick48.position = CGPoint(x: brick8.position.x + (brick8.size.width), y: brick8.position.y)
        ...
        brick49.position = CGPoint(x: brick15.position.x + (brick15.size.width), y: brick15.position.y)
        ...
        brick50.position = CGPoint(x: brick22.position.x + (brick22.size.width), y: brick22.position.y)
        ...
        brick51.position = CGPoint(x: brick24.position.x - (brick24.size.width), y: brick24.position.y)
        ...
        brick52.position = CGPoint(x: brick31.position.x - (brick31.size.width), y: brick31.position.y)
        ...
        brick53.position = CGPoint(x: brick38.position.x - (brick38.size.width), y: brick38.position.y)
        ...
        brick54.position = CGPoint(x: brick45.position.x + (brick45.size.width), y: brick45.position.y)
        ...
        brick55.position = CGPoint(x: self.frame.width / 2, y: brick10.position.y)
        ...
        brick56.position = CGPoint(x: self.frame.width / 2, y: brick3.position.y)
        ...
        brick57.texture = SKTexture(imageNamed: "brick2Texture6")
        brick57.size = cementBrickSize
        brick57.position = CGPoint(x: brick56.position.x + (brick56.size.width), y: brick56.position.y)
        brick57.name = "brick57"
        brick57.zPosition = 1
        self.addChild(brick57)
        brick57.physicsBody = SKPhysicsBody(rectangleOf: brick57.size)
        ...
        brick57.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick57.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick58.texture = SKTexture(imageNamed: "brick2Texture6")
        brick58.size = cementBrickSize
        brick58.position = CGPoint(x: brick56.position.x, y: brick56.position.y + (brick56.size.height))
        brick58.name = "brick58"
        brick58.zPosition = 1
        self.addChild(brick58)
        brick58.physicsBody = SKPhysicsBody(rectangleOf: brick58.size)
        ...
        brick58.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick58.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick59.texture = SKTexture(imageNamed: "brick2Texture6")
        brick59.size = cementBrickSize
        brick59.position = CGPoint(x: brick56.position.x - (brick56.size.width), y: brick56.position.y)
        brick59.name = "brick59"
        brick59.zPosition = 1
        self.addChild(brick59)
        brick59.physicsBody = SKPhysicsBody(rectangleOf: brick59.size)
        ...
        brick59.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick59.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick60.texture = SKTexture(imageNamed: "brick2Texture6")
        brick60.size = cementBrickSize
        brick60.position = CGPoint(x: brick56.position.x, y: brick56.position.y - (brick56.size.height))
        brick60.name = "brick60"
        brick60.zPosition = 1
        self.addChild(brick60)
        brick60.physicsBody = SKPhysicsBody(rectangleOf: brick60.size)
        ...
        brick60.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick60.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick61.texture = SKTexture(imageNamed: "brick2Texture6")
        brick61.size = cementBrickSize
        brick61.position = CGPoint(x: self.frame.width / 2, y: brick17.position.y)
        brick61.name = "brick61"
        brick61.zPosition = 1
        self.addChild(brick61)
        brick61.physicsBody = SKPhysicsBody(rectangleOf: brick61.size)
        ...
        brick61.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick61.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick62.texture = SKTexture(imageNamed: "brick2Texture6")
        brick62.size = cementBrickSize
        brick62.position = CGPoint(x: brick61.position.x + (brick61.size.width), y: brick61.position.y)
        brick62.name = "brick62"
        brick62.zPosition = 1
        self.addChild(brick62)
        brick62.physicsBody = SKPhysicsBody(rectangleOf: brick62.size)
        ...
        brick62.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick62.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick63.texture = SKTexture(imageNamed: "brick2Texture6")
        brick63.size = cementBrickSize
        brick63.position = CGPoint(x: brick61.position.x, y: brick61.position.y + (brick61.size.height))
        brick63.name = "brick63"
        brick63.zPosition = 1
        self.addChild(brick63)
        brick63.physicsBody = SKPhysicsBody(rectangleOf: brick63.size)
        ...
        brick63.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick63.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
    
        brick64.texture = SKTexture(imageNamed: "brick2Texture6")
        brick64.size = cementBrickSize
        brick64.position = CGPoint(x: brick61.position.x - (brick61.size.width), y: brick61.position.y)
        brick64.name = "brick64"
        brick64.zPosition = 1
        self.addChild(brick64)
        brick64.physicsBody = SKPhysicsBody(rectangleOf: brick64.size)
        ...
        brick64.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick64.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        brick65.texture = SKTexture(imageNamed: "brick2Texture6")
        brick65.size = cementBrickSize
        brick65.position = CGPoint(x: brick61.position.x, y: brick61.position.y - (brick61.size.height))
        brick65.name = "brick65"
        brick65.zPosition = 1
        self.addChild(brick65)
        brick65.physicsBody = SKPhysicsBody(rectangleOf: brick65.size)
        ...
        brick65.physicsBody?.collisionBitMask = PhysicsCategory.Rocket
        brick65.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket
        
        moveObstacleLeft = SKAction.moveTo(x: 0, duration: 2.25)
        moveObstacleRight = SKAction.moveTo(x: self.frame.width, duration: 2.25)
        
        movingObstacle1.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacle1.position = CGPoint(x: 0 + (movingObstacle1.size.width * 0.7), y: brick3.position.y + (brick3.size.height * 2))
        movingObstacle1.zPosition = 1
        movingObstacle1.color = SKColor.brown
        movingObstacle1.name = "movingObstacle1"
        self.addChild(movingObstacle1)
        movingObstacle1.run(moveObstacleRight)
        movingObstacle1.physicsBody = SKPhysicsBody(rectangleOf: movingObstacle1.size)
        movingObstacle1.physicsBody?.affectedByGravity = false
        movingObstacle1.physicsBody?.isDynamic = true
        movingObstacle1.physicsBody?.allowsRotation = false
        movingObstacle1.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle1.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle1.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingObstacle2.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacle2.position = CGPoint(x: self.frame.width - (movingObstacle2.size.width * 0.7), y: brick3.position.y - (brick3.size.height * 2))
        movingObstacle2.zPosition = 1
        movingObstacle2.color = SKColor.brown
        movingObstacle2.name = "movingObstacle2"
        self.addChild(movingObstacle2)
        movingObstacle2.run(moveObstacleLeft)
        movingObstacle2.physicsBody = SKPhysicsBody(rectangleOf: movingObstacle2.size)
        movingObstacle2.physicsBody?.affectedByGravity = false
        movingObstacle2.physicsBody?.isDynamic = true
        movingObstacle2.physicsBody?.allowsRotation = false
        movingObstacle2.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle2.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle2.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingObstacle3.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacle3.position = CGPoint(x: 0 + (movingObstacle3.size.width * 0.7), y: brick10.position.y + (brick10.size.height * 2))
        movingObstacle3.zPosition = 1
        movingObstacle3.color = SKColor.brown
        movingObstacle3.name = "movingObstacle3"
        self.addChild(movingObstacle3)
        movingObstacle3.run(moveObstacleRight)
        movingObstacle3.physicsBody = SKPhysicsBody(rectangleOf: movingObstacle3.size)
        movingObstacle3.physicsBody?.affectedByGravity = false
        movingObstacle3.physicsBody?.isDynamic = true
        movingObstacle3.physicsBody?.allowsRotation = false
        movingObstacle3.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle3.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle3.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingObstacle4.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacle4.position = CGPoint(x: self.frame.width - (movingObstacle1.size.width * 0.7), y: brick10.position.y - (brick10.size.height * 2))
        movingObstacle4.zPosition = 1
        movingObstacle4.color = SKColor.brown
        movingObstacle4.name = "movingObstacle4"
        self.addChild(movingObstacle4)
        movingObstacle4.run(moveObstacleLeft)
        movingObstacle4.physicsBody = SKPhysicsBody(rectangleOf: movingObstacle4.size)
        movingObstacle4.physicsBody?.affectedByGravity = false
        movingObstacle4.physicsBody?.isDynamic = true
        movingObstacle4.physicsBody?.allowsRotation = false
        movingObstacle4.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle4.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle4.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingObstacle5.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacle5.position = CGPoint(x: 0 + (movingObstacle5.size.width * 0.7), y: brick17.position.y + (brick17.size.height * 2))
        movingObstacle5.zPosition = 1
        movingObstacle5.color = SKColor.brown
        movingObstacle5.name = "movingObstacle5"
        self.addChild(movingObstacle5)
        movingObstacle5.run(moveObstacleRight)
        movingObstacle5.physicsBody = SKPhysicsBody(rectangleOf: movingObstacle5.size)
        movingObstacle5.physicsBody?.affectedByGravity = false
        movingObstacle5.physicsBody?.isDynamic = true
        movingObstacle5.physicsBody?.allowsRotation = false
        movingObstacle5.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle5.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle5.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingObstacle6.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacle6.position = CGPoint(x: self.frame.width - (movingObstacle6.size.width * 0.7), y: brick17.position.y - (brick17.size.height * 2))
        movingObstacle6.zPosition = 1
        movingObstacle6.color = SKColor.brown
        movingObstacle6.name = "movingObstacle6"
        self.addChild(movingObstacle6)
        movingObstacle6.run(moveObstacleLeft)
        movingObstacle6.physicsBody = SKPhysicsBody(rectangleOf: movingObstacle6.size)
        movingObstacle6.physicsBody?.affectedByGravity = false
        movingObstacle6.physicsBody?.isDynamic = true
        movingObstacle6.physicsBody?.allowsRotation = false
        movingObstacle6.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle6.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle6.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func movingObstacleHitSensor(Obstacle: SKSpriteNode, Sensor: SKSpriteNode) {
        if Obstacle.name == "movingObstacle1" && Sensor.name == "leftBarrier" {
            movingObstacle1.run(moveObstacleRight)
        }
        if Obstacle.name == "movingObstacle1" && Sensor.name == "rightBarrier" {
            movingObstacle1.run(moveObstacleLeft)
        }
        if Obstacle.name == "movingObstacle2" && Sensor.name == "leftBarrier" {
            movingObstacle2.run(moveObstacleRight)
        }
        if Obstacle.name == "movingObstacle2" && Sensor.name == "rightBarrier" {
            movingObstacle2.run(moveObstacleLeft)
        }
        if Obstacle.name == "movingObstacle3" && Sensor.name == "leftBarrier" {
            movingObstacle3.run(moveObstacleRight)
        }
        if Obstacle.name == "movingObstacle3" && Sensor.name == "rightBarrier" {
            movingObstacle3.run(moveObstacleLeft)
        }
        if Obstacle.name == "movingObstacle4" && Sensor.name == "leftBarrier" {
            movingObstacle4.run(moveObstacleRight)
        }
        if Obstacle.name == "movingObstacle4" && Sensor.name == "rightBarrier" {
            movingObstacle4.run(moveObstacleLeft)
        }
        if Obstacle.name == "movingObstacle5" && Sensor.name == "leftBarrier" {
            movingObstacle5.run(moveObstacleRight)
        }
        if Obstacle.name == "movingObstacle5" && Sensor.name == "rightBarrier" {
            movingObstacle5.run(moveObstacleLeft)
        }
        if Obstacle.name == "movingObstacle6" && Sensor.name == "leftBarrier" {
            movingObstacle6.run(moveObstacleRight)
        }
        if Obstacle.name == "movingObstacle6" && Sensor.name == "rightBarrier" {
            movingObstacle6.run(moveObstacleLeft)
        }
    }
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle1") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle1") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle2") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle2") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle3") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle3") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle4") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle4") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle5") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle5") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle6") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle6") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "movingObstacle1") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle1") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle1") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle1") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle2") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle2") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle2") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle2") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle3") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle3") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle3") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle3") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle4") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle4") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle4") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle4") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle5") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle5") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle5") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle5") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle6") && (secondBody.name == "leftBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle6") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "movingObstacle6") && (secondBody.name == "rightBarrier") {
                movingObstacleHitSensor(Obstacle: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle6") {
                movingObstacleHitSensor(Obstacle: secondBody, Sensor: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle1") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle1") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle2") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle2") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle3") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle3") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle4") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle4") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle5") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle5") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle6") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle6") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "brick57") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick57") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick58") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick58") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick59") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick59") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick60") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick60") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick61") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick61") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick62") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick62") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick63") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick63") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick64") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick64") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "brick65") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "brick65") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            ...
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick57") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick57") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick58") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick58") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick59") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick59") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick60") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick60") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick61") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick61") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick62") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick62") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick63") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick63") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick64") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick64") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick65") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick65") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick57" {
            if brickCount > 1 {
                powerUp.position = brick57.position
            ...
            if brickLives[56] == 6 {
                brickLives[56] -= 1
                brick57.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[56] == 5 {
                brickLives[56] -= 1
                brick57.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[56] == 4 {
                brickLives[56] -= 1
                brick57.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[56] == 3 {
                brickLives[56] -= 1
                brick57.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[56] == 2 {
                brickLives[56] -= 1
                brick57.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[56] == 1 {
                brickLives[56] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick58" {
            if brickCount > 1 {
                powerUp.position = brick58.position
            ...
            if brickLives[57] == 6 {
                brickLives[57] -= 1
                brick58.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[57] == 5 {
                brickLives[57] -= 1
                brick58.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[57] == 4 {
                brickLives[57] -= 1
                brick58.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[57] == 3 {
                brickLives[57] -= 1
                brick58.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[57] == 2 {
                brickLives[57] -= 1
                brick58.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[57] == 1 {
                brickLives[57] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick59" {
            if brickCount > 1 {
                powerUp.position = brick59.position
            ...
            if brickLives[58] == 6 {
                brickLives[58] -= 1
                brick59.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[58] == 5 {
                brickLives[58] -= 1
                brick59.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[58] == 4 {
                brickLives[58] -= 1
                brick59.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[58] == 3 {
                brickLives[58] -= 1
                brick59.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[58] == 2 {
                brickLives[58] -= 1
                brick59.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[58] == 1 {
                brickLives[58] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick60" {
            if brickCount > 1 {
                powerUp.position = brick60.position
            ...
            if brickLives[59] == 6 {
                brickLives[59] -= 1
                brick60.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[59] == 5 {
                brickLives[59] -= 1
                brick60.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[59] == 4 {
                brickLives[59] -= 1
                brick60.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[59] == 3 {
                brickLives[59] -= 1
                brick60.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[59] == 2 {
                brickLives[59] -= 1
                brick60.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[59] == 1 {
                brickLives[59] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick61" {
            if brickCount > 1 {
                powerUp.position = brick61.position
            ...
            if brickLives[60] == 6 {
                brickLives[60] -= 1
                brick61.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[60] == 5 {
                brickLives[60] -= 1
                brick61.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[60] == 4 {
                brickLives[60] -= 1
                brick61.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[60] == 3 {
                brickLives[60] -= 1
                brick61.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[60] == 2 {
                brickLives[60] -= 1
                brick61.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[60] == 1 {
                brickLives[60] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick62" {
            if brickCount > 1 {
                powerUp.position = brick62.position
            ...
            if brickLives[61] == 6 {
                brickLives[61] -= 1
                brick62.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[61] == 5 {
                brickLives[61] -= 1
                brick62.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[61] == 4 {
                brickLives[61] -= 1
                brick62.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[61] == 3 {
                brickLives[61] -= 1
                brick62.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[61] == 2 {
                brickLives[61] -= 1
                brick62.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[61] == 1 {
                brickLives[61] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick63" {
            if brickCount > 1 {
                powerUp.position = brick63.position
            ...
            if brickLives[62] == 6 {
                brickLives[62] -= 1
                brick63.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[62] == 5 {
                brickLives[62] -= 1
                brick63.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[62] == 4 {
                brickLives[62] -= 1
                brick63.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[62] == 3 {
                brickLives[62] -= 1
                brick63.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[62] == 2 {
                brickLives[62] -= 1
                brick63.texture = SKTexture(imageNamed: "brick2Texture1")
            } else if brickLives[62] == 1 {
                brickLives[62] -= 1
                brickCount -= 1
        ...
        if Brick.name == "brick64" {
            if brickCount > 1 {
                powerUp.position = brick64.position
            ...
            if brickLives[63] == 6 {
                brickLives[63] -= 1
                brick64.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[63] == 5 {
                brickLives[63] -= 1
                brick64.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[63] == 4 {
                brickLives[63] -= 1
                brick64.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[63] == 3 {
                brickLives[63] -= 1
                brick64.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[63] == 2 {
                brickLives[63] -= 1
                brick64.texture = SKTexture(imageNamed: "brick2Texture1")
        ...
        if Brick.name == "brick65" {
            if brickCount > 1 {
                powerUp.position = brick65.position
            ...
            if brickLives[64] == 6 {
                brickLives[64] -= 1
                brick65.texture = SKTexture(imageNamed: "brick2Texture5")
            } else if brickLives[64] == 5 {
                brickLives[64] -= 1
                brick65.texture = SKTexture(imageNamed: "brick2Texture4")
            } else if brickLives[64] == 4 {
                brickLives[64] -= 1
                brick65.texture = SKTexture(imageNamed: "brick2Texture3")
            } else if brickLives[64] == 3 {
                brickLives[64] -= 1
                brick65.texture = SKTexture(imageNamed: "brick2Texture2")
            } else if brickLives[64] == 2 {
                brickLives[64] -= 1
                brick65.texture = SKTexture(imageNamed: "brick2Texture1")
        ...
        if brickCount == 0 {
            print("ch3lvl24 completed")
            gameOver = true
            
            if ch3lvl25Unlocked == false {
                continueString = "ch3lvl25"
                UserDefaults.standard.set("ch3lvl25", forKey: "continueString")
            }
            ch3lvl25Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl25Unlocked")
            UserDefaults.standard.synchronize()

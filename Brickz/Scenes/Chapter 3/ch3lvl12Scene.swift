...
class ch3lvl12Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.6 + (brick1.size.height / 2))
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.6 - (brick1.size.height / 2))
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick4.position = CGPoint(x: self.frame.width / 2, y: brick3.position.y + (brick3.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: self.frame.width / 2, y: brick4.position.y + (brick4.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: self.frame.width / 2, y: brick5.position.y + (brick5.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: self.frame.width / 2, y: brick2.position.y - (brick2.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: self.frame.width / 2, y: brick7.position.y - (brick7.size.height))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: self.frame.width / 2, y: brick8.position.y - (brick8.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: self.frame.width / 2, y: brick9.position.y - (brick9.size.height))
        ...
        brick11.position = CGPoint(x: brick5.position.x - (brick5.size.width * 3), y: brick2.position.y + (brick2.size.height / 2))
        ...
        brick16.position = CGPoint(x: brick9.position.x + (brick9.size.width * 3), y: brick2.position.y + (brick2.size.height / 2))
        ...
        brick18.position = CGPoint(x: brick16.position.x, y: brick16.position.y + (brick16.size.height))
        ...
        brick19.position = CGPoint(x: brick16.position.x - (brick16.size.width), y: brick16.position.y)
        ...
        brick20.position = CGPoint(x: brick16.position.x, y: brick16.position.y - (brick16.size.height))
        ...
        brick21.position = CGPoint(x: brick1.position.x + (brick1.size.width * 5.2), y: brick11.position.y)
        ...
        brick26.position = CGPoint(x: brick1.position.x - (brick1.size.width * 5.2), y: brick11.position.y)
        ...
        brick29.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brick26.size.height))
        ...
        bottomSensor.size = CGSize(width: self.frame.width / 2, height: 1)
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick10.position.y - (brick10.size.height * 0.7))
        ...
        bottomSensor.physicsBody?.isDynamic = true
        ...
        topSensor.size = CGSize(width: self.frame.width / 2, height: 1)
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick6.position.y + (brick6.size.height * 0.7))
        ...
        topSensor.physicsBody?.isDynamic = true
        ...
        moveObstacleDown = SKAction.moveTo(y: bottomSensor.position.y, duration: 3.5)
        moveObstacleUp = SKAction.moveTo(y: topSensor.position.y, duration: 3.5)
        ...
        obstacleLeft.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: topSensor.position.y - (obstacleLeft.size.height * 0.6))
        ...
        obstacleRight.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: bottomSensor.position.y + (obstacleRight.size.height * 0.6))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl12 completed")
            gameOver = true
            
            if ch3lvl13Unlocked == false {
                continueString = "ch3lvl13"
                UserDefaults.standard.set("ch3lvl13", forKey: "continueString")
            }
            ch3lvl13Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl13Unlocked")
            UserDefaults.standard.synchronize()

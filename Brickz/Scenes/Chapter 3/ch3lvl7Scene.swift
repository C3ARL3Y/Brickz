...
class ch3lvl7Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    override func didMove(to view: SKView) {
        ...
        moveObstacleUp = SKAction.moveTo(y: self.frame.height, duration: 3)
        moveObstacleDown = SKAction.moveTo(y: 0, duration: 3)
        
        brick1.texture = SKTexture(imageNamed: "brick2Texture6")
        brick1.size = cementBrickSize
        brick1.position = CGPoint(x: self.frame.width / 1.9, y: self.frame.height / 1.6)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 3))
        ...
        brick11.position = CGPoint(x: brick10.position.x + (brick10.size.width), y: brick10.position.y - (brick1.size.height))
        ...
        brick19.position = CGPoint(x: brick18.position.x + (brick19.size.width), y: brick18.position.y + (brick18.size.height))
        ...
        brick20.position = CGPoint(x: brick5.position.x - (brick5.size.width), y: brick5.position.y - (brick5.size.height))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.7 - (woodBrickSize.height * 7))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.7 + (woodBrickSize.height * 7))
        ...
        leftObstacle.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 6)
        leftObstacle.position = CGPoint(x: 0 + (leftObstacle.size.width), y: bottomSensor.position.y + (leftObstacle.size.height * 0.6))
        ...
        rightObstacle.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 6)
        rightObstacle.position = CGPoint(x: self.frame.width - (rightObstacle.size.width), y: topSensor.position.y - (rightObstacle.size.height * 0.6))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl7 completed")
            gameOver = true
            
            if ch3lvl8Unlocked == false {
                continueString = "ch3lvl8"
                UserDefaults.standard.set("ch3lvl8", forKey: "continueString")
            }
            ch3lvl8Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl8Unlocked")
            UserDefaults.standard.synchronize()

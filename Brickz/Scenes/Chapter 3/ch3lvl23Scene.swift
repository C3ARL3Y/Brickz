...
class ch3lvl23Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    ...
    var moveBottomRightBrickRight = SKAction()
    var moveBottomMiddleBrickRight = SKAction()
    var moveBottomLeftBrickRight = SKAction()
    var moveMiddleRightBrickRight = SKAction()
    var moveMiddleLeftBrickRight = SKAction()
    var moveTopBrickRight = SKAction()
    
    var moveBottomRightBrickLeft = SKAction()
    var moveBottomMiddleBrickLeft = SKAction()
    var moveBottomLeftBrickLeft = SKAction()
    var moveMiddleRightBrickLeft = SKAction()
    var moveMiddleLeftBrickLeft = SKAction()
    var moveTopBrickLeft = SKAction()
    ...
    override func didMove(to view: SKView) {
        ...
        moveBottomRightBrickRight = SKAction.moveTo(x: self.frame.width - (cementBrickSize.width * 0.5), duration: 2.5)
        moveBottomMiddleBrickRight = SKAction.moveTo(x: self.frame.width - ((cementBrickSize.width * 0.5) + (cementBrickSize.width)), duration: 2.5)
        moveBottomLeftBrickRight = SKAction.moveTo(x: self.frame.width - ((cementBrickSize.width * 0.5) + (cementBrickSize.width * 2)), duration: 2.5)
        moveMiddleRightBrickRight = SKAction.moveTo(x: self.frame.width - ((cementBrickSize.width * 0.5) + (cementBrickSize.width * 0.5)), duration: 2.5)
        moveMiddleLeftBrickRight = SKAction.moveTo(x: self.frame.width - ((cementBrickSize.width * 0.5) + (cementBrickSize.width * 1.5)), duration: 2.5)
        moveTopBrickRight = SKAction.moveTo(x: self.frame.width - ((cementBrickSize.width * 0.5) + (cementBrickSize.width)), duration: 2.5)
        
        moveBottomRightBrickLeft = SKAction.moveTo(x: 0 + (cementBrickSize.width * 0.5), duration: 2.5)
        moveBottomMiddleBrickLeft = SKAction.moveTo(x: 0 + ((cementBrickSize.width * 0.5) + (cementBrickSize.width)), duration: 2.5)
        moveBottomLeftBrickLeft = SKAction.moveTo(x: 0 + ((cementBrickSize.width * 0.5) + (cementBrickSize.width * 2)), duration: 2.5)
        moveMiddleRightBrickLeft = SKAction.moveTo(x: 0 + ((cementBrickSize.width * 0.5) + (cementBrickSize.width * 0.5)), duration: 2.5)
        moveMiddleLeftBrickLeft = SKAction.moveTo(x: 0 + ((cementBrickSize.width * 0.5) + (cementBrickSize.width * 1.5)), duration: 2.5)
        moveTopBrickLeft = SKAction.moveTo(x: 0 + ((cementBrickSize.width * 0.5) + (cementBrickSize.width)), duration: 2.5)
        
        brick1.texture = SKTexture(imageNamed: "brick2Texture6")
        brick1.size = cementBrickSize
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.65)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick3.position.x + (brick3.size.width / 2), y: brick3.position.y + (brick3.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick1.position.x - (brick1.size.width * 4), y: brick1.position.y)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick12.position = CGPoint(x: brick11.position.x - (brick11.size.width / 2), y: brick11.position.y + (brick11.size.height))
        ...
        brick13.position = CGPoint(x: brick1.position.x + (brick1.size.width * 4), y: brick1.position.y)
        ...
        brick15.position = CGPoint(x: brick13.position.x + (brick13.size.width), y: brick14.position.y)
        ...
        brick16.position = CGPoint(x: brick14.position.x + (brick14.size.width / 2), y: brick14.position.y + (brick14.size.height))
        ...
        brick18.position = CGPoint(x: brick17.position.x - (brick17.size.width / 2), y: brick17.position.y + (brick17.size.height))
        ...
        brick19.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height * 4))
        ...
        brick21.position = CGPoint(x: brick19.position.x - (brick19.size.width), y: brick19.position.y)
        ...
        brick22.position = CGPoint(x: brick19.position.x - (brick19.size.width / 2), y: brick19.position.y + (brick19.size.height))
        ...
        brick24.position = CGPoint(x: brick23.position.x - (brick23.size.width / 2), y: brick23.position.y + (brick23.size.height))
        ...
        brick25.position = CGPoint(x: brick7.position.x, y: brick7.position.y + (brick7.size.height * 4))
        ...
        brick27.position = CGPoint(x: brick25.position.x - (brick25.size.width), y: brick25.position.y)
        ...
        brick31.position = CGPoint(x: brick13.position.x, y: brick13.position.y + (brick13.size.height * 4))
        ...
        brick37.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 4))
        ...
        brick39.position = CGPoint(x: brick37.position.x + (brick37.size.width), y: brick37.position.y)
        ...
        brick42.position = CGPoint(x: brick41.position.x + (brick41.size.width / 2), y: brick41.position.y + (brick41.size.height))
        ...
        brick43.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height * 4))
        ...
        brick45.position = CGPoint(x: brick43.position.x - (brick43.size.width), y: brick43.position.y)
        ...
        brick46.position = CGPoint(x: brick45.position.x + (brick45.size.width / 2), y: brick45.position.y + (brick45.size.height))
        ...
        brick48.position = CGPoint(x: brick47.position.x - (brick47.size.width / 2), y: brick47.position.y + (brick47.size.height))
        ...
        brick49.position = CGPoint(x: brick13.position.x, y: brick13.position.y - (brick13.size.height * 4))
        ...
        brick51.position = CGPoint(x: brick49.position.x - (brick49.size.width), y: brick49.position.y)
        ...
        brick55.position = CGPoint(x: 0 + ((brick55.size.width * 0.7) + (brick55.size.width * 2)), y: brick37.position.y - (brick37.size.height * 4))
        ...
        brick55.run(moveBottomMiddleBrickRight)
        ...
        brick56.physicsBody?.isDynamic = true
        brick56.physicsBody?.affectedByGravity = false
        brick56.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick56.physicsBody?.collisionBitMask = PhysicsCategory.Rocket | PhysicsCategory.Barrier
        brick56.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket | PhysicsCategory.Barrier
        brick56.run(moveBottomRightBrickRight)
        
        brick57.texture = SKTexture(imageNamed: "brick2Texture6")
        brick57.size = cementBrickSize
        brick57.position = CGPoint(x: brick55.position.x - (brick55.size.width), y: brick55.position.y)
        brick57.name = "brick57"
        brick57.zPosition = 1
        self.addChild(brick57)
        brick57.physicsBody = SKPhysicsBody(rectangleOf: brick57.size)
        brick57.physicsBody?.isDynamic = true
        brick57.physicsBody?.affectedByGravity = false
        brick57.physicsBody?.categoryBitMask = PhysicsCategory.Brick
        brick57.physicsBody?.collisionBitMask = PhysicsCategory.Rocket | PhysicsCategory.Barrier
        brick57.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket | PhysicsCategory.Barrier
        brick57.run(moveBottomLeftBrickRight)
        ...
        brick58.run(moveMiddleLeftBrickRight)
        ...
        brick59.run(moveMiddleRightBrickRight)
        
        brick60.texture = SKTexture(imageNamed: "brick2Texture6")
        brick60.size = cementBrickSize
        brick60.position = CGPoint(x: brick59.position.x - (brick59.size.width / 2), y: brick59.position.y + (brick59.size.height))
        ...
        brick60.run(moveTopBrickRight)
        
        topSensor.size = CGSize(width: self.frame.width, height: 1)
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick24.position.y + (brick24.size.height * 0.5))
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick37.position.y - (brick37.size.height * 0.5))
        ...
        moveObstacleUp = SKAction.moveTo(y: topSensor.position.y, duration: 2.5)
        moveObstacleDown = SKAction.moveTo(y: bottomSensor.position.y, duration: 2.5)
        
        obstacleLeft.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7)
        obstacleLeft.position = CGPoint(x: brick1.position.x - (brick1.size.height * 2), y: topSensor.position.y - (obstacleLeft.size.height * 0.7))
        obstacleLeft.zPosition = 1
        obstacleLeft.color = SKColor.brown
        ...
        obstacleLeft.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        obstacleLeft.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        obstacleRight.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 7)
        obstacleRight.position = CGPoint(x: brick1.position.x + (brick1.size.height * 2), y: bottomSensor.position.y + (obstacleRight.size.height * 0.7))
        obstacleRight.zPosition = 1
        obstacleRight.color = SKColor.brown
        ...
        obstacleRight.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        obstacleRight.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        obstacleTop.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleTop.position = CGPoint(x: rightBarrier.position.x - (obstacleTop.size.width * 0.7), y: brick1.position.y + (brick1.size.height * 3))
        ...
        obstacleTop.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        obstacleTop.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        obstacleBottom.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleBottom.position = CGPoint(x: leftBarrier.position.x + (obstacleBottom.size.width * 0.7), y: brick1.position.y - (brick1.size.height))
        ...
        obstacleBottom.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        obstacleBottom.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier 
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "brick56") && (secondBody.name == "rightBarrier") {
                movingBricksHitSensor(Brick: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "brick56") {
                movingBricksHitSensor(Brick: secondBody, Sensor: firstBody)
            }
            if (firstBody.name == "brick57") && (secondBody.name == "leftBarrier") {
                movingBricksHitSensor(Brick: firstBody, Sensor: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "brick57") {
                movingBricksHitSensor(Brick: secondBody, Sensor: firstBody)
            }
    ...
    func movingBricksHitSensor(Brick: SKSpriteNode, Sensor: SKSpriteNode) {
        if Brick.name == "brick56" && Sensor.name == "rightBarrier" {
            brick55.run(moveBottomMiddleBrickLeft)
            brick56.run(moveBottomLeftBrickLeft)
            brick57.run(moveBottomRightBrickLeft)
            brick58.run(moveMiddleRightBrickLeft)
            brick59.run(moveMiddleLeftBrickLeft)
            brick60.run(moveTopBrickLeft)
            
        }
        if Brick.name == "brick57" && Sensor.name == "leftBarrier" {
            brick55.run(moveBottomMiddleBrickRight)
            brick56.run(moveBottomRightBrickRight)
            brick57.run(moveBottomLeftBrickRight)
            brick58.run(moveMiddleLeftBrickRight)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch3lvl23 completed")
            gameOver = true
            
            if ch3lvl24Unlocked == false {
                continueString = "ch3lvl24"
                UserDefaults.standard.set("ch3lvl24", forKey: "continueString")
            }
            ch3lvl24Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl24Unlocked")
            UserDefaults.standard.synchronize()

...
class ch2lvl12Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    let movingMiddleObstacle = SKSpriteNode()
    let movingBottomObstacle = SKSpriteNode()
    let movingTopObstacle = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (woodBrickSize.height * 0.8), y: self.frame.height / 1.4)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick1.position.x + (brick1.size.height), y: brick1.position.y - (brick1.size.width / 2))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.width))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick6.position.x + (brick6.size.height), y: brick6.position.y - (brick6.size.width / 2))
        ...
        brick12.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.width))
        ...
        brick13.position = CGPoint(x: brick10.position.x + (brick10.size.height), y: brick10.position.y - (brick10.size.width / 2))
        ...
        brick15.position = CGPoint(x: brick13.position.x + (brick13.size.height), y: brick13.position.y - (brick13.size.width / 2))
        ...
        brick16.position = CGPoint(x: self.frame.width - (woodBrickSize.height * 0.8), y: brick1.position.y)
        ...
        brick19.position = CGPoint(x: brick18.position.x, y: brick18.position.y - (brick18.size.width))
        ...
        brick21.position = CGPoint(x: brick16.position.x - (brick16.size.height), y: brick16.position.y - (brick16.size.width / 2))
        ...
        brick22.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brick21.size.width))
        ...
        brick25.position = CGPoint(x: brick21.position.x - (brick21.size.height), y: brick21.position.y - (brick21.size.width / 2))
        ...
        brick27.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brick26.size.width))
        ...
        brick28.position = CGPoint(x: brick25.position.x - (brick25.size.height), y: brick25.position.y - (brick25.size.width / 2))
        ...
        brick30.position = CGPoint(x: brick28.position.x - (brick28.size.height), y: brick28.position.y - (brick28.size.width / 2))
        ...
        topSensor.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y)
        ...
        bottomSensor.position = CGPoint(x: self.frame.width / 2, y: brick20.position.y)
        ...
        moveObstacleUp = SKAction.moveTo(y: topSensor.position.y, duration: 1.5)
        moveObstacleDown = SKAction.moveTo(y: bottomSensor.position.y, duration: 1.5)
        
        moveObstacleLeft = SKAction.moveTo(x: 0, duration: 2.5)
        moveObstacleRight = SKAction.moveTo(x: self.frame.width, duration: 2.5)
        
        movingMiddleObstacle.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 8)
        movingMiddleObstacle.position = CGPoint(x: self.frame.width / 2, y: bottomSensor.position.y + (movingMiddleObstacle.size.height / 2))
        movingMiddleObstacle.zPosition = 1
        movingMiddleObstacle.color = SKColor.brown
        movingMiddleObstacle.name = "movingMiddleObstacle"
        self.addChild(movingMiddleObstacle)
        movingMiddleObstacle.run(moveObstacleUp)
        movingMiddleObstacle.physicsBody = SKPhysicsBody(rectangleOf: movingMiddleObstacle.size)
        movingMiddleObstacle.physicsBody?.affectedByGravity = false
        movingMiddleObstacle.physicsBody?.isDynamic = true
        movingMiddleObstacle.physicsBody?.allowsRotation = false
        movingMiddleObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingMiddleObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingMiddleObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingBottomObstacle.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingBottomObstacle.position = CGPoint(x: 0 + (movingBottomObstacle.size.width * 0.6), y: brick20.position.y - (brick20.size.width * 0.9))
        movingBottomObstacle.zPosition = 1
        movingBottomObstacle.color = SKColor.brown
        movingBottomObstacle.name = "movingBottomObstacle"
        self.addChild(movingBottomObstacle)
        movingBottomObstacle.run(moveObstacleRight)
        movingBottomObstacle.physicsBody = SKPhysicsBody(rectangleOf: movingBottomObstacle.size)
        movingBottomObstacle.physicsBody?.affectedByGravity = false
        movingBottomObstacle.physicsBody?.isDynamic = true
        movingBottomObstacle.physicsBody?.allowsRotation = false
        movingBottomObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingBottomObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingBottomObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingTopObstacle.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingTopObstacle.position = CGPoint(x: self.frame.width - (movingTopObstacle.size.width * 0.6), y: brick1.position.y + (brick1.size.width * 0.9))
        movingTopObstacle.zPosition = 1
        movingTopObstacle.color = SKColor.brown
        movingTopObstacle.name = "movingTopObstacle"
        self.addChild(movingTopObstacle)
        movingTopObstacle.run(moveObstacleLeft)
        movingTopObstacle.physicsBody = SKPhysicsBody(rectangleOf: movingTopObstacle.size)
        movingTopObstacle.physicsBody?.affectedByGravity = false
        movingTopObstacle.physicsBody?.isDynamic = true
        movingTopObstacle.physicsBody?.allowsRotation = false
        movingTopObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingTopObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingTopObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        brick31.texture = SKTexture(imageNamed: "brick1Texture4")
        brick31.size = woodBrickSize
        brick31.position = CGPoint(x: self.frame.width / 2, y: movingTopObstacle.position.y + (brick31.size.height * 1.5))
        ...
        brick32.position = CGPoint(x: self.frame.width / 2, y: movingBottomObstacle.position.y - (brick32.size.height * 1.5))
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "movingTopObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingTopObstacle") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingBottomObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingBottomObstacle") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingMiddleObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingMiddleObstacle") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "movingMiddleObstacle") && (secondBody.name == "topSensor") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "topSensor") && (secondBody.name == "movingMiddleObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingMiddleObstacle") && (secondBody.name == "bottomSensor") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "bottomSensor") && (secondBody.name == "movingMiddleObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingBottomObstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingBottomObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingBottomObstacle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingBottomObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingTopObstacle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingTopObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingTopObstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingTopObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "movingTopObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingTopObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingBottomObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingBottomObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingMiddleObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingMiddleObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "obstacle5") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacle5") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "topBarrier") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "movingMiddleObstacle" && Barrier.name == "topSensor" {
            movingMiddleObstacle.run(moveObstacleDown)
        }
        if Obstacle.name == "movingMiddleObstacle" && Barrier.name == "bottomSensor" {
            movingMiddleObstacle.run(moveObstacleUp)
        }
        if Obstacle.name == "movingBottomObstacle" && Barrier.name == "rightBarrier" {
            movingBottomObstacle.run(moveObstacleLeft)
        }
        if Obstacle.name == "movingBottomObstacle" && Barrier.name == "leftBarrier" {
            movingBottomObstacle.run(moveObstacleRight)
        }
        if Obstacle.name == "movingTopObstacle" && Barrier.name == "leftBarrier" {
            movingTopObstacle.run(moveObstacleRight)
        }
        if Obstacle.name == "movingTopObstacle" && Barrier.name == "rightBarrier" {
            movingTopObstacle.run(moveObstacleLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl12 completed")
            gameOver = true
            
            if ch2lvl13Unlocked == false {
            continueString = "ch2lvl13"
            UserDefaults.standard.set("ch2lvl13", forKey: "continueString")
            }
            ch2lvl13Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl13Unlocked")
            UserDefaults.standard.synchronize()

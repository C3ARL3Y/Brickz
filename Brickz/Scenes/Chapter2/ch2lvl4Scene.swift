...
class ch2lvl4Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    let wall5 = SKSpriteNode()
    let wall6 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brick1.size.width), y: self.frame.height / 2.6)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: self.frame.width / 2 + (brick2.size.width), y: self.frame.height / 2.6)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height * 2))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (brick3.size.height * 2))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick4.position.x, y: brick4.position.y + (brick4.size.height * 2))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x, y: brick5.position.y + (brick5.size.height * 2))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (brick6.size.height * 2))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick2.position.x, y: brick2.position.y + (brick2.size.height * 2))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick8.position.x, y: brick8.position.y + (brick8.size.height * 2))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x, y: brick9.position.y + (brick9.size.height * 2))
        ...
        brick11.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (brick10.size.height * 2))
        ...
        brick12.position = CGPoint(x: brick11.position.x, y: brick11.position.y + (brick11.size.height * 2))
        ...
        wall1.size = CGSize(width: self.frame.height / 40, height: brick1.size.height * 11)
        wall1.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + (brick1.size.height * 5))
        wall1.color = SKColor.brown
        ...
        wall1.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        wall1.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        wall1.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        wall2.size = CGSize(width: brick1.size.width * 2.2, height: self.frame.height / 40)
        wall2.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + (brick1.size.height))
        wall2.color = SKColor.brown
        ...
        wall2.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        wall2.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        wall2.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        wall3.size = CGSize(width: brick1.size.width * 2.2, height: self.frame.height / 40)
        wall3.position = CGPoint(x: self.frame.width / 2, y: brick3.position.y + (brick3.size.height))
        wall3.color = SKColor.brown
        wall3.colorBlendFactor = 1
        wall3.zPosition = 1
        wall3.name = "wall3"
        self.addChild(wall3)
        ...
        wall3.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        wall3.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        wall3.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        wall4.size = CGSize(width: brick1.size.width * 2.2, height: self.frame.height / 40)
        wall4.position = CGPoint(x: self.frame.width / 2, y: brick4.position.y + (brick4.size.height))
        wall4.color = SKColor.brown
        wall4.colorBlendFactor = 1
        wall4.zPosition = 1
        wall4.name = "wall4"
        self.addChild(wall4)
        ...
        wall4.physicsBody?.allowsRotation = false
        wall4.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        wall4.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        wall4.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        wall5.size = CGSize(width: brick1.size.width * 2.2, height: self.frame.height / 40)
        wall5.position = CGPoint(x: self.frame.width / 2, y: brick5.position.y + (brick5.size.height))
        wall5.color = SKColor.brown
        wall5.colorBlendFactor = 1
        wall5.zPosition = 1
        wall5.name = "wall5"
        self.addChild(wall5)
        wall5.physicsBody = SKPhysicsBody(rectangleOf: wall5.size)
        wall5.physicsBody?.affectedByGravity = false
        wall5.physicsBody?.isDynamic = true
        wall5.physicsBody?.allowsRotation = false
        wall5.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        wall5.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        wall5.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
        
        wall6.size = CGSize(width: brick1.size.width * 2.2, height: self.frame.height / 40)
        wall6.position = CGPoint(x: self.frame.width / 2, y: brick6.position.y + (brick6.size.height))
        wall6.color = SKColor.brown
        wall6.colorBlendFactor = 1
        wall6.zPosition = 1
        wall6.name = "wall6"
        self.addChild(wall6)
        wall6.physicsBody = SKPhysicsBody(rectangleOf: wall6.size)
        wall6.physicsBody?.affectedByGravity = false
        wall6.physicsBody?.isDynamic = true
        wall6.physicsBody?.allowsRotation = false
        wall6.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        wall6.physicsBody?.collisionBitMask = PhysicsCategory.Barrier
        wall6.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "wall1") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "wall1") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "wall2") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "wall2") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "wall3") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "wall3") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "wall4") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "wall4") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "wall5") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "wall5") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "wall6") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "wall6") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "wall1") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "wall1") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "wall2") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "wall2") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "wall3") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "wall3") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "wall4") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "wall4") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "wall5") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "wall5") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "wall6") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "wall6") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl4 completed")
            gameOver = true
            
            if ch2lvl5Unlocked == false {
            continueString = "ch2lvl5"
            UserDefaults.standard.set("ch2lvl5", forKey: "continueString")
            }
            ch2lvl5Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl5Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == wall1.name || Barrier.name == wall2.name || Barrier.name == wall3.name || Barrier.name == wall4.name || Barrier.name == wall5.name || Barrier.name == wall6.name {
            if soundBool == true {

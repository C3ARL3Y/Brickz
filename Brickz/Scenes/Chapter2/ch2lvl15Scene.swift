...
class ch2lvl15Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.height * 1.55), y: self.frame.height / 1.4)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick1.position.x + (brick1.size.height), y: brick1.position.y - (brick1.size.width / 2))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x, y: brick5.position.y - (brick1.size.width))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick5.position.x + (brick5.size.height), y: brick5.position.y - (brick5.size.width / 2))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick8.position.x + (brick8.size.height), y: brick8.position.y - (brick8.size.width / 2))
        ...
        brick11.position = CGPoint(x: self.frame.width - (brick11.size.height * 1.55), y: brick1.position.y)
        ...
        brick15.position = CGPoint(x: brick11.position.x - (brick11.size.height), y: brick11.position.y - (brick11.size.width / 2))
        ...
        brick16.position = CGPoint(x: brick15.position.x, y: brick15.position.y - (brick15.size.width))
        ...
        brick18.position = CGPoint(x: brick15.position.x - (brick15.size.height), y: brick15.position.y - (brick15.size.width / 2))
        ...
        brick20.position = CGPoint(x: brick18.position.x - (brick18.size.height), y: brick18.position.y - (brick18.size.width / 2))
        ...
        brick21.position = CGPoint(x: self.frame.width / 2 - (woodBrickSize.width / 2), y: brick14.position.y - (brick14.size.width / 2 + brick14.size.height))
        ...
        brick25.position = CGPoint(x: brick24.position.x - (brick24.size.width / 2), y: brick24.position.y + (brick24.size.height))
        ...
        brick30.position = CGPoint(x: brick29.position.x - (brick29.size.width / 2), y: brick29.position.y + (brick29.size.height))
        ...
        brick31.position = CGPoint(x: brick21.position.x, y: brick1.position.y + (brick1.size.width / 2 + brick1.size.height))
        ...
        brick33.position = CGPoint(x: brick31.position.x + (brick31.size.width), y: brick31.position.y)
        ...
        brick35.position = CGPoint(x: brick34.position.x - (brick34.size.width / 2), y: brick34.position.y - (brick34.size.height))
        ...
        brick36.position = CGPoint(x: brick35.position.x - (brick35.size.width), y: brick35.position.y)
        ...
        brick38.position = CGPoint(x: brick37.position.x + (brick37.size.width / 2), y: brick37.position.y - (brick37.size.height))
        ...
        brick39.texture = SKTexture(imageNamed: "brick1Texture4")
        brick39.size = woodBrickSize
        ...
        brick40.texture = SKTexture(imageNamed: "brick1Texture4")
        brick40.size = woodBrickSize
        brick40.position = CGPoint(x: brick39.position.x - (brick39.size.width / 2), y: brick39.position.y - (brick39.size.height))
        ...
        obstacleTop.position = CGPoint(x: 0 + (obstacleTop.size.width * 0.6), y: brick31.position.y + (brick31.size.height))
        ...
        obstacleBottom.position = CGPoint(x: self.frame.width - (obstacleBottom.size.width * 0.6), y: brick21.position.y - (brick21.size.height))
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "obstacleTop" && Barrier.name == "rightBarrier" {
            obstacleTop.run(moveObstacleLeft)
        }
        if Obstacle.name == "obstacleTop" && Barrier.name == "leftBarrier" {
            obstacleTop.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacleBottom" && Barrier.name == "leftBarrier" {
            obstacleBottom.run(moveObstacleRight)
        }
        if Obstacle.name == "obstacleBottom" && Barrier.name == "rightBarrier" {
            obstacleBottom.run(moveObstacleLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick39" {
            ...
            if brickLives[38] == 4 {
                brickLives[38] -= 1
                brick39.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[38] == 3 {
                brickLives[38] -= 1
                brick39.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[38] == 2 {
                brickLives[38] -= 1
                brick39.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick40" {
            ...
            if brickLives[39] == 4 {
                brickLives[39] -= 1
                brick40.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[39] == 3 {
                brickLives[39] -= 1
                brick40.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[39] == 2 {
                brickLives[39] -= 1
                brick40.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if brickCount == 0 {
            print("ch2lvl15 completed")
            gameOver = true
            if ch3lvl1Unlocked == false {
            continueString = "ch3lvl1"
            UserDefaults.standard.set("ch3lvl1", forKey: "continueString")
            }
            ch3lvl1Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch3lvl1Unlocked")
            UserDefaults.standard.synchronize()

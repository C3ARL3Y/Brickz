...
class ch2lvl9Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    let obstacleTopLeft = SKSpriteNode()
    let obstacleTopRight = SKSpriteNode()
    let obstacleBottomLeft = SKSpriteNode()
    let obstacleBottomRight = SKSpriteNode()
    
    var obstacleMoveRight = SKAction()
    var obstacleMoveLeft = SKAction()
    
    let iPhoneXLeftBarrier = SKSpriteNode()
    let iPhoneXRightBarrier = SKSpriteNode()
    let iPhoneXBottomBarrier = SKSpriteNode()
    
    let movingObstacleMiddle = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (brick1.size.height), y: self.frame.height / 1.2)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: brick1.position.x + (brick1.size.height), y: brick1.position.y - (brick1.size.width))
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: brick2.position.x - (brick2.size.height), y: brick2.position.y - (brick2.size.width))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick2.position.x - (brick2.size.height), y: brick2.position.y)
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (woodBrickSize.width + (woodBrickSize.height)))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x + (brick5.size.height), y: brick5.position.y - (brick5.size.width))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x - (brick6.size.height), y: brick6.position.y - (brick6.size.width))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick6.position.x - (brick6.size.height), y: brick6.position.y)
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position =  CGPoint(x: self.frame.width - (brick1.size.height), y: brick1.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x - (brick9.size.height), y: brick9.position.y - (brick9.size.width))
        ...
        brick11.position = CGPoint(x: brick10.position.x + (brick10.size.height), y: brick10.position.y - (brick10.size.width))
        ...
        brick12.position = CGPoint(x: brick10.position.x + (brick10.size.height), y: brick10.position.y)
        ...
        brick13.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.height) - (brick11.size.width))
        ...
        brick14.position = CGPoint(x: brick13.position.x - (brick13.size.height), y: brick13.position.y - (brick13.size.width))
        ...
        brick15.position = CGPoint(x: brick14.position.x + (brick14.size.height), y: brick14.position.y - (brick14.size.width))
        ...
        brick16.position = CGPoint(x: brick14.position.x + (brick14.size.height), y: brick14.position.y)
        ...
        brick17.position = CGPoint(x: self.frame.width / 2, y: brick15.position.y - (brick15.size.height / 2))
        ...
        brick21.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + (brick1.size.height / 2))
        ...
        brick23.position = CGPoint(x: brick21.position.x + (brick21.size.width), y: brick21.position.y)
        ...
        brick24.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brick21.size.height))
        ...
        obstacleTopLeft.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleTopLeft.position = CGPoint(x: brick22.position.x - (brick22.size.width * 1.32), y: brick22.position.y + (brick22.size.height / 5))
        obstacleTopLeft.zPosition = 1
        obstacleTopLeft.color = SKColor.brown
        obstacleTopLeft.name = "obstacleTopLeft"
        self.addChild(obstacleTopLeft)
        obstacleTopLeft.physicsBody = SKPhysicsBody(rectangleOf: obstacleTopLeft.size)
        obstacleTopLeft.physicsBody?.affectedByGravity = false
        obstacleTopLeft.physicsBody?.isDynamic = true
        obstacleTopLeft.physicsBody?.allowsRotation = false
        obstacleTopLeft.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleTopLeft.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleTopLeft.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleTopRight.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleTopRight.position = CGPoint(x: brick23.position.x + (brick23.size.width * 1.32), y: brick23.position.y + (brick23.size.height / 5))
        obstacleTopRight.zPosition = 1
        obstacleTopRight.color = SKColor.brown
        obstacleTopRight.name = "obstacleTopRight"
        self.addChild(obstacleTopRight)
        obstacleTopRight.physicsBody = SKPhysicsBody(rectangleOf: obstacleTopRight.size)
        obstacleTopRight.physicsBody?.affectedByGravity = false
        obstacleTopRight.physicsBody?.isDynamic = true
        obstacleTopRight.physicsBody?.allowsRotation = false
        obstacleTopRight.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleTopRight.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleTopRight.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleBottomLeft.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleBottomLeft.position = CGPoint(x: brick20.position.x - (brick20.size.width * 1.32), y: brick20.position.y - (brick20.size.height / 5))
        obstacleBottomLeft.zPosition = 1
        obstacleBottomLeft.color = SKColor.brown
        obstacleBottomLeft.name = "obstacleBottomLeft"
        self.addChild(obstacleBottomLeft)
        obstacleBottomLeft.physicsBody = SKPhysicsBody(rectangleOf: obstacleBottomLeft.size)
        obstacleBottomLeft.physicsBody?.affectedByGravity = false
        obstacleBottomLeft.physicsBody?.isDynamic = true
        obstacleBottomLeft.physicsBody?.allowsRotation = false
        obstacleBottomLeft.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleBottomLeft.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleBottomLeft.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleBottomRight.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleBottomRight.position = CGPoint(x: brick18.position.x + (brick18.size.width * 1.32), y: brick18.position.y - (brick18.size.height / 5))
        obstacleBottomRight.zPosition = 1
        obstacleBottomRight.color = SKColor.brown
        obstacleBottomRight.name = "obstacleBottomRight"
        self.addChild(obstacleBottomRight)
        obstacleBottomRight.physicsBody = SKPhysicsBody(rectangleOf: obstacleBottomRight.size)
        obstacleBottomRight.physicsBody?.affectedByGravity = false
        obstacleBottomRight.physicsBody?.isDynamic = true
        obstacleBottomRight.physicsBody?.allowsRotation = false
        obstacleBottomRight.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleBottomRight.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleBottomRight.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleMoveRight = SKAction.moveTo(x: rightBarrier.position.x, duration: 2.5)
        obstacleMoveLeft = SKAction.moveTo(x: leftBarrier.position.x, duration: 2.5)
        
        movingObstacleMiddle.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        movingObstacleMiddle.position = CGPoint(x: 0 + (self.frame.width / 11), y: brick3.position.y - (brick3.size.width * 0.8))
        movingObstacleMiddle.zPosition = 1
        movingObstacleMiddle.color = SKColor.brown
        movingObstacleMiddle.name = "movingObstacleMiddle"
        self.addChild(movingObstacleMiddle)
        movingObstacleMiddle.run(obstacleMoveRight)
        movingObstacleMiddle.physicsBody = SKPhysicsBody(rectangleOf: movingObstacleMiddle.size)
        movingObstacleMiddle.physicsBody?.affectedByGravity = false
        movingObstacleMiddle.physicsBody?.isDynamic = true
        movingObstacleMiddle.physicsBody?.allowsRotation = false
        movingObstacleMiddle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacleMiddle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacleMiddle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "obstacleTopLeft") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleTopLeft") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleTopRight") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleTopRight") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleBottomLeft") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleBottomLeft") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleBottomRight") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleBottomRight") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacleMiddle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacleMiddle") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "movingObstacleMiddle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacleMiddle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingObstacleMiddle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacleMiddle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleTopLeft") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleTopLeft") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleTopRight") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleTopRight") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleBottomLeft") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleBottomLeft") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleBottomRight") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleBottomRight") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacleMiddle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacleMiddle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "movingObstacleMiddle" && Barrier.name == "rightBarrier" {
            movingObstacleMiddle.run(obstacleMoveLeft)
        }
        if Obstacle.name == "movingObstacleMiddle" && Barrier.name == "leftBarrier" {
            movingObstacleMiddle.run(obstacleMoveRight)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl9 completed")
            gameOver = true
            
            if ch2lvl10Unlocked == false {
            continueString = "ch2lvl10"
            UserDefaults.standard.set("ch2lvl10", forKey: "continueString")
            }
            ch2lvl10Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl10Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == obstacleTopLeft.name || Barrier.name == obstacleTopRight.name || Barrier.name == obstacleBottomLeft.name || Barrier.name == obstacleBottomRight.name {
            if self.soundBool == true {

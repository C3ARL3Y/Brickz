...
class ch2lvl1Scene: SKScene, SKPhysicsContactDelegate {
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            continueString = "ch2lvl2"
            UserDefaults.standard.set("ch2lvl2", forKey: "continueString")
            }
            ch2lvl2Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl2Unlocked")
            UserDefaults.standard.synchronize()

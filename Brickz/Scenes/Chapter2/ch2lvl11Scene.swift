...
class ch2lvl11Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    override func didMove(to view: SKView) {
        ...
        brick4.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y + (brick1.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height * 2))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 2))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick1.position.x + (brick1.size.width * 2), y: brick1.position.y)
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2), y: brick1.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 6))
        ...
        brick12.position = CGPoint(x: brick10.position.x + (brick10.size.width), y: brick10.position.y - (brick10.size.height))
        ...
        brick13.position = CGPoint(x: brick10.position.x - (brick10.size.width), y: brick10.position.y + (brick10.size.height))
        ...
        brick14.position = CGPoint(x: brick10.position.x - (brick10.size.width), y: brick10.position.y - (brick10.size.height))
        ...
        brick15.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (brick10.size.height * 2))
        ...
        brick16.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick10.size.height * 2))
        ...
        brick17.position = CGPoint(x: brick10.position.x - (brick10.size.width * 2), y: brick10.position.y)
        ...
        brick18.position = CGPoint(x: brick10.position.x + (brick10.size.width * 2), y: brick10.position.y)
        ...
        brick19.position = CGPoint(x: brick10.position.x + (brick10.size.width), y: brick10.position.y + (brick10.size.height * 3))
        ...
        brick21.position = CGPoint(x: brick19.position.x + (brick19.size.width), y: brick19.position.y - (brick19.size.height))
        ...
        brick24.position = CGPoint(x: brick20.position.x + (brick20.size.width), y: brick20.position.y + (brick20.size.height))
        ...
        brick25.position = CGPoint(x: brick10.position.x - (brick10.size.width), y: brick10.position.y + (brick10.size.height * 3))
        ...
        brick26.position = CGPoint(x: brick25.position.x - (brick25.size.width), y: brick25.position.y + (brick25.size.height))
        ...
        brick27.position = CGPoint(x: brick25.position.x - (brick25.size.width), y: brick25.position.y - (brick25.size.height))
        ...
        brick29.position = CGPoint(x: brick27.position.x - (brick27.size.width), y: brick27.position.y + (brick27.size.height))
        ...
        brick30.position = CGPoint(x: brick26.position.x - (brick26.size.width), y: brick26.position.y + (brick26.size.height))
        ...
        bottomMovingObstacle.position = CGPoint(x: 0 + (bottomMovingObstacle.size.width / 2), y: brick16.position.y - (woodBrickSize.height * 1.5))
        ...
        obstacle1.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height))
        ...
        obstacle2.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick10.size.height))
        ...
        obstacle3.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (brick10.size.height * 3))
        ...
        obstacle4.position = CGPoint(x: obstacle3.position.x - (obstacle3.size.width * 2), y: obstacle3.position.y)
        ...
        obstacle5.position = CGPoint(x: obstacle3.position.x + (obstacle3.size.width * 2), y: obstacle3.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl11 completed")
            gameOver = true
            
            if ch2lvl12Unlocked == false {
            continueString = "ch2lvl12"
            UserDefaults.standard.set("ch2lvl12", forKey: "continueString")
            }
            ch2lvl12Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl12Unlocked")
            UserDefaults.standard.synchronize()

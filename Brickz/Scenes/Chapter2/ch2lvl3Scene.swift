...
class ch2lvl3Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4]
    ...
    let barrierLeft = SKSpriteNode()
    let barrierRight = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        brick4.position = CGPoint(x: brick1.position.x - (brick1.size.width * 2), y: brick1.position.y)
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        barrierLeft.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 3)
        barrierLeft.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y + (brick1.size.height / 2))
        barrierLeft.color = SKColor.brown
        barrierLeft.colorBlendFactor = 1
        barrierLeft.zPosition = 1
        barrierLeft.name = "barrierLeft"
        self.addChild(barrierLeft)
        barrierLeft.physicsBody = SKPhysicsBody(rectangleOf: barrierLeft.size)
        barrierLeft.physicsBody?.affectedByGravity = false
        barrierLeft.physicsBody?.isDynamic = true
        barrierLeft.physicsBody?.allowsRotation = false
        barrierLeft.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        barrierLeft.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        barrierLeft.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        barrierRight.size = CGSize(width: self.frame.height / 40, height: self.frame.width / 3)
        barrierRight.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y + (brick1.size.height / 2))
        barrierRight.color = SKColor.brown
        barrierRight.colorBlendFactor = 1
        barrierRight.zPosition = 1
        barrierRight.name = "barrierRight"
        self.addChild(barrierRight)
        barrierRight.physicsBody = SKPhysicsBody(rectangleOf: barrierRight.size)
        barrierRight.physicsBody?.affectedByGravity = false
        barrierRight.physicsBody?.isDynamic = true
        barrierRight.physicsBody?.allowsRotation = false
        barrierRight.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        barrierRight.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        barrierRight.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "barrierLeft") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "barrierLeft") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "barrierRight") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "barrierRight") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "barrierLeft") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "barrierLeft") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "barrierRight") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "barrierRight") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl3 completed")
            gameOver = true
            
            if ch2lvl4Unlocked == false {
            continueString = "ch2lvl4"
            UserDefaults.standard.set("ch2lvl4", forKey: "continueString")
            }
            ch2lvl4Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl4Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == barrierLeft.name || Barrier.name == barrierRight.name {
            if self.soundBool == true {

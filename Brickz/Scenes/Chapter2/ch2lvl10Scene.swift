...
class ch2lvl10Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    override func didMove(to view: SKView) {
        ...
        leftBarrier.physicsBody?.collisionBitMask = PhysicsCategory.Ball
        leftBarrier.physicsBody?.contactTestBitMask = PhysicsCategory.Ball
        ...
        rightBarrier.physicsBody?.collisionBitMask = PhysicsCategory.Ball
        rightBarrier.physicsBody?.contactTestBitMask = PhysicsCategory.Ball
        ...
        topBarrier.physicsBody?.collisionBitMask = PhysicsCategory.Rocket | PhysicsCategory.Ball
        topBarrier.physicsBody?.contactTestBitMask = PhysicsCategory.Rocket | PhysicsCategory.Ball
        ...
        paddle.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 12)
        paddle.zPosition = 1
        paddle.name = "paddle"
        ...
        paddle.physicsBody?.collisionBitMask = PhysicsCategory.PowerUp
        paddle.physicsBody?.contactTestBitMask = PhysicsCategory.PowerUp
        ...
        ball1.physicsBody?.collisionBitMask = PhysicsCategory.Paddle | PhysicsCategory.Barrier | PhysicsCategory.Brick | PhysicsCategory.Obstacle
        ball1.physicsBody?.contactTestBitMask = PhysicsCategory.Paddle | PhysicsCategory.Brick | PhysicsCategory.Obstacle | PhysicsCategory.Barrier
        ...
        ball2.physicsBody?.collisionBitMask = PhysicsCategory.Paddle | PhysicsCategory.Barrier | PhysicsCategory.Brick | PhysicsCategory.Obstacle
        ball2.physicsBody?.contactTestBitMask = PhysicsCategory.Paddle | PhysicsCategory.Brick | PhysicsCategory.Obstacle | PhysicsCategory.Barrier
        ...
        ball3.physicsBody?.collisionBitMask = PhysicsCategory.Paddle | PhysicsCategory.Barrier | PhysicsCategory.Brick | PhysicsCategory.Obstacle
        ball3.physicsBody?.contactTestBitMask = PhysicsCategory.Paddle | PhysicsCategory.Brick | PhysicsCategory.Obstacle | PhysicsCategory.Barrier
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.4)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick3.position = CGPoint(x: brick2.position.x + (brick2.size.width), y: brick2.position.y + (brick1.size.height))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick3.position.x + (brick3.size.width), y: brick3.position.y + (brick3.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y + (brick1.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick5.position.x - (brick5.size.width), y: brick5.position.y + (brick5.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 2))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick8.position.x + (brick8.size.width), y: brick8.position.y + (brick8.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick9.position.x + (brick9.size.width), y: brick9.position.y + (brick9.size.height))
        ...
        brick11.position = CGPoint(x: brick10.position.x + (brick10.size.width), y: brick10.position.y + (brick10.size.height))
        ...
        brick12.position = CGPoint(x: brick8.position.x - (brick8.size.width), y: brick8.position.y + (brick8.size.height))
        ...
        brick13.position = CGPoint(x: brick12.position.x - (brick12.size.width), y: brick12.position.y + (brick12.size.height))
        ...
        brick14.position = CGPoint(x: brick13.position.x - (brick13.size.width), y: brick13.position.y + (brick13.size.height))
        ...
        brick15.position = CGPoint(x: brick8.position.x, y: brick8.position.y - (brick8.size.height * 2))
        ...
        brick16.position = CGPoint(x: brick15.position.x + (brick15.size.width), y: brick15.position.y + (brick15.size.height))
        ...
        brick18.position = CGPoint(x: brick17.position.x + (brick17.size.width), y: brick17.position.y + (brick17.size.height))
        ...
        brick19.position = CGPoint(x: brick15.position.x - (brick15.size.width), y: brick15.position.y + (brick15.size.height))
        ...
        brick20.position = CGPoint(x: brick19.position.x - (brick19.size.width), y: brick19.position.y + (brick19.size.height))
        ...
        brick21.position = CGPoint(x: brick20.position.x - (brick20.size.width), y: brick20.position.y + (brick20.size.height))
        ...
        brick22.position = CGPoint(x: brick15.position.x, y: brick15.position.y - (brick15.size.height * 2))
        ...
        brick23.position = CGPoint(x: brick22.position.x + (brick22.size.width), y: brick22.position.y + (brick22.size.height))
        ...
        brick24.position = CGPoint(x: brick23.position.x + (brick23.size.width), y: brick23.position.y + (brick23.size.height))
        ...
        brick25.position = CGPoint(x: brick24.position.x + (brick24.size.width), y: brick24.position.y + (brick24.size.height))
        ...
        brick26.position = CGPoint(x: brick22.position.x - (brick22.size.width), y: brick22.position.y + (brick22.size.height))
        ...
        brick28.position = CGPoint(x: brick27.position.x - (brick27.size.width), y: brick27.position.y + (brick27.size.height))
        ...
        bottomMovingObstacle.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        bottomMovingObstacle.position = CGPoint(x: 0 + (bottomMovingObstacle.size.width * 0.55), y: brick22.position.y - (brick22.size.height))
        bottomMovingObstacle.zPosition = 1
        bottomMovingObstacle.color = SKColor.brown
        bottomMovingObstacle.name = "bottomMovingObstacle"
        self.addChild(bottomMovingObstacle)
        bottomMovingObstacle.run(moveObstacleRight)
        bottomMovingObstacle.physicsBody = SKPhysicsBody(rectangleOf: bottomMovingObstacle.size)
        bottomMovingObstacle.physicsBody?.affectedByGravity = false
        bottomMovingObstacle.physicsBody?.isDynamic = true
        bottomMovingObstacle.physicsBody?.allowsRotation = false
        bottomMovingObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        bottomMovingObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        bottomMovingObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacle1.size = CGSize(width: woodBrickSize.width, height: self.frame.height / 40)
        obstacle1.position = CGPoint(x: brick15.position.x, y: brick15.position.y + brick15.size.height)
        ...
        obstacle2.size = CGSize(width: woodBrickSize.width, height: self.frame.height / 40)
        obstacle2.position = CGPoint(x: brick17.position.x, y: brick17.position.y + brick17.size.height)
        ...
        obstacle3.size = CGSize(width: woodBrickSize.width, height: self.frame.height / 40)
        obstacle3.position = CGPoint(x: brick20.position.x, y: brick20.position.y + brick20.size.height)
        ...
        obstacle4.size = CGSize(width: woodBrickSize.width, height: self.frame.height / 40)
        obstacle4.position = CGPoint(x: brick25.position.x, y: brick25.position.y - brick25.size.height)
        ...
        obstacle5.size = CGSize(width: woodBrickSize.width, height: self.frame.height / 40)
        obstacle5.position = CGPoint(x: brick28.position.x, y: brick28.position.y - brick28.size.height)
        obstacle5.zPosition = 1
        obstacle5.color = SKColor.brown
        obstacle5.name = "obstacle5"
        self.addChild(obstacle5)
        obstacle5.physicsBody = SKPhysicsBody(rectangleOf: obstacle5.size)
        obstacle5.physicsBody?.affectedByGravity = false
        obstacle5.physicsBody?.isDynamic = true
        obstacle5.physicsBody?.allowsRotation = false
        obstacle5.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacle5.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacle5.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "bottomMovingObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "bottomMovingObstacle") && (secondBody.name == "ball") {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "obstacle5") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacle5") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "bottomMovingObstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "bottomMovingObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "bottomMovingObstacle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "bottomMovingObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "bottomMovingObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "bottomMovingObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "bottomMovingObstacle" && Barrier.name == "leftBarrier" {
            bottomMovingObstacle.run(moveObstacleRight)
        }
        if Obstacle.name == "bottomMovingObstacle" && Barrier.name == "rightBarrier"{
            bottomMovingObstacle.run(moveObstacleLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            continueString = "ch2lvl11"
            UserDefaults.standard.set("ch2lvl11", forKey: "continueString")
            }
            ch2lvl11Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl11Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == obstacle1.name || Barrier.name == obstacle2.name || Barrier.name == obstacle3.name || Barrier.name == obstacle4.name || Barrier.name == obstacle5.name {
            if self.soundBool == true {

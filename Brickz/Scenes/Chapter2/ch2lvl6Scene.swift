...
class ch2lvl6Scene: SKScene, SKPhysicsContactDelegate {
    ...
    let stationaryObstacle = SKSpriteNode()
    let movingObstacle = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        obstacleMoveLeft = SKAction.moveTo(x: 0, duration: 2.5)
        
        brick7.texture = SKTexture(imageNamed: "brick1Texture4") // attache everything to this brick brick7
        brick7.size = woodBrickSize
        brick7.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.4)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick1.position = CGPoint(x: brick7.position.x - (brick7.size.width), y: brick7.position.y + (brick7.size.height))
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick7.position.x + (brick7.size.width), y: brick7.position.y + (brick7.size.height))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick8.position.x + (brick8.size.width), y: brick8.position.y - (brick8.size.height))
        ...
        brick13.position = CGPoint(x: brick9.position.x - (brick9.size.width), y: brick9.position.y - (brick9.size.height))
        ...
        stationaryObstacle.size = CGSize(width: self.frame.height / 40, height: self.frame.height / 5)
        stationaryObstacle.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y - (woodBrickSize.height / 2 + self.frame.height / 5))
        stationaryObstacle.color = SKColor.brown
        stationaryObstacle.zPosition = 1
        stationaryObstacle.name = "stationaryObstacle"
        self.addChild(stationaryObstacle)
        stationaryObstacle.physicsBody = SKPhysicsBody(rectangleOf: stationaryObstacle.size)
        stationaryObstacle.physicsBody?.affectedByGravity = false
        stationaryObstacle.physicsBody?.isDynamic = true
        stationaryObstacle.physicsBody?.allowsRotation = false
        stationaryObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        stationaryObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        stationaryObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        movingObstacle.size = CGSize(width: self.frame.width / 7, height: self.frame.height / 40)
        movingObstacle.position = CGPoint(x: leftBarrier.position.x + (movingObstacle.size.width * 0.75), y: self.frame.height / 2.5)
        movingObstacle.color = SKColor.brown
        movingObstacle.zPosition = 1
        ...
        movingObstacle.physicsBody?.affectedByGravity = false
        movingObstacle.physicsBody?.isDynamic = true
        movingObstacle.physicsBody?.allowsRotation = false
        movingObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacle.run(obstacleMoveRight)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "stationaryObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "stationaryObstacle") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacle") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "movingObstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingObstacle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "stationaryObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "stationaryObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Barrier.name == "leftBarrier" {
            movingObstacle.run(obstacleMoveRight)
        } else if Barrier.name == "rightBarrier" {
            movingObstacle.run(obstacleMoveLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl6 completed")
            gameOver = true
            
            if ch2lvl7Unlocked == false {
            continueString = "ch2lvl7"
            UserDefaults.standard.set("ch2lvl7", forKey: "continueString")
            }
            ch2lvl7Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl7Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == movingObstacle.name || Barrier.name == stationaryObstacle.name {
            if self.soundBool == true {

...
class ch2lvl2Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4]
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl2 completed")
            gameOver = true
            
            if ch2lvl3Unlocked == false {
            continueString = "ch2lvl3"
            UserDefaults.standard.set("ch2lvl3", forKey: "continueString")
            }
            ch2lvl3Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl3Unlocked")
            UserDefaults.standard.synchronize()

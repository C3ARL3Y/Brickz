...
class ch2lvl5Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    override func didMove(to view: SKView) {
        ...
        obstacleTop.size = CGSize(width: brick1.size.width * 3.5, height: self.frame.height / 40)
        obstacleTop.position = CGPoint(x: self.frame.width / 2, y: brick13.position.y + (brick1.size.height - (obstacleTop.size.height)))
        obstacleTop.color = SKColor.brown
        obstacleTop.colorBlendFactor = 1
        ...
        obstacleBottom.size = CGSize(width: brick1.size.width * 3.5, height: self.frame.height / 40)
        obstacleBottom.position = CGPoint(x: self.frame.width / 2, y: brick4.position.y - (brick1.size.height - (obstacleBottom.size.height)))
        obstacleBottom.color = SKColor.brown
        obstacleBottom.colorBlendFactor = 1
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl15 completed")
            gameOver = true
            
            if ch2lvl6Unlocked == false {
            continueString = "ch2lvl6"
            UserDefaults.standard.set("ch2lvl6", forKey: "continueString")
            }
            ch2lvl6Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl6Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == obstacleTop.name || Barrier.name == obstacleBottom.name {
            if self.soundBool == true {

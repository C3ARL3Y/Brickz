...
class ch2lvl7Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    let movingObstacleBottom = SKSpriteNode()
    let movingObstacleTop = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        obstacleMoveRight = SKAction.moveTo(x: self.frame.width, duration: 2.5)
        
        brick1.texture = SKTexture(imageNamed: "brick1Texture4")
        brick1.size = woodBrickSize
        brick1.position = CGPoint(x: self.frame.width / 2 - (woodBrickSize.width * 3), y: self.frame.height / 1.4)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick3.position.x - (brick3.size.width), y: brick3.position.y - (brick3.size.height * 2))
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick4.position.x + (brick4.size.width), y: brick4.position.y - (brick4.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick4.position.x - (brick4.size.width), y: brick4.position.y + (brick4.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick4.position.x - (brick4.size.width), y: brick4.position.y - (brick4.size.height))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick2.position.x + (brick2.size.width * 2), y: brick2.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick13.position = CGPoint(x: brick12.position.x - (brick12.size.width), y: brick12.position.y - (brick12.size.height * 2))
        ...
        obstacle1.size = CGSize(width: self.frame.height / 40, height: woodBrickSize.height * 3)
        obstacle1.position = CGPoint(x: self.frame.width / 2, y: brick5.position.y - (woodBrickSize.height * 0.5))
        ...
        movingObstacleBottom.size = CGSize(width: self.frame.width / 7, height: self.frame.height / 40)
        movingObstacleBottom.position = CGPoint(x: leftBarrier.position.x + (movingObstacleBottom.size.width * 0.75), y: brick18.position.y - (woodBrickSize.height * 1.5))
        movingObstacleBottom.zPosition = 1
        movingObstacleBottom.color = SKColor.brown
        movingObstacleBottom.name =  "movingObstacleBottom"
        self.addChild(movingObstacleBottom)
        movingObstacleBottom.physicsBody = SKPhysicsBody(rectangleOf: movingObstacleBottom.size)
        movingObstacleBottom.physicsBody?.affectedByGravity = false
        movingObstacleBottom.physicsBody?.isDynamic = true
        movingObstacleBottom.physicsBody?.allowsRotation = false
        movingObstacleBottom.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacleBottom.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacleBottom.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacleBottom.run(obstacleMoveRight)
        
        movingObstacleTop.size = CGSize(width: self.frame.width / 7, height: self.frame.height / 40)
        movingObstacleTop.position = CGPoint(x: rightBarrier.position.x - (movingObstacleTop.size.width * 0.75), y: brick9.position.y + (woodBrickSize.height * 1.5))
        movingObstacleTop.zPosition = 1
        movingObstacleTop.color = SKColor.brown
        movingObstacleTop.name =  "movingObstacleTop"
        self.addChild(movingObstacleTop)
        movingObstacleTop.physicsBody = SKPhysicsBody(rectangleOf: movingObstacleTop.size)
        movingObstacleTop.physicsBody?.affectedByGravity = false
        movingObstacleTop.physicsBody?.isDynamic = true
        movingObstacleTop.physicsBody?.allowsRotation = false
        movingObstacleTop.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        movingObstacleTop.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacleTop.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        movingObstacleTop.run(obstacleMoveLeft)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacleBottom") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacleBottom") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "movingObstacleTop") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "movingObstacleTop") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "movingObstacleTop") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacleTop") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingObstacleTop") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacleTop") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingObstacleBottom") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "movingObstacleBottom") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "movingObstacleBottom") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "movingObstacleBottom") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacleBottom") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacleBottom") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "movingObstacleTop") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "movingObstacleTop") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "movingObstacleTop" && Barrier.name == "leftBarrier" {
            movingObstacleTop.run(obstacleMoveRight)
        } else if Obstacle.name == "movingObstacleTop" && Barrier.name == "rightBarrier" {
            movingObstacleTop.run(obstacleMoveLeft)
        }
        if Obstacle.name == "movingObstacleBottom" && Barrier.name == "leftBarrier" {
            movingObstacleBottom.run(obstacleMoveRight)
        } else if Obstacle.name == "movingObstacleBottom" && Barrier.name == "rightBarrier" {
            movingObstacleBottom.run(obstacleMoveLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl7 completed")
            gameOver = true
            
            if ch2lvl8Unlocked == false {
            continueString = "ch2lvl8"
            UserDefaults.standard.set("ch2lvl8", forKey: "continueString")
            }
            ch2lvl8Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl8Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == obstacle1.name || Barrier.name == movingObstacleTop.name || Barrier.name == movingObstacleBottom.name {
            if self.soundBool == true {

...
class ch2lvl8Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    let obstacleMiddleMoving = SKSpriteNode()
    let obstacleBottomMoving = SKSpriteNode()
    let obstacleTopMoving = SKSpriteNode()
    let obstacleTopStationary = SKSpriteNode()
    let obstacleBottomStationary = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        obstacleMoveLeft = SKAction.moveTo(x: 0, duration: 2.2)
        obstacleMoveRight = SKAction.moveTo(x: self.frame.width, duration: 2.2)
        ...
        brick3.position = CGPoint(x: brick2.position.x + (brick2.size.width), y: brick2.position.y + (brick2.size.height))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick4.position.x - (brick4.size.width), y: brick4.position.y + (brick4.size.height))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height))
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick2.position.x, y: brick2.position.y + (brick2.size.height))
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (brick3.size.height))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick4.position.x, y: brick4.position.y + (brick4.size.height))
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick5.position.x, y: brick5.position.y + (brick5.size.height))
        ...
        brick11.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height * 2))
        ...
        brick14.position = CGPoint(x: brick11.position.x - (brick11.size.width), y: brick11.position.y - (brick11.size.height))
        ...
        brick15.position = CGPoint(x: brick14.position.x - (brick14.size.width), y: brick14.position.y - (brick14.size.height))
        ...
        brick16.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.height))
        ...
        brick17.position = CGPoint(x: brick12.position.x, y: brick12.position.y - (brick12.size.height))
        ...
        brick18.position = CGPoint(x: brick13.position.x, y: brick13.position.y - (brick13.size.height))
        ...
        brick19.position = CGPoint(x: brick14.position.x, y: brick14.position.y - (brick14.size.height))
        ...
        brick20.position = CGPoint(x: brick15.position.x, y: brick15.position.y - (brick15.size.height))
        ...
        obstacleMiddleMoving.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleMiddleMoving.position = CGPoint(x: 0 + obstacleMiddleMoving.size.width * 0.6, y: brick1.position.y - (woodBrickSize.height))
        obstacleMiddleMoving.zPosition = 1
        obstacleMiddleMoving.color = SKColor.brown
        obstacleMiddleMoving.name = "obstacleMiddleMoving"
        self.addChild(obstacleMiddleMoving)
        obstacleMiddleMoving.run(obstacleMoveRight)
        obstacleMiddleMoving.physicsBody = SKPhysicsBody(rectangleOf: obstacleMiddleMoving.size)
        obstacleMiddleMoving.physicsBody?.affectedByGravity = false
        obstacleMiddleMoving.physicsBody?.isDynamic = true
        obstacleMiddleMoving.physicsBody?.allowsRotation = false
        obstacleMiddleMoving.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleMiddleMoving.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleMiddleMoving.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleBottomMoving.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleBottomMoving.position = CGPoint(x: self.frame.width - obstacleBottomMoving.size.width * 0.6, y: brick20.position.y - (woodBrickSize.height))
        obstacleBottomMoving.zPosition = 1
        obstacleBottomMoving.color = SKColor.brown
        obstacleBottomMoving.name = "obstacleBottomMoving"
        self.addChild(obstacleBottomMoving)
        obstacleBottomMoving.run(obstacleMoveLeft)
        obstacleBottomMoving.physicsBody = SKPhysicsBody(rectangleOf: obstacleBottomMoving.size)
        obstacleBottomMoving.physicsBody?.affectedByGravity = false
        obstacleBottomMoving.physicsBody?.isDynamic = true
        obstacleBottomMoving.physicsBody?.allowsRotation = false
        obstacleBottomMoving.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleBottomMoving.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleBottomMoving.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleTopMoving.size = CGSize(width: self.frame.width / 6, height: self.frame.height / 40)
        obstacleTopMoving.position = CGPoint(x: self.frame.width - obstacleTopMoving.size.width * 0.6, y: brick10.position.y + (woodBrickSize.height))
        obstacleTopMoving.name = "obstacleTopMoving"
        obstacleTopMoving.color = SKColor.brown
        obstacleTopMoving.zPosition = 1
        self.addChild(obstacleTopMoving)
        obstacleTopMoving.run(obstacleMoveLeft)
        obstacleTopMoving.physicsBody = SKPhysicsBody(rectangleOf: obstacleTopMoving.size)
        obstacleTopMoving.physicsBody?.affectedByGravity = false
        obstacleTopMoving.physicsBody?.isDynamic = true
        obstacleTopMoving.physicsBody?.allowsRotation = false
        obstacleTopMoving.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleTopMoving.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleTopMoving.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleTopStationary.size = CGSize(width: (self.frame.width / 6) * 2, height: self.frame.height / 40)
        obstacleTopStationary.position = CGPoint(x: self.frame.width / 2, y: brick8.position.y)
        obstacleTopStationary.zPosition = 1
        obstacleTopStationary.color = SKColor.brown
        obstacleTopStationary.name = "obstacleTopStationary"
        self.addChild(obstacleTopStationary)
        obstacleTopStationary.physicsBody = SKPhysicsBody(rectangleOf: obstacleTopStationary.size)
        obstacleTopStationary.physicsBody?.affectedByGravity = false
        obstacleTopStationary.physicsBody?.isDynamic = true
        obstacleTopStationary.physicsBody?.allowsRotation = false
        obstacleTopStationary.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleTopStationary.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleTopStationary.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        obstacleBottomStationary.size = CGSize(width: (self.frame.width / 6) * 2, height: self.frame.height / 40)
        obstacleBottomStationary.position = CGPoint(x: self.frame.width / 2, y: brick20.position.y)
        obstacleBottomStationary.zPosition = 1
        obstacleBottomStationary.color = SKColor.brown
        obstacleBottomStationary.name = "obstacleBottomStationary"
        self.addChild(obstacleBottomStationary)
        obstacleBottomStationary.physicsBody = SKPhysicsBody(rectangleOf: obstacleBottomStationary.size)
        obstacleBottomStationary.physicsBody?.affectedByGravity = false
        obstacleBottomStationary.physicsBody?.isDynamic = true
        obstacleBottomStationary.physicsBody?.allowsRotation = false
        obstacleBottomStationary.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        obstacleBottomStationary.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        obstacleBottomStationary.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "obstacleMiddleMoving") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleMiddleMoving") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleBottomMoving") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleBottomMoving") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleTopMoving") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleTopMoving") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleTopStationary") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleTopStationary") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "ball") && (secondBody.name == "obstacleBottomStationary") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "obstacleBottomStationary") && (secondBody.name == "ball") {
                checkBallVelocity(Ball: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "obstacleTopMoving") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacleTopMoving") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "obstacleTopMoving") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacleTopMoving") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "obstacleMiddleMoving") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacleMiddleMoving") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "obstacleMiddleMoving") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacleMiddleMoving") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "obstacleBottomMoving") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "obstacleBottomMoving") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "obstacleBottomMoving") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "obstacleBottomMoving") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleTopMoving") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleTopMoving") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleMiddleMoving") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleMiddleMoving") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleBottomMoving") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleBottomMoving") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleTopStationary") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleTopStationary") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
            if (firstBody.name == "rocket") && (secondBody.name == "obstacleBottomStationary") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "obstacleBottomStationary") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "obstacleTopMoving" && Barrier.name == "rightBarrier" {
            obstacleTopMoving.run(obstacleMoveLeft)
        }
        if Obstacle.name == "obstacleTopMoving" && Barrier.name == "leftBarrier" {
            obstacleTopMoving.run(obstacleMoveRight)
        }
        if Obstacle.name == "obstacleBottomMoving" && Barrier.name == "leftBarrier" {
            obstacleBottomMoving.run(obstacleMoveRight)
        }
        if Obstacle.name == "obstacleBottomMoving" && Barrier.name == "rightBarrier" {
            obstacleBottomMoving.run(obstacleMoveLeft)
        }
        if Obstacle.name == "obstacleMiddleMoving" && Barrier.name == "leftBarrier" {
            obstacleMiddleMoving.run(obstacleMoveRight)
        }
        if Obstacle.name == "obstacleMiddleMoving" && Barrier.name == "rightBarrier" {
            obstacleMiddleMoving.run(obstacleMoveLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl8 completed")
            gameOver = true
            
            if ch2lvl9Unlocked == false {
            continueString = "ch2lvl9"
            UserDefaults.standard.set("ch2lvl9", forKey: "continueString")
            }
            ch2lvl9Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl9Unlocked")
            UserDefaults.standard.synchronize()
    ...
    func checkBallVelocity(Ball: SKSpriteNode, Barrier: SKSpriteNode) {
        ...
        if Barrier.name == obstacleBottomStationary.name || Barrier.name == obstacleTopStationary.name || Barrier.name == obstacleTopMoving.name || Barrier.name == obstacleBottomMoving.name || Barrier.name == obstacleMiddleMoving.name  {
            if self.soundBool == true {

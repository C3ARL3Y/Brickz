...
class ch2lvl13Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    let topMovingObstacle = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + (woodBrickSize.height * 2), y: self.frame.height / 1.35)
        brick1.name = "brick1"
        brick1.zPosition = 1
        ...
        brick2.position = CGPoint(x: brick1.position.x + (brick1.size.height), y: brick1.position.y)
        brick2.name = "brick2"
        brick2.zPosition = 1
        ...
        brick3.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.width))
        brick3.name = "brick3"
        brick3.zPosition = 1
        ...
        brick4.position = CGPoint(x: brick1.position.x - (brick1.size.height), y: brick1.position.y)
        brick4.name = "brick4"
        brick4.zPosition = 1
        ...
        brick5.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.width))
        brick5.name = "brick5"
        brick5.zPosition = 1
        ...
        brick6.position = CGPoint(x: self.frame.width - (woodBrickSize.height * 2), y: brick1.position.y)
        brick6.name = "brick6"
        brick6.zPosition = 1
        ...
        brick7.position = CGPoint(x: brick6.position.x + (brick6.size.height), y: brick6.position.y)
        brick7.name = "brick7"
        brick7.zPosition = 1
        ...
        brick8.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (brick6.size.width))
        brick8.name = "brick8"
        brick8.zPosition = 1
        ...
        brick9.position = CGPoint(x: brick6.position.x - (brick6.size.height), y: brick6.position.y)
        brick9.name = "brick9"
        brick9.zPosition = 1
        ...
        brick10.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.width))
        ...
        brick11.position = CGPoint(x: brick1.position.x + (brick1.size.height * 3.35), y: brick1.position.y)
        ...
        brick13.position = CGPoint(x: brick11.position.x, y: brick11.position.y + (brick11.size.width))
        ...
        brick14.position = CGPoint(x: brick11.position.x - (brick11.size.height), y: brick11.position.y)
        ...
        brick15.position = CGPoint(x: brick11.position.x, y: brick11.position.y - (brick11.size.width))
        ...
        brick16.position = CGPoint(x: brick6.position.x - (brick6.size.height * 3.35), y: brick6.position.y)
        ...
        brick17.position = CGPoint(x: brick16.position.x + (brick16.size.height), y: brick16.position.y)
        ...
        brick18.position = CGPoint(x: brick16.position.x, y: brick16.position.y + (brick16.size.width))
        ...
        brick20.position = CGPoint(x: brick16.position.x, y: brick16.position.y - (brick16.size.width))
        ...
        brick21.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.width * 3 + brick1.size.height))
        ...
        brick22.position = CGPoint(x: brick21.position.x + (brick21.size.height), y: brick21.position.y)
        ...
        brick23.position = CGPoint(x: brick21.position.x, y: brick21.position.y + (brick21.size.width))
        ...
        brick24.position = CGPoint(x: brick21.position.x - (brick21.size.height), y: brick21.position.y)
        ...
        brick25.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brick21.size.width))
        ...
        brick26.position = CGPoint(x: brick6.position.x, y: brick21.position.y)
        ...
        brick27.position = CGPoint(x: brick26.position.x + (brick26.size.height), y: brick26.position.y)
        ...
        brick28.position = CGPoint(x: brick26.position.x, y: brick26.position.y + (brick26.size.width))
        ...
        brick29.position = CGPoint(x: brick26.position.x - (brick26.size.height), y: brick26.position.y)
        ...
        brick30.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brick26.size.width))
        ...
        brick31.position = CGPoint(x: self.frame.width / 2, y: brick26.position.y)
        ...
        brick32.position = CGPoint(x: brick31.position.x + (brick31.size.height), y: brick31.position.y)
        ...
        brick33.position = CGPoint(x: brick31.position.x, y: brick31.position.y + (brick31.size.width))
        ...
        brick34.position = CGPoint(x: brick31.position.x - (brick31.size.height), y: brick31.position.y)
        ...
        brick35.position = CGPoint(x: brick31.position.x, y: brick31.position.y - (brick31.size.width))
        ...
        brick12.position = CGPoint(x: brick30.position.x, y: brick30.position.y - (brick30.size.width))
        ...
        brick19.position = CGPoint(x: brick25.position.x, y: brick25.position.y - (brick25.size.width))
        ...
        topMovingObstacle.size = CGSize(width: self.frame.width / 6.5, height: self.frame.height / 40)
        topMovingObstacle.position = CGPoint(x: 0 + (topMovingObstacle.size.width * 0.6), y: brick5.position.y - ((brick1.size.width / 2) + brick1.size.height / 2))
        topMovingObstacle.zPosition = 1
        topMovingObstacle.color = SKColor.brown
        topMovingObstacle.name = "topMovingObstacle"
        self.addChild(topMovingObstacle)
        topMovingObstacle.run(moveObstacleRight)
        topMovingObstacle.physicsBody = SKPhysicsBody(rectangleOf: topMovingObstacle.size)
        topMovingObstacle.physicsBody?.affectedByGravity = false
        topMovingObstacle.physicsBody?.isDynamic = true
        topMovingObstacle.physicsBody?.allowsRotation = false
        topMovingObstacle.physicsBody?.categoryBitMask = PhysicsCategory.Obstacle
        topMovingObstacle.physicsBody?.collisionBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        topMovingObstacle.physicsBody?.contactTestBitMask = PhysicsCategory.Barrier | PhysicsCategory.Obstacle
        
        leftObstacle.size = CGSize(width: self.frame.height / 40, height: woodBrickSize.width * 2.5)
        leftObstacle.position = CGPoint(x: brick21.position.x + (brick21.size.height * 1.9), y: brick21.position.y)
        ...
        rightObstacle.size = CGSize(width: self.frame.height / 40, height: woodBrickSize.width * 2.5)
        rightObstacle.position = CGPoint(x: brick26.position.x - (brick26.size.height * 1.9), y: brick26.position.y)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "topMovingObstacle") {
                checkBallVelocity(Ball: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "topMovingObstacle") && (secondBody.name == "ball") {
            ...
            if (firstBody.name == "topMovingObstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "topMovingObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            if (firstBody.name == "topMovingObstacle") && (secondBody.name == "leftBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "leftBarrier") && (secondBody.name == "topMovingObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocket") && (secondBody.name == "topMovingObstacle") {
                rocketHitStoppingPoint(Rocket: firstBody, StoppingPoint: secondBody)
            } else if (firstBody.name == "topMovingObstacle") && (secondBody.name == "rocket") {
                rocketHitStoppingPoint(Rocket: secondBody, StoppingPoint: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "topMovingObstacle" && Barrier.name == "rightBarrier" {
            topMovingObstacle.run(moveObstacleLeft)
        }
        if Obstacle.name == "topMovingObstacle" && Barrier.name == "leftBarrier" {
            topMovingObstacle.run(moveObstacleRight)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            print("ch1lvl13 completed")
            gameOver = true
            
            if ch2lvl14Unlocked == false {
            continueString = "ch2lvl14"
            UserDefaults.standard.set("ch2lvl14", forKey: "continueString")
            }
            ch2lvl14Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl14Unlocked")
            UserDefaults.standard.synchronize()

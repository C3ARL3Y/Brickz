...
//  Brickz
//
//  Created by Julian Cearley on 3/18/18.
...
class ch2lvl14Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,]
    ...
    let background = SKSpriteNode(imageNamed: "ch2Background")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.texture = SKTexture(imageNamed: "brick1Texture4")
        brick1.size = woodBrickSize
        brick1.name = "brick1"
        brick1.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.35)
        } else {
            brick1.zRotation = 1.57
            brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.35)
        }
        ...
        brick2.texture = SKTexture(imageNamed: "brick1Texture4")
        brick2.size = woodBrickSize
        brick2.name = "brick2"
        brick2.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick2.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.height))
        } else {
            brick2.zRotation = 1.57
            brick2.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brick1.size.width))
        }
        ...
        brick3.texture = SKTexture(imageNamed: "brick1Texture4")
        brick3.size = woodBrickSize
        brick3.name = "brick3"
        brick3.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick3.position = CGPoint(x: brick2.position.x, y: brick2.position.y - (brick2.size.height))
        } else {
            brick3.zRotation = 1.57
            brick3.position = CGPoint(x: brick2.position.x, y: brick2.position.y - (brick2.size.width))
        }
        ...
        brick4.texture = SKTexture(imageNamed: "brick1Texture4")
        brick4.size = woodBrickSize
        brick4.name = "brick4"
        brick4.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick4.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brick3.size.height))
        } else {
            brick4.zRotation = 1.57
            brick4.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brick3.size.width))
        }
        ...
        brick5.texture = SKTexture(imageNamed: "brick1Texture4")
        brick5.size = woodBrickSize
        brick5.name = "brick5"
        brick5.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick5.position = CGPoint(x: brick4.position.x, y: brick4.position.y - (brick4.size.height))
        } else {
            brick5.zRotation = 1.57
            brick5.position = CGPoint(x: brick4.position.x, y: brick4.position.y - (brick4.size.width))
        }
        ...
        brick6.texture = SKTexture(imageNamed: "brick1Texture4")
        brick6.size = woodBrickSize
        brick6.name = "brick6"
        brick6.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick6.position = CGPoint(x: brick5.position.x, y: brick5.position.y - (brick5.size.height))
        } else {
            brick6.zRotation = 1.57
            brick6.position = CGPoint(x: brick5.position.x, y: brick5.position.y - (brick5.size.width))
        }
        ...
        brick7.texture = SKTexture(imageNamed: "brick1Texture4")
        brick7.size = woodBrickSize
        brick7.name = "brick7"
        brick7.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick7.position = CGPoint(x: brick1.position.x + (brick1.size.width), y: brick1.position.y - (brick1.size.height / 2))
        } else {
            brick7.zRotation = 1.57
            brick7.position = CGPoint(x: brick1.position.x + (brick1.size.height), y: brick1.position.y - (brick1.size.width / 2))
        }
        ...
        brick8.texture = SKTexture(imageNamed: "brick1Texture4")
        brick8.size = woodBrickSize
        brick8.name = "brick8"
        brick8.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick8.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.height))
        } else {
            brick8.zRotation = 1.57
            brick8.position = CGPoint(x: brick7.position.x, y: brick7.position.y - (brick7.size.width))
        }
        ...
        brick9.texture = SKTexture(imageNamed: "brick1Texture4")
        brick9.size = woodBrickSize
        brick9.name = "brick9"
        brick9.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick9.position = CGPoint(x: brick8.position.x, y: brick8.position.y - (brick8.size.height))
        } else {
            brick9.zRotation = 1.57
            brick9.position = CGPoint(x: brick8.position.x, y: brick8.position.y - (brick8.size.width))
        }
        ...
        brick10.texture = SKTexture(imageNamed: "brick1Texture4")
        brick10.size = woodBrickSize
        brick10.name = "brick10"
        brick10.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick10.position = CGPoint(x: brick9.position.x, y: brick9.position.y - (brick9.size.height))
        } else {
            brick10.zRotation = 1.57
            brick10.position = CGPoint(x: brick9.position.x, y: brick9.position.y - (brick9.size.width))
        }
        ...
        brick11.texture = SKTexture(imageNamed: "brick1Texture4")
        brick11.size = woodBrickSize
        brick11.name = "brick11"
        brick11.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick11.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick10.size.height))
        } else {
            brick11.zRotation = 1.57
            brick11.position = CGPoint(x: brick10.position.x, y: brick10.position.y - (brick10.size.width))
        }
        ...
        brick12.texture = SKTexture(imageNamed: "brick1Texture4")
        brick12.size = woodBrickSize
        brick12.name = "brick12"
        brick12.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick12.position = CGPoint(x: brick11.position.x + (brick11.size.width), y: brick11.position.y + (brick11.size.height / 2))
        } else {
            brick12.zRotation = 1.57
            brick12.position = CGPoint(x: brick11.position.x + (brick11.size.height), y: brick11.position.y + (brick11.size.width / 2))
        }
        ...
        brick13.texture = SKTexture(imageNamed: "brick1Texture4")
        brick13.size = woodBrickSize
        brick13.name = "brick13"
        brick13.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick13.position = CGPoint(x: brick12.position.x, y: brick12.position.y + (brick12.size.height))
        } else {
            brick13.zRotation = 1.57
            brick13.position = CGPoint(x: brick12.position.x, y: brick12.position.y + (brick12.size.width))
        }
        ...
        brick14.texture = SKTexture(imageNamed: "brick1Texture4")
        brick14.size = woodBrickSize
        brick14.name = "brick14"
        brick14.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick14.position = CGPoint(x: brick13.position.x, y: brick13.position.y + (brick13.size.height))
        } else {
            brick14.zRotation = 1.57
            brick14.position = CGPoint(x: brick13.position.x, y: brick13.position.y + (brick13.size.width))
        }
        ...
        brick15.texture = SKTexture(imageNamed: "brick1Texture4")
        brick15.size = woodBrickSize
        brick15.name = "brick15"
        brick15.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick15.position = CGPoint(x: brick14.position.x, y: brick14.position.y + (brick14.size.height))
        } else {
            brick15.zRotation = 1.57
            brick15.position = CGPoint(x: brick14.position.x, y: brick14.position.y + (brick14.size.width))
        }
        ...
        brick16.texture = SKTexture(imageNamed: "brick1Texture4")
        brick16.size = woodBrickSize
        brick16.name = "brick16"
        brick16.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick16.position = CGPoint(x: brick15.position.x + (brick15.size.width), y: brick15.position.y - (brick15.size.height / 2))
        } else {
            brick16.zRotation = 1.57
            brick16.position = CGPoint(x: brick15.position.x + (brick15.size.height), y: brick15.position.y - (brick15.size.width / 2))
        }
        ...
        brick17.texture = SKTexture(imageNamed: "brick1Texture4")
        brick17.size = woodBrickSize
        brick17.name = "brick17"
        brick17.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick17.position = CGPoint(x: brick16.position.x, y: brick16.position.y - (brick16.size.height))
        } else {
            brick17.zRotation = 1.57
            brick17.position = CGPoint(x: brick16.position.x, y: brick16.position.y - (brick16.size.width))
        }
        ...
        brick18.texture = SKTexture(imageNamed: "brick1Texture4")
        brick18.size = woodBrickSize
        brick18.name = "brick18"
        brick18.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick18.position = CGPoint(x: brick17.position.x, y: brick17.position.y - (brick17.size.height))
        } else {
            brick18.zRotation = 1.57
            brick18.position = CGPoint(x: brick17.position.x, y: brick17.position.y - (brick17.size.width))
        }
        ...
        brick19.texture = SKTexture(imageNamed: "brick1Texture4")
        brick19.size = woodBrickSize
        brick19.name = "brick19"
        brick19.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick19.position = CGPoint(x: brick18.position.x + (brick18.size.width), y: brick18.position.y + (brick18.size.height / 2))
        } else {
            brick19.zRotation = 1.57
            brick19.position = CGPoint(x: brick18.position.x + (brick18.size.height), y: brick18.position.y + (brick18.size.width / 2))
        }
        ...
        brick20.texture = SKTexture(imageNamed: "brick1Texture4")
        brick20.size = woodBrickSize
        brick20.name = "brick20"
        brick20.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick20.position = CGPoint(x: brick19.position.x, y: brick19.position.y + (brick19.size.height))
        } else {
            brick20.zRotation = 1.57
            brick20.position = CGPoint(x: brick19.position.x, y: brick19.position.y + (brick19.size.width))
        }
        ...
        brick21.texture = SKTexture(imageNamed: "brick1Texture4")
        brick21.size = woodBrickSize
        brick21.name = "brick21"
        brick21.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick21.position = CGPoint(x: brick20.position.x + (brick20.size.width), y: brick20.position.y - (brick20.size.height / 2))
        } else {
            brick21.zRotation = 1.57
            brick21.position = CGPoint(x: brick20.position.x + (brick20.size.height), y: brick20.position.y - (brick20.size.width / 2))
        }
        ...
        brick22.texture = SKTexture(imageNamed: "brick1Texture4")
        brick22.size = woodBrickSize
        brick22.name = "brick22"
        brick22.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick22.position = CGPoint(x: brick1.position.x - (brick1.size.width), y: brick1.position.y - (brick1.size.height / 2))
        } else {
            brick22.zRotation = 1.57
            brick22.position = CGPoint(x: brick1.position.x - (brick1.size.height), y: brick1.position.y - (brick1.size.width / 2))
        }
        ...
        brick23.texture = SKTexture(imageNamed: "brick1Texture4")
        brick23.size = woodBrickSize
        brick23.name = "brick23"
        brick23.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick23.position = CGPoint(x: brick22.position.x, y: brick22.position.y - (brick22.size.height))
        } else {
            brick23.zRotation = 1.57
            brick23.position = CGPoint(x: brick22.position.x, y: brick22.position.y - (brick22.size.width))
        }
        ...
        brick24.texture = SKTexture(imageNamed: "brick1Texture4")
        brick24.size = woodBrickSize
        brick24.name = "brick24"
        brick24.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick24.position = CGPoint(x: brick23.position.x, y: brick23.position.y - (brick23.size.height))
        } else {
            brick24.zRotation = 1.57
            brick24.position = CGPoint(x: brick23.position.x, y: brick23.position.y - (brick23.size.width))
        }
        ...
        brick25.texture = SKTexture(imageNamed: "brick1Texture4")
        brick25.size = woodBrickSize
        brick25.name = "brick25"
        brick25.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick25.position = CGPoint(x: brick24.position.x, y: brick24.position.y - (brick24.size.height))
        } else {
            brick25.zRotation = 1.57
            brick25.position = CGPoint(x: brick24.position.x, y: brick24.position.y - (brick24.size.width))
        }
        ...
        brick26.texture = SKTexture(imageNamed: "brick1Texture4")
        brick26.size = woodBrickSize
        brick26.name = "brick26"
        brick26.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick26.position = CGPoint(x: brick25.position.x, y: brick25.position.y - (brick25.size.height))
        } else {
            brick26.zRotation = 1.57
            brick26.position = CGPoint(x: brick25.position.x, y: brick25.position.y - (brick25.size.width))
        }
        ...
        brick27.texture = SKTexture(imageNamed: "brick1Texture4")
        brick27.size = woodBrickSize
        brick27.name = "brick27"
        brick27.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick27.position = CGPoint(x: brick26.position.x - (brick26.size.width), y: brick26.position.y + (brick26.size.height / 2))
        } else {
            brick27.zRotation = 1.57
            brick27.position = CGPoint(x: brick26.position.x - (brick26.size.height), y: brick26.position.y + (brick26.size.width / 2))
        }
        ...
        brick28.texture = SKTexture(imageNamed: "brick1Texture4")
        brick28.size = woodBrickSize
        brick28.name = "brick28"
        brick28.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick28.position = CGPoint(x: brick27.position.x, y: brick27.position.y + (brick27.size.height))
        } else {
            brick28.zRotation = 1.57
            brick28.position = CGPoint(x: brick27.position.x, y: brick27.position.y + (brick27.size.width))
        }
        ...
        brick29.texture = SKTexture(imageNamed: "brick1Texture4")
        brick29.size = woodBrickSize
        brick29.name = "brick29"
        brick29.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick29.position = CGPoint(x: brick28.position.x, y: brick28.position.y + (brick28.size.height))
        } else {
            brick29.zRotation = 1.57
            brick29.position = CGPoint(x: brick28.position.x, y: brick28.position.y + (brick28.size.width))
        }
        ...
        brick30.texture = SKTexture(imageNamed: "brick1Texture4")
        brick30.size = woodBrickSize
        brick30.name = "brick30"
        brick30.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick30.position = CGPoint(x: brick29.position.x, y: brick29.position.y + (brick29.size.height))
        } else {
            brick30.zRotation = 1.57
            brick30.position = CGPoint(x: brick29.position.x, y: brick29.position.y + (brick29.size.width))
        }
        ...
        brick31.texture = SKTexture(imageNamed: "brick1Texture4")
        brick31.size = woodBrickSize
        ...
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            ...
            brick31.zRotation = 1.57
            brick31.position = CGPoint(x: brick30.position.x - (brick30.size.height),  y: brick30.position.y - (brick30.size.width / 2))
        }
        ...
        brick32.texture = SKTexture(imageNamed: "brick1Texture4")
        brick32.size = woodBrickSize
        brick32.name = "brick32"
        brick32.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick32.position = CGPoint(x: brick31.position.x, y: brick31.position.y - (brick31.size.height))
        } else {
            brick32.zRotation = 1.57
            brick32.position = CGPoint(x: brick31.position.x, y: brick31.position.y - (brick31.size.width))
        }
        ...
        brick33.texture = SKTexture(imageNamed: "brick1Texture4")
        brick33.size = woodBrickSize
        brick33.name = "brick33"
        brick33.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick33.position = CGPoint(x: brick32.position.x, y: brick32.position.y - (brick32.size.height))
        } else {
            brick33.zRotation = 1.57
            brick33.position = CGPoint(x: brick32.position.x, y: brick32.position.y - (brick32.size.width))
        }
        ...
        brick34.texture = SKTexture(imageNamed: "brick1Texture4")
        brick34.size = woodBrickSize
        brick34.name = "brick34"
        brick34.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick34.position = CGPoint(x: brick33.position.x - (brick33.size.width), y: brick33.position.y
                + (brick33.size.height / 2))
        } else {
            brick34.zRotation = 1.57
            brick34.position = CGPoint(x: brick33.position.x - (brick33.size.height), y: brick33.position.y
                + (brick33.size.width / 2))
        }
        ...
        brick35.texture = SKTexture(imageNamed: "brick1Texture4")
        brick35.size = woodBrickSize
        brick35.name = "brick35"
        brick35.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick35.position = CGPoint(x: brick34.position.x, y: brick34.position.y + (brick34.size.height))
        } else {
            brick35.zRotation = 1.57
            brick35.position = CGPoint(x: brick34.position.x, y: brick34.position.y + (brick34.size.width))
        }
        ...
        brick36.texture = SKTexture(imageNamed: "brick1Texture4")
        brick36.size = woodBrickSize
        brick36.name = "brick36"
        brick36.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick36.position = CGPoint(x: brick35.position.x - (brick35.size.width), y: brick35.position.y - (brick35.size.height / 2))
        } else {
            brick36.zRotation = 1.57
            brick36.position = CGPoint(x: brick35.position.x - (brick35.size.height), y: brick35.position.y - (brick35.size.width / 2))
        }
        ...
        brick37.texture = SKTexture(imageNamed: "brick1Texture4")
        brick37.size = woodBrickSize
        brick37.name = "brick37"
        brick37.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick37.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.height))
        } else {
            brick37.zRotation = 1.57
            brick37.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brick1.size.width))
        }
        ...
        brick38.texture = SKTexture(imageNamed: "brick1Texture4")
        brick38.size = woodBrickSize
        brick38.name = "brick38"
        brick38.zPosition = 1
        if view.frame.width == 1024 && view.frame.height == 1366 || view.frame.width == 834 && view.frame.height == 1112 || view.frame.width == 768 && view.frame.height == 1024 {
            brick38.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.height))
        } else {
            brick38.zRotation = 1.57
            brick38.position = CGPoint(x: brick6.position.x, y: brick6.position.y - (brick6.size.width))
        }
        ...
        topObstacle.position = CGPoint(x: 0 + (topObstacle.size.width * 0.6), y: brick37.position.y + (brick37.size.width / 1.2))
        ...
        bottomObstacle.position = CGPoint(x: self.frame.width - (bottomObstacle.size.width * 0.6), y: brick38.position.y - (brick38.size.width / 1.2))
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "topObstacle") && (secondBody.name == "rightBarrier") {
                movingObstacleHitBarrier(Obstacle: firstBody, Barrier: secondBody)
            } else if (firstBody.name == "rightBarrier") && (secondBody.name == "topObstacle") {
                movingObstacleHitBarrier(Obstacle: secondBody, Barrier: firstBody)
            }
            ...
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick29") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick29") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
            if (firstBody.name == "rocketExplosionRadius") && (secondBody.name == "brick30") {
                explosionRadiusHitBrick(Radius: firstBody, Brick: secondBody)
            } else if (firstBody.name == "brick30") && (secondBody.name == "rocketExplosionRadius") {
                explosionRadiusHitBrick(Radius: secondBody, Brick: firstBody)
            }
    ...
    func movingObstacleHitBarrier(Obstacle: SKSpriteNode, Barrier: SKSpriteNode) {
        if Obstacle.name == "topObstacle" && Barrier.name == "rightBarrier" {
            topObstacle.run(moveObstacleLeft)
        }
        if Obstacle.name == "topObstacle" && Barrier.name == "leftBarrier" {
            topObstacle.run(moveObstacleRight)
        }
        if Obstacle.name == "bottomObstacle" && Barrier.name == "leftBarrier" {
            bottomObstacle.run(moveObstacleRight)
        }
        if Obstacle.name == "bottomObstacle" && Barrier.name == "rightBarrier" {
            bottomObstacle.run(moveObstacleLeft)
        }
    }
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick1" {
            ...
            if brickLives[0] == 4 {
                brickLives[0] -= 1
                brick1.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[0] == 3 {
                brickLives[0] -= 1
                brick1.texture = SKTexture(imageNamed: "brick1Texture2")
        ...
        if Brick.name == "brick2" {
            ...
            if brickLives[1] == 4 {
                brickLives[1] -= 1
                brick2.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[1] == 3 {
                brickLives[1] -= 1
                brick2.texture = SKTexture(imageNamed: "brick1Texture2")
        ...
        if Brick.name == "brick3" {
            ...
            if brickLives[2] == 4 {
                brickLives[2] -= 1
                brick3.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[2] == 3 {
                brickLives[2] -= 1
                brick3.texture = SKTexture(imageNamed: "brick1Texture2")
        ...
        if Brick.name == "brick4" {
            ...
            if brickLives[3] == 4 {
                brickLives[3] -= 1
                brick4.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[3] == 3 {
                brickLives[3] -= 1
                brick4.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[3] == 2 {
                brickLives[3] -= 1
                brick4.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick5" {
            ...
            if brickLives[4] == 4 {
                brickLives[4] -= 1
                brick5.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[4] == 3 {
                brickLives[4] -= 1
                brick5.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[4] == 2 {
                brickLives[4] -= 1
                brick5.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick6" {
            ...
            if brickLives[5] == 4 {
                brickLives[5] -= 1
                brick6.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[5] == 3 {
                brickLives[5] -= 1
                brick6.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[5] == 2 {
                brickLives[5] -= 1
                brick6.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick7" {
            ...
            if brickLives[6] == 4 {
                brickLives[6] -= 1
                brick7.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[6] == 3 {
                brickLives[6] -= 1
                brick7.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[6] == 2 {
                brickLives[6] -= 1
                brick7.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick8" {
            ...
            if brickLives[7] == 4 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[7] == 3 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[7] == 2 {
                brickLives[7] -= 1
                brick8.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick9" {
            ...
            if brickLives[8] == 4 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[8] == 3 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[8] == 2 {
                brickLives[8] -= 1
                brick9.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick10" {
            ...
            if brickLives[9] == 4 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[9] == 3 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[9] == 2 {
                brickLives[9] -= 1
                brick10.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick11" {
            ...
            if brickLives[10] == 4 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[10] == 3 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[10] == 2 {
                brickLives[10] -= 1
                brick11.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick12" {
            ...
            if brickLives[11] == 4 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[11] == 3 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[11] == 2 {
                brickLives[11] -= 1
                brick12.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick13" {
            ...
            if brickLives[12] == 4 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[12] == 3 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[12] == 2 {
                brickLives[12] -= 1
                brick13.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick14" {
            ...
            if brickLives[13] == 4 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[13] == 3 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[13] == 2 {
                brickLives[13] -= 1
                brick14.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick15" {
            ...
            if brickLives[14] == 4 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[14] == 3 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[14] == 2 {
                brickLives[14] -= 1
                brick15.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick16" {
            ...
            if brickLives[15] == 4 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[15] == 3 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[15] == 2 {
                brickLives[15] -= 1
                brick16.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick17" {
            ...
            if brickLives[16] == 4 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[16] == 3 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[16] == 2 {
                brickLives[16] -= 1
                brick17.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick18" {
            ...
            if brickLives[17] == 4 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[17] == 3 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[17] == 2 {
                brickLives[17] -= 1
                brick18.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick19" {
            ...
            if brickLives[18] == 4 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[18] == 3 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[18] == 2 {
                brickLives[18] -= 1
                brick19.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick20" {
            ...
            if brickLives[19] == 4 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[19] == 3 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[19] == 2 {
                brickLives[19] -= 1
                brick20.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick21" {
            ...
            if brickLives[20] == 4 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[20] == 3 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[20] == 2 {
                brickLives[20] -= 1
                brick21.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick22" {
            ...
            if brickLives[21] == 4 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[21] == 3 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[21] == 2 {
                brickLives[21] -= 1
                brick22.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick23" {
            ...
            if brickLives[22] == 4 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[22] == 3 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[22] == 2 {
                brickLives[22] -= 1
                brick23.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick24" {
            ...
            if brickLives[23] == 4 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[23] == 3 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[23] == 2 {
                brickLives[23] -= 1
                brick24.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick25" {
            ...
            if brickLives[24] == 4 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[24] == 3 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[24] == 2 {
                brickLives[24] -= 1
                brick25.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick26" {
            ...
            if brickLives[25] == 4 {
                brickLives[25] -= 1
                brick26.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[25] == 3 {
                brickLives[25] -= 1
                brick26.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[25] == 2 {
                brickLives[25] -= 1
                brick26.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick27" {
            ...
            if brickLives[26] == 4 {
                brickLives[26] -= 1
                brick27.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[26] == 3 {
                brickLives[26] -= 1
                brick27.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[26] == 2 {
                brickLives[26] -= 1
                brick27.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick28" {
            ...
            if brickLives[27] == 4 {
                brickLives[27] -= 1
                brick28.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[27] == 3 {
                brickLives[27] -= 1
                brick28.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[27] == 2 {
                brickLives[27] -= 1
                brick28.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick29" {
            ...
            if brickLives[28] == 4 {
                brickLives[28] -= 1
                brick29.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[28] == 3 {
                brickLives[28] -= 1
                brick29.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[28] == 2 {
                brickLives[28] -= 1
                brick29.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick30" {
            ...
            if brickLives[29] == 4 {
                brickLives[29] -= 1
                brick30.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[29] == 3 {
                brickLives[29] -= 1
                brick30.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[29] == 2 {
                brickLives[29] -= 1
                brick30.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick31" {
            ...
            if brickLives[30] == 4 {
                brickLives[30] -= 1
                brick31.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[30] == 3 {
                brickLives[30] -= 1
                brick31.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[30] == 2 {
                brickLives[30] -= 1
                brick31.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick32" {
            ...
            if brickLives[31] == 4 {
                brickLives[31] -= 1
                brick32.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[31] == 3 {
                brickLives[31] -= 1
                brick32.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[31] == 2 {
                brickLives[31] -= 1
                brick32.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick33" {
            ...
            if brickLives[32] == 4 {
                brickLives[32] -= 1
                brick33.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[32] == 3 {
                brickLives[32] -= 1
                brick33.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[32] == 2 {
                brickLives[32] -= 1
                brick33.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick34" {
            ...
            if brickLives[33] == 4 {
                brickLives[33] -= 1
                brick34.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[33] == 3 {
                brickLives[33] -= 1
                brick34.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[33] == 2 {
                brickLives[33] -= 1
                brick34.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick35" {
            ...
            if brickLives[34] == 4 {
                brickLives[34] -= 1
                brick35.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[34] == 3 {
                brickLives[34] -= 1
                brick35.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[34] == 2 {
                brickLives[34] -= 1
                brick35.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick36" {
            ...
            if brickLives[35] == 4 {
                brickLives[35] -= 1
                brick36.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[35] == 3 {
                brickLives[35] -= 1
                brick36.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[35] == 2 {
                brickLives[35] -= 1
                brick36.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick37" {
            ...
            if brickLives[36] == 4 {
                brickLives[36] -= 1
                brick37.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[36] == 3 {
                brickLives[36] -= 1
                brick37.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[36] == 2 {
                brickLives[36] -= 1
                brick37.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if Brick.name == "brick38" {
            ...
            if brickLives[37] == 4 {
                brickLives[37] -= 1
                brick38.texture = SKTexture(imageNamed: "brick1Texture3")
            } else if brickLives[37] == 3 {
                brickLives[37] -= 1
                brick38.texture = SKTexture(imageNamed: "brick1Texture2")
            } else if brickLives[37] == 2 {
                brickLives[37] -= 1
                brick38.texture = SKTexture(imageNamed: "brick1Texture1")
        ...
        if brickCount == 0 {
            ...
            continueString = "ch2lvl15"
            UserDefaults.standard.set("ch2lvl15", forKey: "continueString")
            }
            ch2lvl15Unlocked = true
            UserDefaults.standard.set(true, forKey: "ch2lvl15Unlocked")
            UserDefaults.standard.synchronize()
